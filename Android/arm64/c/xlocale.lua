...
enum { __BIONIC_COMPLICATED_NULLNESS = 1 };
...
/* #define __LIBC32_LEGACY_PUBLIC__ __attribute__((__visibility__("hidden"))) ### define is not number */
...
/* #define __INTRODUCED_IN_32 (api_level)  ### define is not number */
/* #define __INTRODUCED_IN_64 (api_level) __BIONIC_AVAILABILITY(introduced=api_level) ### define is not number */
