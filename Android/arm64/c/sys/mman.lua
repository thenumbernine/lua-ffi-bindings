...
/* +++ BEGIN <asm/mman.h> /data/data/com.termux/files/usr/bin/../../usr/include/aarch64-linux-android/asm/mman.h */
...
/* +++ END <asm/mman.h> /data/data/com.termux/files/usr/bin/../../usr/include/aarch64-linux-android/asm/mman.h */
...
enum { PROT_BTI = 0x10 };
enum { PROT_MTE = 0x20 };
enum { PKEY_DISABLE_EXECUTE = 0x4 };
enum { PKEY_DISABLE_READ = 0x8 };
/* #define PKEY_ACCESS_MASK (PKEY_DISABLE_ACCESS | PKEY_DISABLE_WRITE | PKEY_DISABLE_READ | PKEY_DISABLE_EXECUTE) ### define is not number */
