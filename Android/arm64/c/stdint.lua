...
/* #define INTPTR_C (c) INT64_C(c) ### define is not number */
/* #define UINTPTR_C (c) UINT64_C(c) ### define is not number */
/* #define PTRDIFF_C (c) INT64_C(c) ### define is not number */
...
enum { WINT_MIN = 0 };
/* #define INTPTR_MIN (INT64_C(-9223372036854775807)-1) ### define is not number */
/* #define INTPTR_MAX (INT64_C(9223372036854775807)) ### define is not number */
/* #define UINTPTR_MAX (UINT64_C(18446744073709551615)) ### define is not number */
/* #define PTRDIFF_MIN (INT64_C(-9223372036854775807)-1) ### define is not number */
/* #define PTRDIFF_MAX (INT64_C(9223372036854775807)) ### define is not number */
/* #define SIZE_MAX (UINT64_C(18446744073709551615)) ### define is not number */
