...
/* ++ BEGIN <alloca.h> /usr/include/alloca.h */
/* +++ BEGIN <stddef.h> /usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h */
]] require 'ffi.req' 'c.stddef' ffi.cdef[[
/* +++ END <stddef.h> /usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h */
extern void *alloca (size_t __size) __attribute__ ((__nothrow__ , __leaf__));
/* ++ END <alloca.h> /usr/include/alloca.h */
...
/* #define WIFEXITED (status) __WIFEXITED (status) ### define is not number */
/* #define WIFSIGNALED (status) __WIFSIGNALED (status) ### define is not number */
/* #define WIFSTOPPED (status) __WIFSTOPPED (status) ### define is not number */
/* #define WIFCONTINUED (status) __WIFCONTINUED (status) ### define is not number */
