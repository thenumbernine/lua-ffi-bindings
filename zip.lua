...
return require 'ffi.libwrapper'{
	...
	defs = {
		...
		ZIP_FL_NOCASE = 1u,
		ZIP_FL_NODIR = 2u,
		ZIP_FL_COMPRESSED = 4u,
		ZIP_FL_UNCHANGED = 8u,
		ZIP_FL_RECOMPRESS = 16u,
		ZIP_FL_ENCRYPTED = 32u,
		ZIP_FL_ENC_GUESS = 0u,
		ZIP_FL_ENC_RAW = 64u,
		ZIP_FL_ENC_STRICT = 128u,
		ZIP_FL_LOCAL = 256u,
		ZIP_FL_CENTRAL = 512u,
		ZIP_FL_ENC_UTF_8 = 2048u,
		ZIP_FL_ENC_CP437 = 4096u,
		ZIP_FL_OVERWRITE = 8192u,
		ZIP_AFL_RDONLY = 2u,
		...
		ZIP_OPSYS_DOS = 0x00u,
		ZIP_OPSYS_AMIGA = 0x01u,
		ZIP_OPSYS_OPENVMS = 0x02u,
		ZIP_OPSYS_UNIX = 0x03u,
		ZIP_OPSYS_VM_CMS = 0x04u,
		ZIP_OPSYS_ATARI_ST = 0x05u,
		ZIP_OPSYS_OS_2 = 0x06u,
		ZIP_OPSYS_MACINTOSH = 0x07u,
		ZIP_OPSYS_Z_SYSTEM = 0x08u,
		ZIP_OPSYS_CPM = 0x09u,
		ZIP_OPSYS_WINDOWS_NTFS = 0x0au,
		ZIP_OPSYS_MVS = 0x0bu,
		ZIP_OPSYS_VSE = 0x0cu,
		ZIP_OPSYS_ACORN_RISC = 0x0du,
		ZIP_OPSYS_VFAT = 0x0eu,
		ZIP_OPSYS_ALTERNATE_MVS = 0x0fu,
		ZIP_OPSYS_BEOS = 0x10u,
		ZIP_OPSYS_TANDEM = 0x11u,
		ZIP_OPSYS_OS_400 = 0x12u,
		ZIP_OPSYS_OS_X = 0x13u,
		ZIP_STAT_NAME = 0x0001u,
		ZIP_STAT_INDEX = 0x0002u,
		ZIP_STAT_SIZE = 0x0004u,
		ZIP_STAT_COMP_SIZE = 0x0008u,
		ZIP_STAT_MTIME = 0x0010u,
		ZIP_STAT_CRC = 0x0020u,
		ZIP_STAT_COMP_METHOD = 0x0040u,
		ZIP_STAT_ENCRYPTION_METHOD = 0x0080u,
		ZIP_STAT_FLAGS = 0x0100u,
		ZIP_FILE_ATTRIBUTES_HOST_SYSTEM = 0x0001u,
		ZIP_FILE_ATTRIBUTES_ASCII = 0x0002u,
		ZIP_FILE_ATTRIBUTES_VERSION_NEEDED = 0x0004u,
		ZIP_FILE_ATTRIBUTES_EXTERNAL_FILE_ATTRIBUTES = 0x0008u,
		ZIP_FILE_ATTRIBUTES_GENERAL_PURPOSE_BIT_FLAGS = 0x0010u,
