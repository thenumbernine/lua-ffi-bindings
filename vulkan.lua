...
ffi.cdef[[
/* + BEGIN /usr/include/vulkan/vulkan_core.h */
enum { VULKAN_CORE_H_ = 1 };
enum { VK_VERSION_1_0 = 1 };
/* ++ BEGIN /usr/include/vulkan/vk_platform.h */
enum { VK_PLATFORM_H_ = 1 };
enum { VKAPI_ATTR = 1 };
enum { VKAPI_CALL = 1 };
enum { VKAPI_PTR = 1 };
...
/* ++ END   /usr/include/vulkan/vk_platform.h */
enum { VK_USE_64_BIT_PTR_DEFINES = 1 };
/* #define VK_NULL_HANDLE ((void*)0) ### string, not number "((void*)0)" */
/* #define VK_API_VERSION_1_0 VK_MAKE_API_VERSION(0, 1, 0, 0) ### string, not number "VK_MAKE_API_VERSION(0, 1, 0, 0)" */
enum { VK_HEADER_VERSION = 275 };
/* #define VK_HEADER_VERSION_COMPLETE VK_MAKE_API_VERSION(0, 1, 3, VK_HEADER_VERSION) ### string, not number "VK_MAKE_API_VERSION(0, 1, 3, VK_HEADER_VERSION)" */
...
typedef enum VkPhysicalDeviceType { VK_PHYSICAL_DEVICE_TYPE_OTHER = 0, VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU = 1, VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU = 2, VK_PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU = 3, VK_PHYSICAL_DEVICE_TYPE_CPU = 4, VK_PHYSICAL_DEVICE_TYPE_MAX_ENUM = 0x7FFFFFFF } VkPhysicalDeviceType;
typedef enum VkQueryType { VK_QUERY_TYPE_OCCLUSION = 0, VK_QUERY_TYPE_PIPELINE_STATISTICS = 1, VK_QUERY_TYPE_TIMESTAMP = 2, VK_QUERY_TYPE_RESULT_STATUS_ONLY_KHR = 1000023000, VK_QUERY_TYPE_TRANSFORM_FEEDBACK_STREAM_EXT = 1000028004, VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR = 1000116000, VK_QUERY_TYPE_ACCELERATION_STRUCTURE_COMPACTED_SIZE_KHR = 1000150000, VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_SIZE_KHR = 1000150001, VK_QUERY_TYPE_ACCELERATION_STRUCTURE_COMPACTED_SIZE_NV = 1000165000, VK_QUERY_TYPE_PERFORMANCE_QUERY_INTEL = 1000210000, VK_QUERY_TYPE_VIDEO_ENCODE_FEEDBACK_KHR = 1000299000, VK_QUERY_TYPE_MESH_PRIMITIVES_GENERATED_EXT = 1000328000, VK_QUERY_TYPE_PRIMITIVES_GENERATED_EXT = 1000382000, VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_BOTTOM_LEVEL_POINTERS_KHR = 1000386000, VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR = 1000386001, VK_QUERY_TYPE_MICROMAP_SERIALIZATION_SIZE_EXT = 1000396000, VK_QUERY_TYPE_MICROMAP_COMPACTED_SIZE_EXT = 1000396001, VK_QUERY_TYPE_MAX_ENUM = 0x7FFFFFFF } VkQueryType;
...
typedef enum VkComponentSwizzle { VK_COMPONENT_SWIZZLE_IDENTITY = 0, VK_COMPONENT_SWIZZLE_ZERO = 1, VK_COMPONENT_SWIZZLE_ONE = 2, VK_COMPONENT_SWIZZLE_R = 3, VK_COMPONENT_SWIZZLE_G = 4, VK_COMPONENT_SWIZZLE_B = 5, VK_COMPONENT_SWIZZLE_A = 6, VK_COMPONENT_SWIZZLE_MAX_ENUM = 0x7FFFFFFF } VkComponentSwizzle;
...
typedef enum VkPolygonMode { VK_POLYGON_MODE_FILL = 0, VK_POLYGON_MODE_LINE = 1, VK_POLYGON_MODE_POINT = 2, VK_POLYGON_MODE_FILL_RECTANGLE_NV = 1000153000, VK_POLYGON_MODE_MAX_ENUM = 0x7FFFFFFF } VkPolygonMode;
typedef enum VkStencilOp { VK_STENCIL_OP_KEEP = 0, VK_STENCIL_OP_ZERO = 1, VK_STENCIL_OP_REPLACE = 2, VK_STENCIL_OP_INCREMENT_AND_CLAMP = 3, VK_STENCIL_OP_DECREMENT_AND_CLAMP = 4, VK_STENCIL_OP_INVERT = 5, VK_STENCIL_OP_INCREMENT_AND_WRAP = 6, VK_STENCIL_OP_DECREMENT_AND_WRAP = 7, VK_STENCIL_OP_MAX_ENUM = 0x7FFFFFFF } VkStencilOp;
...
typedef enum VkIndexType { VK_INDEX_TYPE_UINT16 = 0, VK_INDEX_TYPE_UINT32 = 1, VK_INDEX_TYPE_NONE_KHR = 1000165000, VK_INDEX_TYPE_UINT8_EXT = 1000265000, VK_INDEX_TYPE_NONE_NV = VK_INDEX_TYPE_NONE_KHR, VK_INDEX_TYPE_MAX_ENUM = 0x7FFFFFFF } VkIndexType;
typedef enum VkSubpassContents { VK_SUBPASS_CONTENTS_INLINE = 0, VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS = 1, VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT = 1000451000, VK_SUBPASS_CONTENTS_MAX_ENUM = 0x7FFFFFFF } VkSubpassContents;
...
typedef enum VkCullModeFlagBits { VK_CULL_MODE_NONE = 0, VK_CULL_MODE_FRONT_BIT = 0x00000001, VK_CULL_MODE_BACK_BIT = 0x00000002, VK_CULL_MODE_FRONT_AND_BACK = 0x00000003, VK_CULL_MODE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkCullModeFlagBits;
...
typedef enum VkAttachmentDescriptionFlagBits { VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT = 0x00000001, VK_ATTACHMENT_DESCRIPTION_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkAttachmentDescriptionFlagBits;
...
typedef enum VkFramebufferCreateFlagBits { VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT = 0x00000001, VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT_KHR = VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT, VK_FRAMEBUFFER_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkFramebufferCreateFlagBits;
typedef VkFlags VkFramebufferCreateFlags;
typedef enum VkRenderPassCreateFlagBits { VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM = 0x00000002, VK_RENDER_PASS_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkRenderPassCreateFlagBits;
typedef VkFlags VkRenderPassCreateFlags;
typedef enum VkSubpassDescriptionFlagBits { VK_SUBPASS_DESCRIPTION_PER_VIEW_ATTRIBUTES_BIT_NVX = 0x00000001, VK_SUBPASS_DESCRIPTION_PER_VIEW_POSITION_X_ONLY_BIT_NVX = 0x00000002, VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM = 0x00000004, VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM = 0x00000008, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_EXT = 0x00000010, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT = 0x00000020, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT = 0x00000040, VK_SUBPASS_DESCRIPTION_ENABLE_LEGACY_DITHERING_BIT_EXT = 0x00000080, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_ARM = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_EXT, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_ARM = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT, VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_ARM = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT, VK_SUBPASS_DESCRIPTION_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkSubpassDescriptionFlagBits;
typedef VkFlags VkSubpassDescriptionFlags;
typedef enum VkCommandPoolCreateFlagBits { VK_COMMAND_POOL_CREATE_TRANSIENT_BIT = 0x00000001, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT = 0x00000002, VK_COMMAND_POOL_CREATE_PROTECTED_BIT = 0x00000004, VK_COMMAND_POOL_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkCommandPoolCreateFlagBits;
typedef VkFlags VkCommandPoolCreateFlags;
typedef enum VkCommandPoolResetFlagBits { VK_COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT = 0x00000001, VK_COMMAND_POOL_RESET_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkCommandPoolResetFlagBits;
typedef VkFlags VkCommandPoolResetFlags;
typedef enum VkCommandBufferUsageFlagBits { VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT = 0x00000001, VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT = 0x00000002, VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT = 0x00000004, VK_COMMAND_BUFFER_USAGE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkCommandBufferUsageFlagBits;
typedef VkFlags VkCommandBufferUsageFlags;
typedef enum VkQueryControlFlagBits { VK_QUERY_CONTROL_PRECISE_BIT = 0x00000001, VK_QUERY_CONTROL_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkQueryControlFlagBits;
typedef VkFlags VkQueryControlFlags;
typedef enum VkCommandBufferResetFlagBits { VK_COMMAND_BUFFER_RESET_RELEASE_RESOURCES_BIT = 0x00000001, VK_COMMAND_BUFFER_RESET_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkCommandBufferResetFlagBits;
typedef VkFlags VkCommandBufferResetFlags;
typedef enum VkStencilFaceFlagBits { VK_STENCIL_FACE_FRONT_BIT = 0x00000001, VK_STENCIL_FACE_BACK_BIT = 0x00000002, VK_STENCIL_FACE_FRONT_AND_BACK = 0x00000003, VK_STENCIL_FRONT_AND_BACK = VK_STENCIL_FACE_FRONT_AND_BACK, VK_STENCIL_FACE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkStencilFaceFlagBits;
...
/* #define VK_API_VERSION_1_1 VK_MAKE_API_VERSION(0, 1, 1, 0) ### string, not number "VK_MAKE_API_VERSION(0, 1, 1, 0)" */
...
enum { VK_LUID_SIZE = 8 };
enum { VK_QUEUE_FAMILY_EXTERNAL = -2 };
typedef enum VkPointClippingBehavior { VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES = 0, VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY = 1, VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES_KHR = VK_POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES, VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY_KHR = VK_POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY, VK_POINT_CLIPPING_BEHAVIOR_MAX_ENUM = 0x7FFFFFFF } VkPointClippingBehavior;
typedef enum VkTessellationDomainOrigin { VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT = 0, VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT = 1, VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT_KHR = VK_TESSELLATION_DOMAIN_ORIGIN_UPPER_LEFT, VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT_KHR = VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT, VK_TESSELLATION_DOMAIN_ORIGIN_MAX_ENUM = 0x7FFFFFFF } VkTessellationDomainOrigin;
typedef enum VkSamplerYcbcrModelConversion { VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY = 0, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY = 1, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709 = 2, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601 = 3, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020 = 4, VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY_KHR = VK_SAMPLER_YCBCR_MODEL_CONVERSION_RGB_IDENTITY, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY_KHR = VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_IDENTITY, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709_KHR = VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_709, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601_KHR = VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_601, VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020_KHR = VK_SAMPLER_YCBCR_MODEL_CONVERSION_YCBCR_2020, VK_SAMPLER_YCBCR_MODEL_CONVERSION_MAX_ENUM = 0x7FFFFFFF } VkSamplerYcbcrModelConversion;
typedef enum VkSamplerYcbcrRange { VK_SAMPLER_YCBCR_RANGE_ITU_FULL = 0, VK_SAMPLER_YCBCR_RANGE_ITU_NARROW = 1, VK_SAMPLER_YCBCR_RANGE_ITU_FULL_KHR = VK_SAMPLER_YCBCR_RANGE_ITU_FULL, VK_SAMPLER_YCBCR_RANGE_ITU_NARROW_KHR = VK_SAMPLER_YCBCR_RANGE_ITU_NARROW, VK_SAMPLER_YCBCR_RANGE_MAX_ENUM = 0x7FFFFFFF } VkSamplerYcbcrRange;
typedef enum VkChromaLocation { VK_CHROMA_LOCATION_COSITED_EVEN = 0, VK_CHROMA_LOCATION_MIDPOINT = 1, VK_CHROMA_LOCATION_COSITED_EVEN_KHR = VK_CHROMA_LOCATION_COSITED_EVEN, VK_CHROMA_LOCATION_MIDPOINT_KHR = VK_CHROMA_LOCATION_MIDPOINT, VK_CHROMA_LOCATION_MAX_ENUM = 0x7FFFFFFF } VkChromaLocation;
...
typedef enum VkPeerMemoryFeatureFlagBits { VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT = 0x00000001, VK_PEER_MEMORY_FEATURE_COPY_DST_BIT = 0x00000002, VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT = 0x00000004, VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT = 0x00000008, VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT_KHR = VK_PEER_MEMORY_FEATURE_COPY_SRC_BIT, VK_PEER_MEMORY_FEATURE_COPY_DST_BIT_KHR = VK_PEER_MEMORY_FEATURE_COPY_DST_BIT, VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT_KHR = VK_PEER_MEMORY_FEATURE_GENERIC_SRC_BIT, VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT_KHR = VK_PEER_MEMORY_FEATURE_GENERIC_DST_BIT, VK_PEER_MEMORY_FEATURE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkPeerMemoryFeatureFlagBits;
typedef VkFlags VkPeerMemoryFeatureFlags;
typedef enum VkMemoryAllocateFlagBits { VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT = 0x00000001, VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT = 0x00000002, VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 0x00000004, VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT_KHR = VK_MEMORY_ALLOCATE_DEVICE_MASK_BIT, VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR = VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT, VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT, VK_MEMORY_ALLOCATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkMemoryAllocateFlagBits;
typedef VkFlags VkMemoryAllocateFlags;
typedef VkFlags VkCommandPoolTrimFlags;
typedef VkFlags VkDescriptorUpdateTemplateCreateFlags;
typedef enum VkExternalMemoryHandleTypeFlagBits { VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT = 0x00000001, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT = 0x00000002, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT = 0x00000004, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT = 0x00000008, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT = 0x00000010, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT = 0x00000020, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT = 0x00000040, VK_EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_BIT_EXT = 0x00000200, VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_BIT_ANDROID = 0x00000400, VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT = 0x00000080, VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_MAPPED_FOREIGN_MEMORY_BIT_EXT = 0x00000100, VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA = 0x00000800, VK_EXTERNAL_MEMORY_HANDLE_TYPE_RDMA_ADDRESS_BIT_NV = 0x00001000, VK_EXTERNAL_MEMORY_HANDLE_TYPE_SCREEN_BUFFER_BIT_QNX = 0x00004000, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT_KHR = VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT, VK_EXTERNAL_MEMORY_HANDLE_TYPE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkExternalMemoryHandleTypeFlagBits;
...
typedef enum VkExternalFenceHandleTypeFlagBits { VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT = 0x00000001, VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT = 0x00000002, VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT = 0x00000004, VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT = 0x00000008, VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT_KHR = VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_FD_BIT, VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT_KHR = VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_BIT, VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT_KHR = VK_EXTERNAL_FENCE_HANDLE_TYPE_OPAQUE_WIN32_KMT_BIT, VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT_KHR = VK_EXTERNAL_FENCE_HANDLE_TYPE_SYNC_FD_BIT, VK_EXTERNAL_FENCE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkExternalFenceHandleTypeFlagBits;
...
/* #define VK_API_VERSION_1_2 VK_MAKE_API_VERSION(0, 1, 2, 0) ### string, not number "VK_MAKE_API_VERSION(0, 1, 2, 0)" */
...
typedef enum VkShaderFloatControlsIndependence { VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY = 0, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL = 1, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE = 2, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE, VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_MAX_ENUM = 0x7FFFFFFF } VkShaderFloatControlsIndependence;
typedef enum VkSamplerReductionMode { VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE = 0, VK_SAMPLER_REDUCTION_MODE_MIN = 1, VK_SAMPLER_REDUCTION_MODE_MAX = 2, VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE_RANGECLAMP_QCOM = 1000521000, VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE_EXT = VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE, VK_SAMPLER_REDUCTION_MODE_MIN_EXT = VK_SAMPLER_REDUCTION_MODE_MIN, VK_SAMPLER_REDUCTION_MODE_MAX_EXT = VK_SAMPLER_REDUCTION_MODE_MAX, VK_SAMPLER_REDUCTION_MODE_MAX_ENUM = 0x7FFFFFFF } VkSamplerReductionMode;
...
typedef enum VkSemaphoreWaitFlagBits { VK_SEMAPHORE_WAIT_ANY_BIT = 0x00000001, VK_SEMAPHORE_WAIT_ANY_BIT_KHR = VK_SEMAPHORE_WAIT_ANY_BIT, VK_SEMAPHORE_WAIT_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF } VkSemaphoreWaitFlagBits;
...
/* #define VK_API_VERSION_1_3 VK_MAKE_API_VERSION(0, 1, 3, 0) ### string, not number "VK_MAKE_API_VERSION(0, 1, 3, 0)" */
...
/* #define VK_KHR_SURFACE_EXTENSION_NAME     "VK_KHR_surface" ### string, not number "\"VK_KHR_surface\"" */
typedef enum VkPresentModeKHR { VK_PRESENT_MODE_IMMEDIATE_KHR = 0, VK_PRESENT_MODE_MAILBOX_KHR = 1, VK_PRESENT_MODE_FIFO_KHR = 2, VK_PRESENT_MODE_FIFO_RELAXED_KHR = 3, VK_PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR = 1000111000, VK_PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR = 1000111001, VK_PRESENT_MODE_MAX_ENUM_KHR = 0x7FFFFFFF } VkPresentModeKHR;
typedef enum VkColorSpaceKHR { VK_COLOR_SPACE_SRGB_NONLINEAR_KHR = 0, VK_COLOR_SPACE_DISPLAY_P3_NONLINEAR_EXT = 1000104001, VK_COLOR_SPACE_EXTENDED_SRGB_LINEAR_EXT = 1000104002, VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT = 1000104003, VK_COLOR_SPACE_DCI_P3_NONLINEAR_EXT = 1000104004, VK_COLOR_SPACE_BT709_LINEAR_EXT = 1000104005, VK_COLOR_SPACE_BT709_NONLINEAR_EXT = 1000104006, VK_COLOR_SPACE_BT2020_LINEAR_EXT = 1000104007, VK_COLOR_SPACE_HDR10_ST2084_EXT = 1000104008, VK_COLOR_SPACE_DOLBYVISION_EXT = 1000104009, VK_COLOR_SPACE_HDR10_HLG_EXT = 1000104010, VK_COLOR_SPACE_ADOBERGB_LINEAR_EXT = 1000104011, VK_COLOR_SPACE_ADOBERGB_NONLINEAR_EXT = 1000104012, VK_COLOR_SPACE_PASS_THROUGH_EXT = 1000104013, VK_COLOR_SPACE_EXTENDED_SRGB_NONLINEAR_EXT = 1000104014, VK_COLOR_SPACE_DISPLAY_NATIVE_AMD = 1000213000, VK_COLORSPACE_SRGB_NONLINEAR_KHR = VK_COLOR_SPACE_SRGB_NONLINEAR_KHR, VK_COLOR_SPACE_DCI_P3_LINEAR_EXT = VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT, VK_COLOR_SPACE_MAX_ENUM_KHR = 0x7FFFFFFF } VkColorSpaceKHR;
...
/* #define VK_KHR_SWAPCHAIN_EXTENSION_NAME   "VK_KHR_swapchain" ### string, not number "\"VK_KHR_swapchain\"" */
typedef enum VkSwapchainCreateFlagBitsKHR { VK_SWAPCHAIN_CREATE_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = 0x00000001, VK_SWAPCHAIN_CREATE_PROTECTED_BIT_KHR = 0x00000002, VK_SWAPCHAIN_CREATE_MUTABLE_FORMAT_BIT_KHR = 0x00000004, VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_EXT = 0x00000008, VK_SWAPCHAIN_CREATE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkSwapchainCreateFlagBitsKHR;
typedef VkFlags VkSwapchainCreateFlagsKHR;
typedef enum VkDeviceGroupPresentModeFlagBitsKHR { VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_BIT_KHR = 0x00000001, VK_DEVICE_GROUP_PRESENT_MODE_REMOTE_BIT_KHR = 0x00000002, VK_DEVICE_GROUP_PRESENT_MODE_SUM_BIT_KHR = 0x00000004, VK_DEVICE_GROUP_PRESENT_MODE_LOCAL_MULTI_DEVICE_BIT_KHR = 0x00000008, VK_DEVICE_GROUP_PRESENT_MODE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkDeviceGroupPresentModeFlagBitsKHR;
...
/* #define VK_KHR_DISPLAY_EXTENSION_NAME     "VK_KHR_display" ### string, not number "\"VK_KHR_display\"" */
typedef VkFlags VkDisplayModeCreateFlagsKHR;
typedef enum VkDisplayPlaneAlphaFlagBitsKHR { VK_DISPLAY_PLANE_ALPHA_OPAQUE_BIT_KHR = 0x00000001, VK_DISPLAY_PLANE_ALPHA_GLOBAL_BIT_KHR = 0x00000002, VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_BIT_KHR = 0x00000004, VK_DISPLAY_PLANE_ALPHA_PER_PIXEL_PREMULTIPLIED_BIT_KHR = 0x00000008, VK_DISPLAY_PLANE_ALPHA_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkDisplayPlaneAlphaFlagBitsKHR;
...
/* #define VK_KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME "VK_KHR_display_swapchain" ### string, not number "\"VK_KHR_display_swapchain\"" */
...
/* #define VK_KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_EXTENSION_NAME "VK_KHR_sampler_mirror_clamp_to_edge" ### string, not number "\"VK_KHR_sampler_mirror_clamp_to_edge\"" */
...
/* #define VK_KHR_VIDEO_QUEUE_EXTENSION_NAME "VK_KHR_video_queue" ### string, not number "\"VK_KHR_video_queue\"" */
typedef enum VkQueryResultStatusKHR { VK_QUERY_RESULT_STATUS_ERROR_KHR = -1, VK_QUERY_RESULT_STATUS_NOT_READY_KHR = 0, VK_QUERY_RESULT_STATUS_COMPLETE_KHR = 1, VK_QUERY_RESULT_STATUS_INSUFFICIENT_BITSTREAM_BUFFER_RANGE_KHR = -1000299000, VK_QUERY_RESULT_STATUS_MAX_ENUM_KHR = 0x7FFFFFFF } VkQueryResultStatusKHR;
...
typedef enum VkVideoChromaSubsamplingFlagBitsKHR { VK_VIDEO_CHROMA_SUBSAMPLING_INVALID_KHR = 0, VK_VIDEO_CHROMA_SUBSAMPLING_MONOCHROME_BIT_KHR = 0x00000001, VK_VIDEO_CHROMA_SUBSAMPLING_420_BIT_KHR = 0x00000002, VK_VIDEO_CHROMA_SUBSAMPLING_422_BIT_KHR = 0x00000004, VK_VIDEO_CHROMA_SUBSAMPLING_444_BIT_KHR = 0x00000008, VK_VIDEO_CHROMA_SUBSAMPLING_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoChromaSubsamplingFlagBitsKHR;
typedef VkFlags VkVideoChromaSubsamplingFlagsKHR;
typedef enum VkVideoComponentBitDepthFlagBitsKHR { VK_VIDEO_COMPONENT_BIT_DEPTH_INVALID_KHR = 0, VK_VIDEO_COMPONENT_BIT_DEPTH_8_BIT_KHR = 0x00000001, VK_VIDEO_COMPONENT_BIT_DEPTH_10_BIT_KHR = 0x00000004, VK_VIDEO_COMPONENT_BIT_DEPTH_12_BIT_KHR = 0x00000010, VK_VIDEO_COMPONENT_BIT_DEPTH_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoComponentBitDepthFlagBitsKHR;
typedef VkFlags VkVideoComponentBitDepthFlagsKHR;
typedef enum VkVideoCapabilityFlagBitsKHR { VK_VIDEO_CAPABILITY_PROTECTED_CONTENT_BIT_KHR = 0x00000001, VK_VIDEO_CAPABILITY_SEPARATE_REFERENCE_IMAGES_BIT_KHR = 0x00000002, VK_VIDEO_CAPABILITY_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoCapabilityFlagBitsKHR;
typedef VkFlags VkVideoCapabilityFlagsKHR;
typedef enum VkVideoSessionCreateFlagBitsKHR { VK_VIDEO_SESSION_CREATE_PROTECTED_CONTENT_BIT_KHR = 0x00000001, VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_PARAMETER_OPTIMIZATIONS_BIT_KHR = 0x00000002, VK_VIDEO_SESSION_CREATE_INLINE_QUERIES_BIT_KHR = 0x00000004, VK_VIDEO_SESSION_CREATE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoSessionCreateFlagBitsKHR;
typedef VkFlags VkVideoSessionCreateFlagsKHR;
typedef VkFlags VkVideoSessionParametersCreateFlagsKHR;
typedef VkFlags VkVideoBeginCodingFlagsKHR;
typedef VkFlags VkVideoEndCodingFlagsKHR;
typedef enum VkVideoCodingControlFlagBitsKHR { VK_VIDEO_CODING_CONTROL_RESET_BIT_KHR = 0x00000001, VK_VIDEO_CODING_CONTROL_ENCODE_RATE_CONTROL_BIT_KHR = 0x00000002, VK_VIDEO_CODING_CONTROL_ENCODE_QUALITY_LEVEL_BIT_KHR = 0x00000004, VK_VIDEO_CODING_CONTROL_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoCodingControlFlagBitsKHR;
...
/* #define VK_KHR_VIDEO_DECODE_QUEUE_EXTENSION_NAME "VK_KHR_video_decode_queue" ### string, not number "\"VK_KHR_video_decode_queue\"" */
typedef enum VkVideoDecodeCapabilityFlagBitsKHR { VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_COINCIDE_BIT_KHR = 0x00000001, VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_DISTINCT_BIT_KHR = 0x00000002, VK_VIDEO_DECODE_CAPABILITY_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoDecodeCapabilityFlagBitsKHR;
typedef VkFlags VkVideoDecodeCapabilityFlagsKHR;
typedef enum VkVideoDecodeUsageFlagBitsKHR { VK_VIDEO_DECODE_USAGE_DEFAULT_KHR = 0, VK_VIDEO_DECODE_USAGE_TRANSCODING_BIT_KHR = 0x00000001, VK_VIDEO_DECODE_USAGE_OFFLINE_BIT_KHR = 0x00000002, VK_VIDEO_DECODE_USAGE_STREAMING_BIT_KHR = 0x00000004, VK_VIDEO_DECODE_USAGE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoDecodeUsageFlagBitsKHR;
...
enum { VK_KHR_video_encode_h264 = 1 };
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h264std.h */
enum { VULKAN_VIDEO_CODEC_H264STD_H_ = 1 };
enum { vulkan_video_codec_h264std = 1 };
/* +++ BEGIN /usr/include/vk_video/vulkan_video_codecs_common.h */
enum { VULKAN_VIDEO_CODECS_COMMON_H_ = 1 };
enum { vulkan_video_codecs_common = 1 };
/* ++++ BEGIN /usr/lib/gcc/x86_64-linux-gnu/13/include/stdint.h */
]] require 'ffi.req' 'c.stdint' ffi.cdef[[
/* ++++ END   /usr/lib/gcc/x86_64-linux-gnu/13/include/stdint.h */
/* +++ END   /usr/include/vk_video/vulkan_video_codecs_common.h */
...
/* ++ END   /usr/include/vk_video/vulkan_video_codec_h264std.h */
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h264std_encode.h */
enum { VULKAN_VIDEO_CODEC_H264STD_ENCODE_H_ = 1 };
enum { vulkan_video_codec_h264std_encode = 1 };
/* +++ BEGIN /usr/include/vk_video/vulkan_video_codec_h264std.h */
/* +++ END   /usr/include/vk_video/vulkan_video_codec_h264std.h */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_API_VERSION_1_0_0 VK_MAKE_VIDEO_STD_VERSION(1, 0, 0) ### string, not number "VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_SPEC_VERSION VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_API_VERSION_1_0_0 ### string, not number "VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_API_VERSION_1_0_0" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_EXTENSION_NAME "VK_STD_vulkan_video_codec_h264_encode" ### string, not number "\"VK_STD_vulkan_video_codec_h264_encode\"" */
...
enum { VK_KHR_video_encode_h265 = 1 };
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h265std.h */
enum { VULKAN_VIDEO_CODEC_H265STD_H_ = 1 };
...
enum { STD_VIDEO_H265_NO_REFERENCE_PICTURE = 255 };
typedef enum StdVideoH265ChromaFormatIdc { STD_VIDEO_H265_CHROMA_FORMAT_IDC_MONOCHROME = 0, STD_VIDEO_H265_CHROMA_FORMAT_IDC_420 = 1, STD_VIDEO_H265_CHROMA_FORMAT_IDC_422 = 2, STD_VIDEO_H265_CHROMA_FORMAT_IDC_444 = 3, STD_VIDEO_H265_CHROMA_FORMAT_IDC_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_CHROMA_FORMAT_IDC_MAX_ENUM = 0x7FFFFFFF } StdVideoH265ChromaFormatIdc;
typedef enum StdVideoH265ProfileIdc { STD_VIDEO_H265_PROFILE_IDC_MAIN = 1, STD_VIDEO_H265_PROFILE_IDC_MAIN_10 = 2, STD_VIDEO_H265_PROFILE_IDC_MAIN_STILL_PICTURE = 3, STD_VIDEO_H265_PROFILE_IDC_FORMAT_RANGE_EXTENSIONS = 4, STD_VIDEO_H265_PROFILE_IDC_SCC_EXTENSIONS = 9, STD_VIDEO_H265_PROFILE_IDC_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_PROFILE_IDC_MAX_ENUM = 0x7FFFFFFF } StdVideoH265ProfileIdc;
typedef enum StdVideoH265LevelIdc { STD_VIDEO_H265_LEVEL_IDC_1_0 = 0, STD_VIDEO_H265_LEVEL_IDC_2_0 = 1, STD_VIDEO_H265_LEVEL_IDC_2_1 = 2, STD_VIDEO_H265_LEVEL_IDC_3_0 = 3, STD_VIDEO_H265_LEVEL_IDC_3_1 = 4, STD_VIDEO_H265_LEVEL_IDC_4_0 = 5, STD_VIDEO_H265_LEVEL_IDC_4_1 = 6, STD_VIDEO_H265_LEVEL_IDC_5_0 = 7, STD_VIDEO_H265_LEVEL_IDC_5_1 = 8, STD_VIDEO_H265_LEVEL_IDC_5_2 = 9, STD_VIDEO_H265_LEVEL_IDC_6_0 = 10, STD_VIDEO_H265_LEVEL_IDC_6_1 = 11, STD_VIDEO_H265_LEVEL_IDC_6_2 = 12, STD_VIDEO_H265_LEVEL_IDC_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_LEVEL_IDC_MAX_ENUM = 0x7FFFFFFF } StdVideoH265LevelIdc;
typedef enum StdVideoH265SliceType { STD_VIDEO_H265_SLICE_TYPE_B = 0, STD_VIDEO_H265_SLICE_TYPE_P = 1, STD_VIDEO_H265_SLICE_TYPE_I = 2, STD_VIDEO_H265_SLICE_TYPE_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_SLICE_TYPE_MAX_ENUM = 0x7FFFFFFF } StdVideoH265SliceType;
typedef enum StdVideoH265PictureType { STD_VIDEO_H265_PICTURE_TYPE_P = 0, STD_VIDEO_H265_PICTURE_TYPE_B = 1, STD_VIDEO_H265_PICTURE_TYPE_I = 2, STD_VIDEO_H265_PICTURE_TYPE_IDR = 3, STD_VIDEO_H265_PICTURE_TYPE_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_PICTURE_TYPE_MAX_ENUM = 0x7FFFFFFF } StdVideoH265PictureType;
typedef enum StdVideoH265AspectRatioIdc { STD_VIDEO_H265_ASPECT_RATIO_IDC_UNSPECIFIED = 0, STD_VIDEO_H265_ASPECT_RATIO_IDC_SQUARE = 1, STD_VIDEO_H265_ASPECT_RATIO_IDC_12_11 = 2, STD_VIDEO_H265_ASPECT_RATIO_IDC_10_11 = 3, STD_VIDEO_H265_ASPECT_RATIO_IDC_16_11 = 4, STD_VIDEO_H265_ASPECT_RATIO_IDC_40_33 = 5, STD_VIDEO_H265_ASPECT_RATIO_IDC_24_11 = 6, STD_VIDEO_H265_ASPECT_RATIO_IDC_20_11 = 7, STD_VIDEO_H265_ASPECT_RATIO_IDC_32_11 = 8, STD_VIDEO_H265_ASPECT_RATIO_IDC_80_33 = 9, STD_VIDEO_H265_ASPECT_RATIO_IDC_18_11 = 10, STD_VIDEO_H265_ASPECT_RATIO_IDC_15_11 = 11, STD_VIDEO_H265_ASPECT_RATIO_IDC_64_33 = 12, STD_VIDEO_H265_ASPECT_RATIO_IDC_160_99 = 13, STD_VIDEO_H265_ASPECT_RATIO_IDC_4_3 = 14, STD_VIDEO_H265_ASPECT_RATIO_IDC_3_2 = 15, STD_VIDEO_H265_ASPECT_RATIO_IDC_2_1 = 16, STD_VIDEO_H265_ASPECT_RATIO_IDC_EXTENDED_SAR = 255, STD_VIDEO_H265_ASPECT_RATIO_IDC_INVALID = 0x7FFFFFFF, STD_VIDEO_H265_ASPECT_RATIO_IDC_MAX_ENUM = 0x7FFFFFFF } StdVideoH265AspectRatioIdc;
...
/* ++ END   /usr/include/vk_video/vulkan_video_codec_h265std.h */
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h265std_encode.h */
enum { VULKAN_VIDEO_CODEC_H265STD_ENCODE_H_ = 1 };
enum { vulkan_video_codec_h265std_encode = 1 };
/* +++ BEGIN /usr/include/vk_video/vulkan_video_codec_h265std.h */
/* +++ END   /usr/include/vk_video/vulkan_video_codec_h265std.h */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_API_VERSION_1_0_0 VK_MAKE_VIDEO_STD_VERSION(1, 0, 0) ### string, not number "VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_SPEC_VERSION VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_API_VERSION_1_0_0 ### string, not number "VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_API_VERSION_1_0_0" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_EXTENSION_NAME "VK_STD_vulkan_video_codec_h265_encode" ### string, not number "\"VK_STD_vulkan_video_codec_h265_encode\"" */
...
/* ++ END   /usr/include/vk_video/vulkan_video_codec_h265std_encode.h */
enum { VK_KHR_VIDEO_ENCODE_H265_SPEC_VERSION = 14 };
/* #define VK_KHR_VIDEO_ENCODE_H265_EXTENSION_NAME "VK_KHR_video_encode_h265" ### string, not number "\"VK_KHR_video_encode_h265\"" */
...
typedef enum VkVideoEncodeH265CtbSizeFlagBitsKHR { VK_VIDEO_ENCODE_H265_CTB_SIZE_16_BIT_KHR = 0x00000001, VK_VIDEO_ENCODE_H265_CTB_SIZE_32_BIT_KHR = 0x00000002, VK_VIDEO_ENCODE_H265_CTB_SIZE_64_BIT_KHR = 0x00000004, VK_VIDEO_ENCODE_H265_CTB_SIZE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoEncodeH265CtbSizeFlagBitsKHR;
...
enum { VK_KHR_video_decode_h264 = 1 };
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h264std_decode.h */
enum { VULKAN_VIDEO_CODEC_H264STD_DECODE_H_ = 1 };
enum { vulkan_video_codec_h264std_decode = 1 };
/* +++ BEGIN /usr/include/vk_video/vulkan_video_codec_h264std.h */
/* +++ END   /usr/include/vk_video/vulkan_video_codec_h264std.h */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_API_VERSION_1_0_0 VK_MAKE_VIDEO_STD_VERSION(1, 0, 0) ### string, not number "VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_SPEC_VERSION VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_API_VERSION_1_0_0 ### string, not number "VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_API_VERSION_1_0_0" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_EXTENSION_NAME "VK_STD_vulkan_video_codec_h264_decode" ### string, not number "\"VK_STD_vulkan_video_codec_h264_decode\"" */
enum { STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_LIST_SIZE = 2 };
typedef enum StdVideoDecodeH264FieldOrderCount { STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_TOP = 0, STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_BOTTOM = 1, STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_INVALID = 0x7FFFFFFF, STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_MAX_ENUM = 0x7FFFFFFF } StdVideoDecodeH264FieldOrderCount;
...
/* #define VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME "VK_KHR_dynamic_rendering" ### string, not number "\"VK_KHR_dynamic_rendering\"" */
...
/* #define VK_KHR_MULTIVIEW_EXTENSION_NAME   "VK_KHR_multiview" ### string, not number "\"VK_KHR_multiview\"" */
...
/* #define VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME "VK_KHR_get_physical_device_properties2" ### string, not number "\"VK_KHR_get_physical_device_properties2\"" */
...
/* #define VK_KHR_DEVICE_GROUP_EXTENSION_NAME "VK_KHR_device_group" ### string, not number "\"VK_KHR_device_group\"" */
...
/* #define VK_KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME "VK_KHR_shader_draw_parameters" ### string, not number "\"VK_KHR_shader_draw_parameters\"" */
enum { VK_KHR_maintenance1 = 1 };
enum { VK_KHR_MAINTENANCE_1_SPEC_VERSION = 2 };
/* #define VK_KHR_MAINTENANCE_1_EXTENSION_NAME "VK_KHR_maintenance1" ### string, not number "\"VK_KHR_maintenance1\"" */
enum { VK_KHR_MAINTENANCE1_SPEC_VERSION = 2 };
/* #define VK_KHR_MAINTENANCE1_EXTENSION_NAME VK_KHR_MAINTENANCE_1_EXTENSION_NAME ### string, not number "VK_KHR_MAINTENANCE_1_EXTENSION_NAME" */
...
/* #define VK_KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME "VK_KHR_device_group_creation" ### string, not number "\"VK_KHR_device_group_creation\"" */
enum { VK_MAX_DEVICE_GROUP_SIZE_KHR = 32 };
...
/* #define VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME "VK_KHR_external_memory_capabilities" ### string, not number "\"VK_KHR_external_memory_capabilities\"" */
...
/* #define VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME "VK_KHR_external_memory" ### string, not number "\"VK_KHR_external_memory\"" */
enum { VK_QUEUE_FAMILY_EXTERNAL_KHR = -2 };
typedef VkExternalMemoryImageCreateInfo VkExternalMemoryImageCreateInfoKHR;
typedef VkExternalMemoryBufferCreateInfo VkExternalMemoryBufferCreateInfoKHR;
typedef VkExportMemoryAllocateInfo VkExportMemoryAllocateInfoKHR;
enum { VK_KHR_external_memory_fd = 1 };
enum { VK_KHR_EXTERNAL_MEMORY_FD_SPEC_VERSION = 1 };
/* #define VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME "VK_KHR_external_memory_fd" ### string, not number "\"VK_KHR_external_memory_fd\"" */
...
/* #define VK_KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME "VK_KHR_external_semaphore_capabilities" ### string, not number "\"VK_KHR_external_semaphore_capabilities\"" */
...
/* #define VK_KHR_EXTERNAL_SEMAPHORE_EXTENSION_NAME "VK_KHR_external_semaphore" ### string, not number "\"VK_KHR_external_semaphore\"" */
typedef VkSemaphoreImportFlags VkSemaphoreImportFlagsKHR;
typedef VkSemaphoreImportFlagBits VkSemaphoreImportFlagBitsKHR;
typedef VkExportSemaphoreCreateInfo VkExportSemaphoreCreateInfoKHR;
enum { VK_KHR_external_semaphore_fd = 1 };
enum { VK_KHR_EXTERNAL_SEMAPHORE_FD_SPEC_VERSION = 1 };
/* #define VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME "VK_KHR_external_semaphore_fd" ### string, not number "\"VK_KHR_external_semaphore_fd\"" */
...
/* #define VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME "VK_KHR_push_descriptor" ### string, not number "\"VK_KHR_push_descriptor\"" */
...
/* #define VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME "VK_KHR_shader_float16_int8" ### string, not number "\"VK_KHR_shader_float16_int8\"" */
typedef VkPhysicalDeviceShaderFloat16Int8Features VkPhysicalDeviceShaderFloat16Int8FeaturesKHR;
typedef VkPhysicalDeviceShaderFloat16Int8Features VkPhysicalDeviceFloat16Int8FeaturesKHR;
enum { VK_KHR_16bit_storage = 1 };
enum { VK_KHR_16BIT_STORAGE_SPEC_VERSION = 1 };
/* #define VK_KHR_16BIT_STORAGE_EXTENSION_NAME "VK_KHR_16bit_storage" ### string, not number "\"VK_KHR_16bit_storage\"" */
typedef VkPhysicalDevice16BitStorageFeatures VkPhysicalDevice16BitStorageFeaturesKHR;
enum { VK_KHR_incremental_present = 1 };
enum { VK_KHR_INCREMENTAL_PRESENT_SPEC_VERSION = 2 };
/* #define VK_KHR_INCREMENTAL_PRESENT_EXTENSION_NAME "VK_KHR_incremental_present" ### string, not number "\"VK_KHR_incremental_present\"" */
...
/* #define VK_KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME "VK_KHR_descriptor_update_template" ### string, not number "\"VK_KHR_descriptor_update_template\"" */
...
/* #define VK_KHR_IMAGELESS_FRAMEBUFFER_EXTENSION_NAME "VK_KHR_imageless_framebuffer" ### string, not number "\"VK_KHR_imageless_framebuffer\"" */
...
/* #define VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME "VK_KHR_create_renderpass2" ### string, not number "\"VK_KHR_create_renderpass2\"" */
...
/* #define VK_KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME "VK_KHR_shared_presentable_image" ### string, not number "\"VK_KHR_shared_presentable_image\"" */
...
/* #define VK_KHR_EXTERNAL_FENCE_CAPABILITIES_EXTENSION_NAME "VK_KHR_external_fence_capabilities" ### string, not number "\"VK_KHR_external_fence_capabilities\"" */
...
/* #define VK_KHR_EXTERNAL_FENCE_EXTENSION_NAME "VK_KHR_external_fence" ### string, not number "\"VK_KHR_external_fence\"" */
typedef VkFenceImportFlags VkFenceImportFlagsKHR;
typedef VkFenceImportFlagBits VkFenceImportFlagBitsKHR;
typedef VkExportFenceCreateInfo VkExportFenceCreateInfoKHR;
enum { VK_KHR_external_fence_fd = 1 };
enum { VK_KHR_EXTERNAL_FENCE_FD_SPEC_VERSION = 1 };
/* #define VK_KHR_EXTERNAL_FENCE_FD_EXTENSION_NAME "VK_KHR_external_fence_fd" ### string, not number "\"VK_KHR_external_fence_fd\"" */
...
/* #define VK_KHR_PERFORMANCE_QUERY_EXTENSION_NAME "VK_KHR_performance_query" ### string, not number "\"VK_KHR_performance_query\"" */
...
typedef enum VkPerformanceCounterScopeKHR { VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR = 0, VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR = 1, VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR = 2, VK_QUERY_SCOPE_COMMAND_BUFFER_KHR = VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR, VK_QUERY_SCOPE_RENDER_PASS_KHR = VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR, VK_QUERY_SCOPE_COMMAND_KHR = VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR, VK_PERFORMANCE_COUNTER_SCOPE_MAX_ENUM_KHR = 0x7FFFFFFF } VkPerformanceCounterScopeKHR;
typedef enum VkPerformanceCounterStorageKHR { VK_PERFORMANCE_COUNTER_STORAGE_INT32_KHR = 0, VK_PERFORMANCE_COUNTER_STORAGE_INT64_KHR = 1, VK_PERFORMANCE_COUNTER_STORAGE_UINT32_KHR = 2, VK_PERFORMANCE_COUNTER_STORAGE_UINT64_KHR = 3, VK_PERFORMANCE_COUNTER_STORAGE_FLOAT32_KHR = 4, VK_PERFORMANCE_COUNTER_STORAGE_FLOAT64_KHR = 5, VK_PERFORMANCE_COUNTER_STORAGE_MAX_ENUM_KHR = 0x7FFFFFFF } VkPerformanceCounterStorageKHR;
typedef enum VkPerformanceCounterDescriptionFlagBitsKHR { VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_BIT_KHR = 0x00000001, VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR = 0x00000002, VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_KHR = VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_BIT_KHR, VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_KHR = VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR, VK_PERFORMANCE_COUNTER_DESCRIPTION_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkPerformanceCounterDescriptionFlagBitsKHR;
typedef VkFlags VkPerformanceCounterDescriptionFlagsKHR;
typedef enum VkAcquireProfilingLockFlagBitsKHR { VK_ACQUIRE_PROFILING_LOCK_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkAcquireProfilingLockFlagBitsKHR;
...
/* #define VK_KHR_MAINTENANCE_2_EXTENSION_NAME "VK_KHR_maintenance2" ### string, not number "\"VK_KHR_maintenance2\"" */
enum { VK_KHR_MAINTENANCE2_SPEC_VERSION = 1 };
/* #define VK_KHR_MAINTENANCE2_EXTENSION_NAME VK_KHR_MAINTENANCE_2_EXTENSION_NAME ### string, not number "VK_KHR_MAINTENANCE_2_EXTENSION_NAME" */
...
/* #define VK_KHR_GET_SURFACE_CAPABILITIES_2_EXTENSION_NAME "VK_KHR_get_surface_capabilities2" ### string, not number "\"VK_KHR_get_surface_capabilities2\"" */
...
/* #define VK_KHR_VARIABLE_POINTERS_EXTENSION_NAME "VK_KHR_variable_pointers" ### string, not number "\"VK_KHR_variable_pointers\"" */
...
/* #define VK_KHR_GET_DISPLAY_PROPERTIES_2_EXTENSION_NAME "VK_KHR_get_display_properties2" ### string, not number "\"VK_KHR_get_display_properties2\"" */
...
/* #define VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME "VK_KHR_dedicated_allocation" ### string, not number "\"VK_KHR_dedicated_allocation\"" */
...
/* #define VK_KHR_STORAGE_BUFFER_STORAGE_CLASS_EXTENSION_NAME "VK_KHR_storage_buffer_storage_class" ### string, not number "\"VK_KHR_storage_buffer_storage_class\"" */
enum { VK_KHR_relaxed_block_layout = 1 };
enum { VK_KHR_RELAXED_BLOCK_LAYOUT_SPEC_VERSION = 1 };
/* #define VK_KHR_RELAXED_BLOCK_LAYOUT_EXTENSION_NAME "VK_KHR_relaxed_block_layout" ### string, not number "\"VK_KHR_relaxed_block_layout\"" */
enum { VK_KHR_get_memory_requirements2 = 1 };
enum { VK_KHR_GET_MEMORY_REQUIREMENTS_2_SPEC_VERSION = 1 };
/* #define VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME "VK_KHR_get_memory_requirements2" ### string, not number "\"VK_KHR_get_memory_requirements2\"" */
...
/* #define VK_KHR_IMAGE_FORMAT_LIST_EXTENSION_NAME "VK_KHR_image_format_list" ### string, not number "\"VK_KHR_image_format_list\"" */
typedef VkImageFormatListCreateInfo VkImageFormatListCreateInfoKHR;
enum { VK_KHR_sampler_ycbcr_conversion = 1 };
typedef VkSamplerYcbcrConversion VkSamplerYcbcrConversionKHR;
enum { VK_KHR_SAMPLER_YCBCR_CONVERSION_SPEC_VERSION = 14 };
/* #define VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME "VK_KHR_sampler_ycbcr_conversion" ### string, not number "\"VK_KHR_sampler_ycbcr_conversion\"" */
...
/* #define VK_KHR_BIND_MEMORY_2_EXTENSION_NAME "VK_KHR_bind_memory2" ### string, not number "\"VK_KHR_bind_memory2\"" */
...
/* #define VK_KHR_MAINTENANCE_3_EXTENSION_NAME "VK_KHR_maintenance3" ### string, not number "\"VK_KHR_maintenance3\"" */
enum { VK_KHR_MAINTENANCE3_SPEC_VERSION = 1 };
/* #define VK_KHR_MAINTENANCE3_EXTENSION_NAME VK_KHR_MAINTENANCE_3_EXTENSION_NAME ### string, not number "VK_KHR_MAINTENANCE_3_EXTENSION_NAME" */
...
/* #define VK_KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME "VK_KHR_draw_indirect_count" ### string, not number "\"VK_KHR_draw_indirect_count\"" */
...
/* #define VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_EXTENSION_NAME "VK_KHR_shader_subgroup_extended_types" ### string, not number "\"VK_KHR_shader_subgroup_extended_types\"" */
typedef VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures VkPhysicalDeviceShaderSubgroupExtendedTypesFeaturesKHR;
enum { VK_KHR_8bit_storage = 1 };
enum { VK_KHR_8BIT_STORAGE_SPEC_VERSION = 1 };
/* #define VK_KHR_8BIT_STORAGE_EXTENSION_NAME "VK_KHR_8bit_storage" ### string, not number "\"VK_KHR_8bit_storage\"" */
typedef VkPhysicalDevice8BitStorageFeatures VkPhysicalDevice8BitStorageFeaturesKHR;
enum { VK_KHR_shader_atomic_int64 = 1 };
enum { VK_KHR_SHADER_ATOMIC_INT64_SPEC_VERSION = 1 };
/* #define VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME "VK_KHR_shader_atomic_int64" ### string, not number "\"VK_KHR_shader_atomic_int64\"" */
typedef VkPhysicalDeviceShaderAtomicInt64Features VkPhysicalDeviceShaderAtomicInt64FeaturesKHR;
enum { VK_KHR_shader_clock = 1 };
enum { VK_KHR_SHADER_CLOCK_SPEC_VERSION = 1 };
/* #define VK_KHR_SHADER_CLOCK_EXTENSION_NAME "VK_KHR_shader_clock" ### string, not number "\"VK_KHR_shader_clock\"" */
...
enum { VK_KHR_video_decode_h265 = 1 };
/* ++ BEGIN /usr/include/vk_video/vulkan_video_codec_h265std_decode.h */
enum { VULKAN_VIDEO_CODEC_H265STD_DECODE_H_ = 1 };
enum { vulkan_video_codec_h265std_decode = 1 };
/* +++ BEGIN /usr/include/vk_video/vulkan_video_codec_h265std.h */
/* +++ END   /usr/include/vk_video/vulkan_video_codec_h265std.h */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_API_VERSION_1_0_0 VK_MAKE_VIDEO_STD_VERSION(1, 0, 0) ### string, not number "VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_SPEC_VERSION VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_API_VERSION_1_0_0 ### string, not number "VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_API_VERSION_1_0_0" */
/* #define VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_EXTENSION_NAME "VK_STD_vulkan_video_codec_h265_decode" ### string, not number "\"VK_STD_vulkan_video_codec_h265_decode\"" */
...
/* ++ END   /usr/include/vk_video/vulkan_video_codec_h265std_decode.h */
enum { VK_KHR_VIDEO_DECODE_H265_SPEC_VERSION = 8 };
/* #define VK_KHR_VIDEO_DECODE_H265_EXTENSION_NAME "VK_KHR_video_decode_h265" ### string, not number "\"VK_KHR_video_decode_h265\"" */
...
/* #define VK_KHR_DRIVER_PROPERTIES_EXTENSION_NAME "VK_KHR_driver_properties" ### string, not number "\"VK_KHR_driver_properties\"" */
...
/* #define VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME "VK_KHR_shader_float_controls" ### string, not number "\"VK_KHR_shader_float_controls\"" */
typedef VkShaderFloatControlsIndependence VkShaderFloatControlsIndependenceKHR;
typedef VkPhysicalDeviceFloatControlsProperties VkPhysicalDeviceFloatControlsPropertiesKHR;
enum { VK_KHR_depth_stencil_resolve = 1 };
enum { VK_KHR_DEPTH_STENCIL_RESOLVE_SPEC_VERSION = 1 };
/* #define VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME "VK_KHR_depth_stencil_resolve" ### string, not number "\"VK_KHR_depth_stencil_resolve\"" */
...
/* #define VK_KHR_SWAPCHAIN_MUTABLE_FORMAT_EXTENSION_NAME "VK_KHR_swapchain_mutable_format" ### string, not number "\"VK_KHR_swapchain_mutable_format\"" */
enum { VK_KHR_timeline_semaphore = 1 };
enum { VK_KHR_TIMELINE_SEMAPHORE_SPEC_VERSION = 2 };
/* #define VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME "VK_KHR_timeline_semaphore" ### string, not number "\"VK_KHR_timeline_semaphore\"" */
...
/* #define VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME "VK_KHR_vulkan_memory_model" ### string, not number "\"VK_KHR_vulkan_memory_model\"" */
typedef VkPhysicalDeviceVulkanMemoryModelFeatures VkPhysicalDeviceVulkanMemoryModelFeaturesKHR;
enum { VK_KHR_shader_terminate_invocation = 1 };
enum { VK_KHR_SHADER_TERMINATE_INVOCATION_SPEC_VERSION = 1 };
/* #define VK_KHR_SHADER_TERMINATE_INVOCATION_EXTENSION_NAME "VK_KHR_shader_terminate_invocation" ### string, not number "\"VK_KHR_shader_terminate_invocation\"" */
typedef VkPhysicalDeviceShaderTerminateInvocationFeatures VkPhysicalDeviceShaderTerminateInvocationFeaturesKHR;
enum { VK_KHR_fragment_shading_rate = 1 };
enum { VK_KHR_FRAGMENT_SHADING_RATE_SPEC_VERSION = 2 };
/* #define VK_KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME "VK_KHR_fragment_shading_rate" ### string, not number "\"VK_KHR_fragment_shading_rate\"" */
typedef enum VkFragmentShadingRateCombinerOpKHR { VK_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_KHR = 0, VK_FRAGMENT_SHADING_RATE_COMBINER_OP_REPLACE_KHR = 1, VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MIN_KHR = 2, VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_KHR = 3, VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MUL_KHR = 4, VK_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_ENUM_KHR = 0x7FFFFFFF } VkFragmentShadingRateCombinerOpKHR;
...
/* #define VK_KHR_SPIRV_1_4_EXTENSION_NAME   "VK_KHR_spirv_1_4" ### string, not number "\"VK_KHR_spirv_1_4\"" */
enum { VK_KHR_surface_protected_capabilities = 1 };
enum { VK_KHR_SURFACE_PROTECTED_CAPABILITIES_SPEC_VERSION = 1 };
/* #define VK_KHR_SURFACE_PROTECTED_CAPABILITIES_EXTENSION_NAME "VK_KHR_surface_protected_capabilities" ### string, not number "\"VK_KHR_surface_protected_capabilities\"" */
...
/* #define VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_EXTENSION_NAME "VK_KHR_separate_depth_stencil_layouts" ### string, not number "\"VK_KHR_separate_depth_stencil_layouts\"" */
typedef VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures VkPhysicalDeviceSeparateDepthStencilLayoutsFeaturesKHR;
typedef VkAttachmentReferenceStencilLayout VkAttachmentReferenceStencilLayoutKHR;
typedef VkAttachmentDescriptionStencilLayout VkAttachmentDescriptionStencilLayoutKHR;
enum { VK_KHR_present_wait = 1 };
enum { VK_KHR_PRESENT_WAIT_SPEC_VERSION = 1 };
/* #define VK_KHR_PRESENT_WAIT_EXTENSION_NAME "VK_KHR_present_wait" ### string, not number "\"VK_KHR_present_wait\"" */
...
/* #define VK_KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_EXTENSION_NAME "VK_KHR_uniform_buffer_standard_layout" ### string, not number "\"VK_KHR_uniform_buffer_standard_layout\"" */
typedef VkPhysicalDeviceUniformBufferStandardLayoutFeatures VkPhysicalDeviceUniformBufferStandardLayoutFeaturesKHR;
enum { VK_KHR_buffer_device_address = 1 };
enum { VK_KHR_BUFFER_DEVICE_ADDRESS_SPEC_VERSION = 1 };
/* #define VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME "VK_KHR_buffer_device_address" ### string, not number "\"VK_KHR_buffer_device_address\"" */
...
/* #define VK_KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME "VK_KHR_deferred_host_operations" ### string, not number "\"VK_KHR_deferred_host_operations\"" */
...
/* #define VK_KHR_PIPELINE_EXECUTABLE_PROPERTIES_EXTENSION_NAME "VK_KHR_pipeline_executable_properties" ### string, not number "\"VK_KHR_pipeline_executable_properties\"" */
...
/* #define VK_KHR_MAP_MEMORY_2_EXTENSION_NAME "VK_KHR_map_memory2" ### string, not number "\"VK_KHR_map_memory2\"" */
...
/* #define VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME "VK_KHR_shader_integer_dot_product" ### string, not number "\"VK_KHR_shader_integer_dot_product\"" */
typedef VkPhysicalDeviceShaderIntegerDotProductFeatures VkPhysicalDeviceShaderIntegerDotProductFeaturesKHR;
typedef VkPhysicalDeviceShaderIntegerDotProductProperties VkPhysicalDeviceShaderIntegerDotProductPropertiesKHR;
enum { VK_KHR_pipeline_library = 1 };
enum { VK_KHR_PIPELINE_LIBRARY_SPEC_VERSION = 1 };
/* #define VK_KHR_PIPELINE_LIBRARY_EXTENSION_NAME "VK_KHR_pipeline_library" ### string, not number "\"VK_KHR_pipeline_library\"" */
...
/* #define VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME "VK_KHR_shader_non_semantic_info" ### string, not number "\"VK_KHR_shader_non_semantic_info\"" */
enum { VK_KHR_present_id = 1 };
enum { VK_KHR_PRESENT_ID_SPEC_VERSION = 1 };
/* #define VK_KHR_PRESENT_ID_EXTENSION_NAME  "VK_KHR_present_id" ### string, not number "\"VK_KHR_present_id\"" */
...
typedef enum VkVideoEncodeRateControlModeFlagBitsKHR { VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DEFAULT_KHR = 0, VK_VIDEO_ENCODE_RATE_CONTROL_MODE_DISABLED_BIT_KHR = 0x00000001, VK_VIDEO_ENCODE_RATE_CONTROL_MODE_CBR_BIT_KHR = 0x00000002, VK_VIDEO_ENCODE_RATE_CONTROL_MODE_VBR_BIT_KHR = 0x00000004, VK_VIDEO_ENCODE_RATE_CONTROL_MODE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoEncodeRateControlModeFlagBitsKHR;
typedef VkFlags VkVideoEncodeRateControlModeFlagsKHR;
typedef enum VkVideoEncodeFeedbackFlagBitsKHR { VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR = 0x00000001, VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_BYTES_WRITTEN_BIT_KHR = 0x00000002, VK_VIDEO_ENCODE_FEEDBACK_BITSTREAM_HAS_OVERRIDES_BIT_KHR = 0x00000004, VK_VIDEO_ENCODE_FEEDBACK_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoEncodeFeedbackFlagBitsKHR;
typedef VkFlags VkVideoEncodeFeedbackFlagsKHR;
typedef enum VkVideoEncodeUsageFlagBitsKHR { VK_VIDEO_ENCODE_USAGE_DEFAULT_KHR = 0, VK_VIDEO_ENCODE_USAGE_TRANSCODING_BIT_KHR = 0x00000001, VK_VIDEO_ENCODE_USAGE_STREAMING_BIT_KHR = 0x00000002, VK_VIDEO_ENCODE_USAGE_RECORDING_BIT_KHR = 0x00000004, VK_VIDEO_ENCODE_USAGE_CONFERENCING_BIT_KHR = 0x00000008, VK_VIDEO_ENCODE_USAGE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoEncodeUsageFlagBitsKHR;
typedef VkFlags VkVideoEncodeUsageFlagsKHR;
typedef enum VkVideoEncodeContentFlagBitsKHR { VK_VIDEO_ENCODE_CONTENT_DEFAULT_KHR = 0, VK_VIDEO_ENCODE_CONTENT_CAMERA_BIT_KHR = 0x00000001, VK_VIDEO_ENCODE_CONTENT_DESKTOP_BIT_KHR = 0x00000002, VK_VIDEO_ENCODE_CONTENT_RENDERED_BIT_KHR = 0x00000004, VK_VIDEO_ENCODE_CONTENT_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkVideoEncodeContentFlagBitsKHR;
...
/* #define VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME "VK_KHR_synchronization2" ### string, not number "\"VK_KHR_synchronization2\"" */
...
enum { VK_KHR_fragment_shader_barycentric = 1 };
enum { VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_SPEC_VERSION = 1 };
/* #define VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME "VK_KHR_fragment_shader_barycentric" ### string, not number "\"VK_KHR_fragment_shader_barycentric\"" */
...
/* #define VK_KHR_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_EXTENSION_NAME "VK_KHR_shader_subgroup_uniform_control_flow" ### string, not number "\"VK_KHR_shader_subgroup_uniform_control_flow\"" */
...
/* #define VK_KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_EXTENSION_NAME "VK_KHR_zero_initialize_workgroup_memory" ### string, not number "\"VK_KHR_zero_initialize_workgroup_memory\"" */
...
/* #define VK_KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_EXTENSION_NAME "VK_KHR_workgroup_memory_explicit_layout" ### string, not number "\"VK_KHR_workgroup_memory_explicit_layout\"" */
...
/* #define VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME "VK_KHR_copy_commands2" ### string, not number "\"VK_KHR_copy_commands2\"" */
...
/* #define VK_KHR_FORMAT_FEATURE_FLAGS_2_EXTENSION_NAME "VK_KHR_format_feature_flags2" ### string, not number "\"VK_KHR_format_feature_flags2\"" */
typedef VkFormatFeatureFlags2 VkFormatFeatureFlags2KHR;
typedef VkFormatFeatureFlagBits2 VkFormatFeatureFlagBits2KHR;
typedef VkFormatProperties3 VkFormatProperties3KHR;
enum { VK_KHR_ray_tracing_maintenance1 = 1 };
enum { VK_KHR_RAY_TRACING_MAINTENANCE_1_SPEC_VERSION = 1 };
/* #define VK_KHR_RAY_TRACING_MAINTENANCE_1_EXTENSION_NAME "VK_KHR_ray_tracing_maintenance1" ### string, not number "\"VK_KHR_ray_tracing_maintenance1\"" */
...
/* #define VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME "VK_KHR_portability_enumeration" ### string, not number "\"VK_KHR_portability_enumeration\"" */
enum { VK_KHR_maintenance4 = 1 };
enum { VK_KHR_MAINTENANCE_4_SPEC_VERSION = 2 };
/* #define VK_KHR_MAINTENANCE_4_EXTENSION_NAME "VK_KHR_maintenance4" ### string, not number "\"VK_KHR_maintenance4\"" */
...
enum { VK_KHR_maintenance5 = 1 };
enum { VK_KHR_MAINTENANCE_5_SPEC_VERSION = 1 };
/* #define VK_KHR_MAINTENANCE_5_EXTENSION_NAME "VK_KHR_maintenance5" ### string, not number "\"VK_KHR_maintenance5\"" */
...
enum { VK_KHR_video_maintenance1 = 1 };
enum { VK_KHR_VIDEO_MAINTENANCE_1_SPEC_VERSION = 1 };
/* #define VK_KHR_VIDEO_MAINTENANCE_1_EXTENSION_NAME "VK_KHR_video_maintenance1" ### string, not number "\"VK_KHR_video_maintenance1\"" */
...
enum { VK_KHR_vertex_attribute_divisor = 1 };
enum { VK_KHR_VERTEX_ATTRIBUTE_DIVISOR_SPEC_VERSION = 1 };
/* #define VK_KHR_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME "VK_KHR_vertex_attribute_divisor" ### string, not number "\"VK_KHR_vertex_attribute_divisor\"" */
...
enum { VK_KHR_calibrated_timestamps = 1 };
enum { VK_KHR_CALIBRATED_TIMESTAMPS_SPEC_VERSION = 1 };
/* #define VK_KHR_CALIBRATED_TIMESTAMPS_EXTENSION_NAME "VK_KHR_calibrated_timestamps" ### string, not number "\"VK_KHR_calibrated_timestamps\"" */
typedef enum VkTimeDomainKHR { VK_TIME_DOMAIN_DEVICE_KHR = 0, VK_TIME_DOMAIN_CLOCK_MONOTONIC_KHR = 1, VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_KHR = 2, VK_TIME_DOMAIN_QUERY_PERFORMANCE_COUNTER_KHR = 3, VK_TIME_DOMAIN_DEVICE_EXT = VK_TIME_DOMAIN_DEVICE_KHR, VK_TIME_DOMAIN_CLOCK_MONOTONIC_EXT = VK_TIME_DOMAIN_CLOCK_MONOTONIC_KHR, VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_EXT = VK_TIME_DOMAIN_CLOCK_MONOTONIC_RAW_KHR, VK_TIME_DOMAIN_QUERY_PERFORMANCE_COUNTER_EXT = VK_TIME_DOMAIN_QUERY_PERFORMANCE_COUNTER_KHR, VK_TIME_DOMAIN_MAX_ENUM_KHR = 0x7FFFFFFF } VkTimeDomainKHR;
...
enum { VK_KHR_maintenance6 = 1 };
enum { VK_KHR_MAINTENANCE_6_SPEC_VERSION = 1 };
/* #define VK_KHR_MAINTENANCE_6_EXTENSION_NAME "VK_KHR_maintenance6" ### string, not number "\"VK_KHR_maintenance6\"" */
...
/* #define VK_NV_GLSL_SHADER_EXTENSION_NAME  "VK_NV_glsl_shader" ### string, not number "\"VK_NV_glsl_shader\"" */
enum { VK_EXT_depth_range_unrestricted = 1 };
enum { VK_EXT_DEPTH_RANGE_UNRESTRICTED_SPEC_VERSION = 1 };
/* #define VK_EXT_DEPTH_RANGE_UNRESTRICTED_EXTENSION_NAME "VK_EXT_depth_range_unrestricted" ### string, not number "\"VK_EXT_depth_range_unrestricted\"" */
enum { VK_IMG_filter_cubic = 1 };
enum { VK_IMG_FILTER_CUBIC_SPEC_VERSION = 1 };
/* #define VK_IMG_FILTER_CUBIC_EXTENSION_NAME "VK_IMG_filter_cubic" ### string, not number "\"VK_IMG_filter_cubic\"" */
enum { VK_AMD_rasterization_order = 1 };
enum { VK_AMD_RASTERIZATION_ORDER_SPEC_VERSION = 1 };
/* #define VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME "VK_AMD_rasterization_order" ### string, not number "\"VK_AMD_rasterization_order\"" */
typedef enum VkRasterizationOrderAMD { VK_RASTERIZATION_ORDER_STRICT_AMD = 0, VK_RASTERIZATION_ORDER_RELAXED_AMD = 1, VK_RASTERIZATION_ORDER_MAX_ENUM_AMD = 0x7FFFFFFF } VkRasterizationOrderAMD;
...
/* #define VK_AMD_SHADER_TRINARY_MINMAX_EXTENSION_NAME "VK_AMD_shader_trinary_minmax" ### string, not number "\"VK_AMD_shader_trinary_minmax\"" */
enum { VK_AMD_shader_explicit_vertex_parameter = 1 };
enum { VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_SPEC_VERSION = 1 };
/* #define VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_EXTENSION_NAME "VK_AMD_shader_explicit_vertex_parameter" ### string, not number "\"VK_AMD_shader_explicit_vertex_parameter\"" */
enum { VK_EXT_debug_marker = 1 };
enum { VK_EXT_DEBUG_MARKER_SPEC_VERSION = 4 };
/* #define VK_EXT_DEBUG_MARKER_EXTENSION_NAME "VK_EXT_debug_marker" ### string, not number "\"VK_EXT_debug_marker\"" */
...
/* #define VK_AMD_GCN_SHADER_EXTENSION_NAME  "VK_AMD_gcn_shader" ### string, not number "\"VK_AMD_gcn_shader\"" */
enum { VK_NV_dedicated_allocation = 1 };
enum { VK_NV_DEDICATED_ALLOCATION_SPEC_VERSION = 1 };
/* #define VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME "VK_NV_dedicated_allocation" ### string, not number "\"VK_NV_dedicated_allocation\"" */
...
/* #define VK_EXT_TRANSFORM_FEEDBACK_EXTENSION_NAME "VK_EXT_transform_feedback" ### string, not number "\"VK_EXT_transform_feedback\"" */
...
/* #define VK_NVX_BINARY_IMPORT_EXTENSION_NAME "VK_NVX_binary_import" ### string, not number "\"VK_NVX_binary_import\"" */
...
/* #define VK_NVX_IMAGE_VIEW_HANDLE_EXTENSION_NAME "VK_NVX_image_view_handle" ### string, not number "\"VK_NVX_image_view_handle\"" */
...
/* #define VK_AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME "VK_AMD_draw_indirect_count" ### string, not number "\"VK_AMD_draw_indirect_count\"" */
...
/* #define VK_AMD_NEGATIVE_VIEWPORT_HEIGHT_EXTENSION_NAME "VK_AMD_negative_viewport_height" ### string, not number "\"VK_AMD_negative_viewport_height\"" */
enum { VK_AMD_gpu_shader_half_float = 1 };
enum { VK_AMD_GPU_SHADER_HALF_FLOAT_SPEC_VERSION = 2 };
/* #define VK_AMD_GPU_SHADER_HALF_FLOAT_EXTENSION_NAME "VK_AMD_gpu_shader_half_float" ### string, not number "\"VK_AMD_gpu_shader_half_float\"" */
enum { VK_AMD_shader_ballot = 1 };
enum { VK_AMD_SHADER_BALLOT_SPEC_VERSION = 1 };
/* #define VK_AMD_SHADER_BALLOT_EXTENSION_NAME "VK_AMD_shader_ballot" ### string, not number "\"VK_AMD_shader_ballot\"" */
enum { VK_AMD_texture_gather_bias_lod = 1 };
enum { VK_AMD_TEXTURE_GATHER_BIAS_LOD_SPEC_VERSION = 1 };
/* #define VK_AMD_TEXTURE_GATHER_BIAS_LOD_EXTENSION_NAME "VK_AMD_texture_gather_bias_lod" ### string, not number "\"VK_AMD_texture_gather_bias_lod\"" */
...
/* #define VK_AMD_SHADER_INFO_EXTENSION_NAME "VK_AMD_shader_info" ### string, not number "\"VK_AMD_shader_info\"" */
typedef enum VkShaderInfoTypeAMD { VK_SHADER_INFO_TYPE_STATISTICS_AMD = 0, VK_SHADER_INFO_TYPE_BINARY_AMD = 1, VK_SHADER_INFO_TYPE_DISASSEMBLY_AMD = 2, VK_SHADER_INFO_TYPE_MAX_ENUM_AMD = 0x7FFFFFFF } VkShaderInfoTypeAMD;
...
/* #define VK_AMD_SHADER_IMAGE_LOAD_STORE_LOD_EXTENSION_NAME "VK_AMD_shader_image_load_store_lod" ### string, not number "\"VK_AMD_shader_image_load_store_lod\"" */
enum { VK_NV_corner_sampled_image = 1 };
enum { VK_NV_CORNER_SAMPLED_IMAGE_SPEC_VERSION = 2 };
/* #define VK_NV_CORNER_SAMPLED_IMAGE_EXTENSION_NAME "VK_NV_corner_sampled_image" ### string, not number "\"VK_NV_corner_sampled_image\"" */
...
/* #define VK_NV_EXTERNAL_MEMORY_EXTENSION_NAME "VK_NV_external_memory" ### string, not number "\"VK_NV_external_memory\"" */
...
/* #define VK_EXT_VALIDATION_FLAGS_EXTENSION_NAME "VK_EXT_validation_flags" ### string, not number "\"VK_EXT_validation_flags\"" */
typedef enum VkValidationCheckEXT { VK_VALIDATION_CHECK_ALL_EXT = 0, VK_VALIDATION_CHECK_SHADERS_EXT = 1, VK_VALIDATION_CHECK_MAX_ENUM_EXT = 0x7FFFFFFF } VkValidationCheckEXT;
...
/* #define VK_EXT_SHADER_SUBGROUP_BALLOT_EXTENSION_NAME "VK_EXT_shader_subgroup_ballot" ### string, not number "\"VK_EXT_shader_subgroup_ballot\"" */
enum { VK_EXT_shader_subgroup_vote = 1 };
enum { VK_EXT_SHADER_SUBGROUP_VOTE_SPEC_VERSION = 1 };
/* #define VK_EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME "VK_EXT_shader_subgroup_vote" ### string, not number "\"VK_EXT_shader_subgroup_vote\"" */
enum { VK_EXT_texture_compression_astc_hdr = 1 };
enum { VK_EXT_TEXTURE_COMPRESSION_ASTC_HDR_SPEC_VERSION = 1 };
/* #define VK_EXT_TEXTURE_COMPRESSION_ASTC_HDR_EXTENSION_NAME "VK_EXT_texture_compression_astc_hdr" ### string, not number "\"VK_EXT_texture_compression_astc_hdr\"" */
typedef VkPhysicalDeviceTextureCompressionASTCHDRFeatures VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT;
enum { VK_EXT_astc_decode_mode = 1 };
enum { VK_EXT_ASTC_DECODE_MODE_SPEC_VERSION = 1 };
/* #define VK_EXT_ASTC_DECODE_MODE_EXTENSION_NAME "VK_EXT_astc_decode_mode" ### string, not number "\"VK_EXT_astc_decode_mode\"" */
...
/* #define VK_EXT_CONDITIONAL_RENDERING_EXTENSION_NAME "VK_EXT_conditional_rendering" ### string, not number "\"VK_EXT_conditional_rendering\"" */
typedef enum VkConditionalRenderingFlagBitsEXT { VK_CONDITIONAL_RENDERING_INVERTED_BIT_EXT = 0x00000001, VK_CONDITIONAL_RENDERING_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkConditionalRenderingFlagBitsEXT;
...
/* #define VK_NV_CLIP_SPACE_W_SCALING_EXTENSION_NAME "VK_NV_clip_space_w_scaling" ### string, not number "\"VK_NV_clip_space_w_scaling\"" */
...
/* #define VK_EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME "VK_EXT_direct_mode_display" ### string, not number "\"VK_EXT_direct_mode_display\"" */
...
/* #define VK_EXT_DISPLAY_SURFACE_COUNTER_EXTENSION_NAME "VK_EXT_display_surface_counter" ### string, not number "\"VK_EXT_display_surface_counter\"" */
typedef enum VkSurfaceCounterFlagBitsEXT { VK_SURFACE_COUNTER_VBLANK_BIT_EXT = 0x00000001, VK_SURFACE_COUNTER_VBLANK_EXT = VK_SURFACE_COUNTER_VBLANK_BIT_EXT, VK_SURFACE_COUNTER_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkSurfaceCounterFlagBitsEXT;
...
/* #define VK_EXT_DISPLAY_CONTROL_EXTENSION_NAME "VK_EXT_display_control" ### string, not number "\"VK_EXT_display_control\"" */
typedef enum VkDisplayPowerStateEXT { VK_DISPLAY_POWER_STATE_OFF_EXT = 0, VK_DISPLAY_POWER_STATE_SUSPEND_EXT = 1, VK_DISPLAY_POWER_STATE_ON_EXT = 2, VK_DISPLAY_POWER_STATE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDisplayPowerStateEXT;
typedef enum VkDeviceEventTypeEXT { VK_DEVICE_EVENT_TYPE_DISPLAY_HOTPLUG_EXT = 0, VK_DEVICE_EVENT_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDeviceEventTypeEXT;
typedef enum VkDisplayEventTypeEXT { VK_DISPLAY_EVENT_TYPE_FIRST_PIXEL_OUT_EXT = 0, VK_DISPLAY_EVENT_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDisplayEventTypeEXT;
...
/* #define VK_GOOGLE_DISPLAY_TIMING_EXTENSION_NAME "VK_GOOGLE_display_timing" ### string, not number "\"VK_GOOGLE_display_timing\"" */
...
/* #define VK_NV_SAMPLE_MASK_OVERRIDE_COVERAGE_EXTENSION_NAME "VK_NV_sample_mask_override_coverage" ### string, not number "\"VK_NV_sample_mask_override_coverage\"" */
enum { VK_NV_geometry_shader_passthrough = 1 };
enum { VK_NV_GEOMETRY_SHADER_PASSTHROUGH_SPEC_VERSION = 1 };
/* #define VK_NV_GEOMETRY_SHADER_PASSTHROUGH_EXTENSION_NAME "VK_NV_geometry_shader_passthrough" ### string, not number "\"VK_NV_geometry_shader_passthrough\"" */
enum { VK_NV_viewport_array2 = 1 };
enum { VK_NV_VIEWPORT_ARRAY_2_SPEC_VERSION = 1 };
/* #define VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME "VK_NV_viewport_array2" ### string, not number "\"VK_NV_viewport_array2\"" */
enum { VK_NV_VIEWPORT_ARRAY2_SPEC_VERSION = 1 };
/* #define VK_NV_VIEWPORT_ARRAY2_EXTENSION_NAME VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME ### string, not number "VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME" */
enum { VK_NVX_multiview_per_view_attributes = 1 };
enum { VK_NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_SPEC_VERSION = 1 };
/* #define VK_NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_EXTENSION_NAME "VK_NVX_multiview_per_view_attributes" ### string, not number "\"VK_NVX_multiview_per_view_attributes\"" */
...
/* #define VK_NV_VIEWPORT_SWIZZLE_EXTENSION_NAME "VK_NV_viewport_swizzle" ### string, not number "\"VK_NV_viewport_swizzle\"" */
...
/* #define VK_EXT_DISCARD_RECTANGLES_EXTENSION_NAME "VK_EXT_discard_rectangles" ### string, not number "\"VK_EXT_discard_rectangles\"" */
typedef enum VkDiscardRectangleModeEXT { VK_DISCARD_RECTANGLE_MODE_INCLUSIVE_EXT = 0, VK_DISCARD_RECTANGLE_MODE_EXCLUSIVE_EXT = 1, VK_DISCARD_RECTANGLE_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDiscardRectangleModeEXT;
...
/* #define VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME "VK_EXT_conservative_rasterization" ### string, not number "\"VK_EXT_conservative_rasterization\"" */
typedef enum VkConservativeRasterizationModeEXT { VK_CONSERVATIVE_RASTERIZATION_MODE_DISABLED_EXT = 0, VK_CONSERVATIVE_RASTERIZATION_MODE_OVERESTIMATE_EXT = 1, VK_CONSERVATIVE_RASTERIZATION_MODE_UNDERESTIMATE_EXT = 2, VK_CONSERVATIVE_RASTERIZATION_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkConservativeRasterizationModeEXT;
...
/* #define VK_EXT_DEPTH_CLIP_ENABLE_EXTENSION_NAME "VK_EXT_depth_clip_enable" ### string, not number "\"VK_EXT_depth_clip_enable\"" */
...
/* #define VK_EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME "VK_EXT_swapchain_colorspace" ### string, not number "\"VK_EXT_swapchain_colorspace\"" */
enum { VK_EXT_hdr_metadata = 1 };
enum { VK_EXT_HDR_METADATA_SPEC_VERSION = 2 };
/* #define VK_EXT_HDR_METADATA_EXTENSION_NAME "VK_EXT_hdr_metadata" ### string, not number "\"VK_EXT_hdr_metadata\"" */
...
enum { VK_IMG_relaxed_line_rasterization = 1 };
enum { VK_IMG_RELAXED_LINE_RASTERIZATION_SPEC_VERSION = 1 };
/* #define VK_IMG_RELAXED_LINE_RASTERIZATION_EXTENSION_NAME "VK_IMG_relaxed_line_rasterization" ### string, not number "\"VK_IMG_relaxed_line_rasterization\"" */
...
/* #define VK_EXT_EXTERNAL_MEMORY_DMA_BUF_EXTENSION_NAME "VK_EXT_external_memory_dma_buf" ### string, not number "\"VK_EXT_external_memory_dma_buf\"" */
enum { VK_EXT_queue_family_foreign = 1 };
enum { VK_EXT_QUEUE_FAMILY_FOREIGN_SPEC_VERSION = 1 };
/* #define VK_EXT_QUEUE_FAMILY_FOREIGN_EXTENSION_NAME "VK_EXT_queue_family_foreign" ### string, not number "\"VK_EXT_queue_family_foreign\"" */
enum { VK_QUEUE_FAMILY_FOREIGN_EXT = -3 };
enum { VK_EXT_debug_utils = 1 };
typedef struct VkDebugUtilsMessengerEXT_T *VkDebugUtilsMessengerEXT;
enum { VK_EXT_DEBUG_UTILS_SPEC_VERSION = 2 };
/* #define VK_EXT_DEBUG_UTILS_EXTENSION_NAME "VK_EXT_debug_utils" ### string, not number "\"VK_EXT_debug_utils\"" */
typedef VkFlags VkDebugUtilsMessengerCallbackDataFlagsEXT;
typedef enum VkDebugUtilsMessageSeverityFlagBitsEXT { VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT = 0x00000001, VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT = 0x00000010, VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT = 0x00000100, VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT = 0x00001000, VK_DEBUG_UTILS_MESSAGE_SEVERITY_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkDebugUtilsMessageSeverityFlagBitsEXT;
typedef enum VkDebugUtilsMessageTypeFlagBitsEXT { VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT = 0x00000001, VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT = 0x00000002, VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT = 0x00000004, VK_DEBUG_UTILS_MESSAGE_TYPE_DEVICE_ADDRESS_BINDING_BIT_EXT = 0x00000008, VK_DEBUG_UTILS_MESSAGE_TYPE_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkDebugUtilsMessageTypeFlagBitsEXT;
...
/* #define VK_EXT_SAMPLER_FILTER_MINMAX_EXTENSION_NAME "VK_EXT_sampler_filter_minmax" ### string, not number "\"VK_EXT_sampler_filter_minmax\"" */
typedef VkSamplerReductionMode VkSamplerReductionModeEXT;
typedef VkSamplerReductionModeCreateInfo VkSamplerReductionModeCreateInfoEXT;
typedef VkPhysicalDeviceSamplerFilterMinmaxProperties VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT;
enum { VK_AMD_gpu_shader_int16 = 1 };
enum { VK_AMD_GPU_SHADER_INT16_SPEC_VERSION = 2 };
/* #define VK_AMD_GPU_SHADER_INT16_EXTENSION_NAME "VK_AMD_gpu_shader_int16" ### string, not number "\"VK_AMD_gpu_shader_int16\"" */
enum { VK_AMD_mixed_attachment_samples = 1 };
enum { VK_AMD_MIXED_ATTACHMENT_SAMPLES_SPEC_VERSION = 1 };
/* #define VK_AMD_MIXED_ATTACHMENT_SAMPLES_EXTENSION_NAME "VK_AMD_mixed_attachment_samples" ### string, not number "\"VK_AMD_mixed_attachment_samples\"" */
enum { VK_AMD_shader_fragment_mask = 1 };
enum { VK_AMD_SHADER_FRAGMENT_MASK_SPEC_VERSION = 1 };
/* #define VK_AMD_SHADER_FRAGMENT_MASK_EXTENSION_NAME "VK_AMD_shader_fragment_mask" ### string, not number "\"VK_AMD_shader_fragment_mask\"" */
enum { VK_EXT_inline_uniform_block = 1 };
enum { VK_EXT_INLINE_UNIFORM_BLOCK_SPEC_VERSION = 1 };
/* #define VK_EXT_INLINE_UNIFORM_BLOCK_EXTENSION_NAME "VK_EXT_inline_uniform_block" ### string, not number "\"VK_EXT_inline_uniform_block\"" */
...
/* #define VK_EXT_SHADER_STENCIL_EXPORT_EXTENSION_NAME "VK_EXT_shader_stencil_export" ### string, not number "\"VK_EXT_shader_stencil_export\"" */
enum { VK_EXT_sample_locations = 1 };
enum { VK_EXT_SAMPLE_LOCATIONS_SPEC_VERSION = 1 };
/* #define VK_EXT_SAMPLE_LOCATIONS_EXTENSION_NAME "VK_EXT_sample_locations" ### string, not number "\"VK_EXT_sample_locations\"" */
...
/* #define VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME "VK_EXT_blend_operation_advanced" ### string, not number "\"VK_EXT_blend_operation_advanced\"" */
typedef enum VkBlendOverlapEXT { VK_BLEND_OVERLAP_UNCORRELATED_EXT = 0, VK_BLEND_OVERLAP_DISJOINT_EXT = 1, VK_BLEND_OVERLAP_CONJOINT_EXT = 2, VK_BLEND_OVERLAP_MAX_ENUM_EXT = 0x7FFFFFFF } VkBlendOverlapEXT;
...
/* #define VK_NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME "VK_NV_fragment_coverage_to_color" ### string, not number "\"VK_NV_fragment_coverage_to_color\"" */
...
/* #define VK_NV_FRAMEBUFFER_MIXED_SAMPLES_EXTENSION_NAME "VK_NV_framebuffer_mixed_samples" ### string, not number "\"VK_NV_framebuffer_mixed_samples\"" */
typedef enum VkCoverageModulationModeNV { VK_COVERAGE_MODULATION_MODE_NONE_NV = 0, VK_COVERAGE_MODULATION_MODE_RGB_NV = 1, VK_COVERAGE_MODULATION_MODE_ALPHA_NV = 2, VK_COVERAGE_MODULATION_MODE_RGBA_NV = 3, VK_COVERAGE_MODULATION_MODE_MAX_ENUM_NV = 0x7FFFFFFF } VkCoverageModulationModeNV;
...
/* #define VK_NV_FILL_RECTANGLE_EXTENSION_NAME "VK_NV_fill_rectangle" ### string, not number "\"VK_NV_fill_rectangle\"" */
enum { VK_NV_shader_sm_builtins = 1 };
enum { VK_NV_SHADER_SM_BUILTINS_SPEC_VERSION = 1 };
/* #define VK_NV_SHADER_SM_BUILTINS_EXTENSION_NAME "VK_NV_shader_sm_builtins" ### string, not number "\"VK_NV_shader_sm_builtins\"" */
...
/* #define VK_EXT_POST_DEPTH_COVERAGE_EXTENSION_NAME "VK_EXT_post_depth_coverage" ### string, not number "\"VK_EXT_post_depth_coverage\"" */
enum { VK_EXT_image_drm_format_modifier = 1 };
enum { VK_EXT_IMAGE_DRM_FORMAT_MODIFIER_SPEC_VERSION = 2 };
/* #define VK_EXT_IMAGE_DRM_FORMAT_MODIFIER_EXTENSION_NAME "VK_EXT_image_drm_format_modifier" ### string, not number "\"VK_EXT_image_drm_format_modifier\"" */
...
/* #define VK_EXT_VALIDATION_CACHE_EXTENSION_NAME "VK_EXT_validation_cache" ### string, not number "\"VK_EXT_validation_cache\"" */
typedef enum VkValidationCacheHeaderVersionEXT { VK_VALIDATION_CACHE_HEADER_VERSION_ONE_EXT = 1, VK_VALIDATION_CACHE_HEADER_VERSION_MAX_ENUM_EXT = 0x7FFFFFFF } VkValidationCacheHeaderVersionEXT;
...
/* #define VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME "VK_EXT_descriptor_indexing" ### string, not number "\"VK_EXT_descriptor_indexing\"" */
...
/* #define VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME "VK_EXT_shader_viewport_index_layer" ### string, not number "\"VK_EXT_shader_viewport_index_layer\"" */
enum { VK_NV_shading_rate_image = 1 };
enum { VK_NV_SHADING_RATE_IMAGE_SPEC_VERSION = 3 };
/* #define VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME "VK_NV_shading_rate_image" ### string, not number "\"VK_NV_shading_rate_image\"" */
typedef enum VkShadingRatePaletteEntryNV { VK_SHADING_RATE_PALETTE_ENTRY_NO_INVOCATIONS_NV = 0, VK_SHADING_RATE_PALETTE_ENTRY_16_INVOCATIONS_PER_PIXEL_NV = 1, VK_SHADING_RATE_PALETTE_ENTRY_8_INVOCATIONS_PER_PIXEL_NV = 2, VK_SHADING_RATE_PALETTE_ENTRY_4_INVOCATIONS_PER_PIXEL_NV = 3, VK_SHADING_RATE_PALETTE_ENTRY_2_INVOCATIONS_PER_PIXEL_NV = 4, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_PIXEL_NV = 5, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_2X1_PIXELS_NV = 6, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_1X2_PIXELS_NV = 7, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_2X2_PIXELS_NV = 8, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_4X2_PIXELS_NV = 9, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_2X4_PIXELS_NV = 10, VK_SHADING_RATE_PALETTE_ENTRY_1_INVOCATION_PER_4X4_PIXELS_NV = 11, VK_SHADING_RATE_PALETTE_ENTRY_MAX_ENUM_NV = 0x7FFFFFFF } VkShadingRatePaletteEntryNV;
typedef enum VkCoarseSampleOrderTypeNV { VK_COARSE_SAMPLE_ORDER_TYPE_DEFAULT_NV = 0, VK_COARSE_SAMPLE_ORDER_TYPE_CUSTOM_NV = 1, VK_COARSE_SAMPLE_ORDER_TYPE_PIXEL_MAJOR_NV = 2, VK_COARSE_SAMPLE_ORDER_TYPE_SAMPLE_MAJOR_NV = 3, VK_COARSE_SAMPLE_ORDER_TYPE_MAX_ENUM_NV = 0x7FFFFFFF } VkCoarseSampleOrderTypeNV;
...
/* #define VK_NV_RAY_TRACING_EXTENSION_NAME  "VK_NV_ray_tracing" ### string, not number "\"VK_NV_ray_tracing\"" */
enum { VK_SHADER_UNUSED_KHR = -1 };
enum { VK_SHADER_UNUSED_NV = -1 };
typedef enum VkRayTracingShaderGroupTypeKHR { VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR = 0, VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR = 1, VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR = 2, VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV = VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR, VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV = VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR, VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV = VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR, VK_RAY_TRACING_SHADER_GROUP_TYPE_MAX_ENUM_KHR = 0x7FFFFFFF } VkRayTracingShaderGroupTypeKHR;
typedef VkRayTracingShaderGroupTypeKHR VkRayTracingShaderGroupTypeNV;
typedef enum VkGeometryTypeKHR { VK_GEOMETRY_TYPE_TRIANGLES_KHR = 0, VK_GEOMETRY_TYPE_AABBS_KHR = 1, VK_GEOMETRY_TYPE_INSTANCES_KHR = 2, VK_GEOMETRY_TYPE_TRIANGLES_NV = VK_GEOMETRY_TYPE_TRIANGLES_KHR, VK_GEOMETRY_TYPE_AABBS_NV = VK_GEOMETRY_TYPE_AABBS_KHR, VK_GEOMETRY_TYPE_MAX_ENUM_KHR = 0x7FFFFFFF } VkGeometryTypeKHR;
typedef VkGeometryTypeKHR VkGeometryTypeNV;
typedef enum VkAccelerationStructureTypeKHR { VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR = 0, VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR = 1, VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR = 2, VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV = VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR, VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV = VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR, VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_KHR = 0x7FFFFFFF } VkAccelerationStructureTypeKHR;
...
/* #define VK_NV_REPRESENTATIVE_FRAGMENT_TEST_EXTENSION_NAME "VK_NV_representative_fragment_test" ### string, not number "\"VK_NV_representative_fragment_test\"" */
...
/* #define VK_EXT_FILTER_CUBIC_EXTENSION_NAME "VK_EXT_filter_cubic" ### string, not number "\"VK_EXT_filter_cubic\"" */
...
/* #define VK_QCOM_RENDER_PASS_SHADER_RESOLVE_EXTENSION_NAME "VK_QCOM_render_pass_shader_resolve" ### string, not number "\"VK_QCOM_render_pass_shader_resolve\"" */
enum { VK_EXT_global_priority = 1 };
enum { VK_EXT_GLOBAL_PRIORITY_SPEC_VERSION = 2 };
/* #define VK_EXT_GLOBAL_PRIORITY_EXTENSION_NAME "VK_EXT_global_priority" ### string, not number "\"VK_EXT_global_priority\"" */
...
/* #define VK_EXT_EXTERNAL_MEMORY_HOST_EXTENSION_NAME "VK_EXT_external_memory_host" ### string, not number "\"VK_EXT_external_memory_host\"" */
...
/* #define VK_AMD_BUFFER_MARKER_EXTENSION_NAME "VK_AMD_buffer_marker" ### string, not number "\"VK_AMD_buffer_marker\"" */
...
/* #define VK_AMD_PIPELINE_COMPILER_CONTROL_EXTENSION_NAME "VK_AMD_pipeline_compiler_control" ### string, not number "\"VK_AMD_pipeline_compiler_control\"" */
typedef enum VkPipelineCompilerControlFlagBitsAMD { VK_PIPELINE_COMPILER_CONTROL_FLAG_BITS_MAX_ENUM_AMD = 0x7FFFFFFF } VkPipelineCompilerControlFlagBitsAMD;
...
/* #define VK_EXT_CALIBRATED_TIMESTAMPS_EXTENSION_NAME "VK_EXT_calibrated_timestamps" ### string, not number "\"VK_EXT_calibrated_timestamps\"" */
...
/* #define VK_AMD_SHADER_CORE_PROPERTIES_EXTENSION_NAME "VK_AMD_shader_core_properties" ### string, not number "\"VK_AMD_shader_core_properties\"" */
...
/* #define VK_AMD_MEMORY_OVERALLOCATION_BEHAVIOR_EXTENSION_NAME "VK_AMD_memory_overallocation_behavior" ### string, not number "\"VK_AMD_memory_overallocation_behavior\"" */
typedef enum VkMemoryOverallocationBehaviorAMD { VK_MEMORY_OVERALLOCATION_BEHAVIOR_DEFAULT_AMD = 0, VK_MEMORY_OVERALLOCATION_BEHAVIOR_ALLOWED_AMD = 1, VK_MEMORY_OVERALLOCATION_BEHAVIOR_DISALLOWED_AMD = 2, VK_MEMORY_OVERALLOCATION_BEHAVIOR_MAX_ENUM_AMD = 0x7FFFFFFF } VkMemoryOverallocationBehaviorAMD;
...
/* #define VK_EXT_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME "VK_EXT_vertex_attribute_divisor" ### string, not number "\"VK_EXT_vertex_attribute_divisor\"" */
...
/* #define VK_EXT_PIPELINE_CREATION_FEEDBACK_EXTENSION_NAME "VK_EXT_pipeline_creation_feedback" ### string, not number "\"VK_EXT_pipeline_creation_feedback\"" */
...
/* #define VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME "VK_NV_shader_subgroup_partitioned" ### string, not number "\"VK_NV_shader_subgroup_partitioned\"" */
enum { VK_NV_compute_shader_derivatives = 1 };
enum { VK_NV_COMPUTE_SHADER_DERIVATIVES_SPEC_VERSION = 1 };
/* #define VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME "VK_NV_compute_shader_derivatives" ### string, not number "\"VK_NV_compute_shader_derivatives\"" */
...
/* #define VK_NV_MESH_SHADER_EXTENSION_NAME  "VK_NV_mesh_shader" ### string, not number "\"VK_NV_mesh_shader\"" */
...
/* #define VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME "VK_NV_fragment_shader_barycentric" ### string, not number "\"VK_NV_fragment_shader_barycentric\"" */
typedef VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV;
enum { VK_NV_shader_image_footprint = 1 };
enum { VK_NV_SHADER_IMAGE_FOOTPRINT_SPEC_VERSION = 2 };
/* #define VK_NV_SHADER_IMAGE_FOOTPRINT_EXTENSION_NAME "VK_NV_shader_image_footprint" ### string, not number "\"VK_NV_shader_image_footprint\"" */
...
/* #define VK_NV_SCISSOR_EXCLUSIVE_EXTENSION_NAME "VK_NV_scissor_exclusive" ### string, not number "\"VK_NV_scissor_exclusive\"" */
...
/* #define VK_NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_EXTENSION_NAME "VK_NV_device_diagnostic_checkpoints" ### string, not number "\"VK_NV_device_diagnostic_checkpoints\"" */
...
/* #define VK_INTEL_SHADER_INTEGER_FUNCTIONS_2_EXTENSION_NAME "VK_INTEL_shader_integer_functions2" ### string, not number "\"VK_INTEL_shader_integer_functions2\"" */
...
/* #define VK_INTEL_PERFORMANCE_QUERY_EXTENSION_NAME "VK_INTEL_performance_query" ### string, not number "\"VK_INTEL_performance_query\"" */
typedef enum VkPerformanceConfigurationTypeINTEL { VK_PERFORMANCE_CONFIGURATION_TYPE_COMMAND_QUEUE_METRICS_DISCOVERY_ACTIVATED_INTEL = 0, VK_PERFORMANCE_CONFIGURATION_TYPE_MAX_ENUM_INTEL = 0x7FFFFFFF } VkPerformanceConfigurationTypeINTEL;
typedef enum VkQueryPoolSamplingModeINTEL { VK_QUERY_POOL_SAMPLING_MODE_MANUAL_INTEL = 0, VK_QUERY_POOL_SAMPLING_MODE_MAX_ENUM_INTEL = 0x7FFFFFFF } VkQueryPoolSamplingModeINTEL;
typedef enum VkPerformanceOverrideTypeINTEL { VK_PERFORMANCE_OVERRIDE_TYPE_NULL_HARDWARE_INTEL = 0, VK_PERFORMANCE_OVERRIDE_TYPE_FLUSH_GPU_CACHES_INTEL = 1, VK_PERFORMANCE_OVERRIDE_TYPE_MAX_ENUM_INTEL = 0x7FFFFFFF } VkPerformanceOverrideTypeINTEL;
typedef enum VkPerformanceParameterTypeINTEL { VK_PERFORMANCE_PARAMETER_TYPE_HW_COUNTERS_SUPPORTED_INTEL = 0, VK_PERFORMANCE_PARAMETER_TYPE_STREAM_MARKER_VALID_BITS_INTEL = 1, VK_PERFORMANCE_PARAMETER_TYPE_MAX_ENUM_INTEL = 0x7FFFFFFF } VkPerformanceParameterTypeINTEL;
typedef enum VkPerformanceValueTypeINTEL { VK_PERFORMANCE_VALUE_TYPE_UINT32_INTEL = 0, VK_PERFORMANCE_VALUE_TYPE_UINT64_INTEL = 1, VK_PERFORMANCE_VALUE_TYPE_FLOAT_INTEL = 2, VK_PERFORMANCE_VALUE_TYPE_BOOL_INTEL = 3, VK_PERFORMANCE_VALUE_TYPE_STRING_INTEL = 4, VK_PERFORMANCE_VALUE_TYPE_MAX_ENUM_INTEL = 0x7FFFFFFF } VkPerformanceValueTypeINTEL;
...
/* #define VK_EXT_PCI_BUS_INFO_EXTENSION_NAME "VK_EXT_pci_bus_info" ### string, not number "\"VK_EXT_pci_bus_info\"" */
...
/* #define VK_AMD_DISPLAY_NATIVE_HDR_EXTENSION_NAME "VK_AMD_display_native_hdr" ### string, not number "\"VK_AMD_display_native_hdr\"" */
...
/* #define VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME "VK_EXT_fragment_density_map" ### string, not number "\"VK_EXT_fragment_density_map\"" */
...
/* #define VK_EXT_SCALAR_BLOCK_LAYOUT_EXTENSION_NAME "VK_EXT_scalar_block_layout" ### string, not number "\"VK_EXT_scalar_block_layout\"" */
typedef VkPhysicalDeviceScalarBlockLayoutFeatures VkPhysicalDeviceScalarBlockLayoutFeaturesEXT;
enum { VK_GOOGLE_hlsl_functionality1 = 1 };
enum { VK_GOOGLE_HLSL_FUNCTIONALITY_1_SPEC_VERSION = 1 };
/* #define VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME "VK_GOOGLE_hlsl_functionality1" ### string, not number "\"VK_GOOGLE_hlsl_functionality1\"" */
enum { VK_GOOGLE_HLSL_FUNCTIONALITY1_SPEC_VERSION = 1 };
/* #define VK_GOOGLE_HLSL_FUNCTIONALITY1_EXTENSION_NAME VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME ### string, not number "VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME" */
enum { VK_GOOGLE_decorate_string = 1 };
enum { VK_GOOGLE_DECORATE_STRING_SPEC_VERSION = 1 };
/* #define VK_GOOGLE_DECORATE_STRING_EXTENSION_NAME "VK_GOOGLE_decorate_string" ### string, not number "\"VK_GOOGLE_decorate_string\"" */
enum { VK_EXT_subgroup_size_control = 1 };
enum { VK_EXT_SUBGROUP_SIZE_CONTROL_SPEC_VERSION = 2 };
/* #define VK_EXT_SUBGROUP_SIZE_CONTROL_EXTENSION_NAME "VK_EXT_subgroup_size_control" ### string, not number "\"VK_EXT_subgroup_size_control\"" */
...
/* #define VK_AMD_SHADER_CORE_PROPERTIES_2_EXTENSION_NAME "VK_AMD_shader_core_properties2" ### string, not number "\"VK_AMD_shader_core_properties2\"" */
typedef enum VkShaderCorePropertiesFlagBitsAMD { VK_SHADER_CORE_PROPERTIES_FLAG_BITS_MAX_ENUM_AMD = 0x7FFFFFFF } VkShaderCorePropertiesFlagBitsAMD;
...
/* #define VK_AMD_DEVICE_COHERENT_MEMORY_EXTENSION_NAME "VK_AMD_device_coherent_memory" ### string, not number "\"VK_AMD_device_coherent_memory\"" */
...
/* #define VK_EXT_SHADER_IMAGE_ATOMIC_INT64_EXTENSION_NAME "VK_EXT_shader_image_atomic_int64" ### string, not number "\"VK_EXT_shader_image_atomic_int64\"" */
...
/* #define VK_EXT_MEMORY_BUDGET_EXTENSION_NAME "VK_EXT_memory_budget" ### string, not number "\"VK_EXT_memory_budget\"" */
...
/* #define VK_EXT_MEMORY_PRIORITY_EXTENSION_NAME "VK_EXT_memory_priority" ### string, not number "\"VK_EXT_memory_priority\"" */
...
/* #define VK_NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_EXTENSION_NAME "VK_NV_dedicated_allocation_image_aliasing" ### string, not number "\"VK_NV_dedicated_allocation_image_aliasing\"" */
...
/* #define VK_EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME "VK_EXT_buffer_device_address" ### string, not number "\"VK_EXT_buffer_device_address\"" */
...
/* #define VK_EXT_TOOLING_INFO_EXTENSION_NAME "VK_EXT_tooling_info" ### string, not number "\"VK_EXT_tooling_info\"" */
...
/* #define VK_EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME "VK_EXT_separate_stencil_usage" ### string, not number "\"VK_EXT_separate_stencil_usage\"" */
typedef VkImageStencilUsageCreateInfo VkImageStencilUsageCreateInfoEXT;
enum { VK_EXT_validation_features = 1 };
enum { VK_EXT_VALIDATION_FEATURES_SPEC_VERSION = 6 };
/* #define VK_EXT_VALIDATION_FEATURES_EXTENSION_NAME "VK_EXT_validation_features" ### string, not number "\"VK_EXT_validation_features\"" */
typedef enum VkValidationFeatureEnableEXT { VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_EXT = 0, VK_VALIDATION_FEATURE_ENABLE_GPU_ASSISTED_RESERVE_BINDING_SLOT_EXT = 1, VK_VALIDATION_FEATURE_ENABLE_BEST_PRACTICES_EXT = 2, VK_VALIDATION_FEATURE_ENABLE_DEBUG_PRINTF_EXT = 3, VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT = 4, VK_VALIDATION_FEATURE_ENABLE_MAX_ENUM_EXT = 0x7FFFFFFF } VkValidationFeatureEnableEXT;
typedef enum VkValidationFeatureDisableEXT { VK_VALIDATION_FEATURE_DISABLE_ALL_EXT = 0, VK_VALIDATION_FEATURE_DISABLE_SHADERS_EXT = 1, VK_VALIDATION_FEATURE_DISABLE_THREAD_SAFETY_EXT = 2, VK_VALIDATION_FEATURE_DISABLE_API_PARAMETERS_EXT = 3, VK_VALIDATION_FEATURE_DISABLE_OBJECT_LIFETIMES_EXT = 4, VK_VALIDATION_FEATURE_DISABLE_CORE_CHECKS_EXT = 5, VK_VALIDATION_FEATURE_DISABLE_UNIQUE_HANDLES_EXT = 6, VK_VALIDATION_FEATURE_DISABLE_SHADER_VALIDATION_CACHE_EXT = 7, VK_VALIDATION_FEATURE_DISABLE_MAX_ENUM_EXT = 0x7FFFFFFF } VkValidationFeatureDisableEXT;
...
/* #define VK_NV_COOPERATIVE_MATRIX_EXTENSION_NAME "VK_NV_cooperative_matrix" ### string, not number "\"VK_NV_cooperative_matrix\"" */
...
/* #define VK_NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME "VK_NV_coverage_reduction_mode" ### string, not number "\"VK_NV_coverage_reduction_mode\"" */
typedef enum VkCoverageReductionModeNV { VK_COVERAGE_REDUCTION_MODE_MERGE_NV = 0, VK_COVERAGE_REDUCTION_MODE_TRUNCATE_NV = 1, VK_COVERAGE_REDUCTION_MODE_MAX_ENUM_NV = 0x7FFFFFFF } VkCoverageReductionModeNV;
...
/* #define VK_EXT_FRAGMENT_SHADER_INTERLOCK_EXTENSION_NAME "VK_EXT_fragment_shader_interlock" ### string, not number "\"VK_EXT_fragment_shader_interlock\"" */
...
/* #define VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME "VK_EXT_ycbcr_image_arrays" ### string, not number "\"VK_EXT_ycbcr_image_arrays\"" */
...
/* #define VK_EXT_PROVOKING_VERTEX_EXTENSION_NAME "VK_EXT_provoking_vertex" ### string, not number "\"VK_EXT_provoking_vertex\"" */
typedef enum VkProvokingVertexModeEXT { VK_PROVOKING_VERTEX_MODE_FIRST_VERTEX_EXT = 0, VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT = 1, VK_PROVOKING_VERTEX_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkProvokingVertexModeEXT;
...
/* #define VK_EXT_HEADLESS_SURFACE_EXTENSION_NAME "VK_EXT_headless_surface" ### string, not number "\"VK_EXT_headless_surface\"" */
...
/* #define VK_EXT_LINE_RASTERIZATION_EXTENSION_NAME "VK_EXT_line_rasterization" ### string, not number "\"VK_EXT_line_rasterization\"" */
typedef enum VkLineRasterizationModeEXT { VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT = 0, VK_LINE_RASTERIZATION_MODE_RECTANGULAR_EXT = 1, VK_LINE_RASTERIZATION_MODE_BRESENHAM_EXT = 2, VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH_EXT = 3, VK_LINE_RASTERIZATION_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkLineRasterizationModeEXT;
...
/* #define VK_EXT_SHADER_ATOMIC_FLOAT_EXTENSION_NAME "VK_EXT_shader_atomic_float" ### string, not number "\"VK_EXT_shader_atomic_float\"" */
...
/* #define VK_EXT_HOST_QUERY_RESET_EXTENSION_NAME "VK_EXT_host_query_reset" ### string, not number "\"VK_EXT_host_query_reset\"" */
...
/* #define VK_EXT_INDEX_TYPE_UINT8_EXTENSION_NAME "VK_EXT_index_type_uint8" ### string, not number "\"VK_EXT_index_type_uint8\"" */
...
/* #define VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME "VK_EXT_extended_dynamic_state" ### string, not number "\"VK_EXT_extended_dynamic_state\"" */
...
enum { VK_EXT_host_image_copy = 1 };
enum { VK_EXT_HOST_IMAGE_COPY_SPEC_VERSION = 1 };
/* #define VK_EXT_HOST_IMAGE_COPY_EXTENSION_NAME "VK_EXT_host_image_copy" ### string, not number "\"VK_EXT_host_image_copy\"" */
typedef enum VkHostImageCopyFlagBitsEXT { VK_HOST_IMAGE_COPY_MEMCPY_EXT = 0x00000001, VK_HOST_IMAGE_COPY_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkHostImageCopyFlagBitsEXT;
...
/* #define VK_EXT_SHADER_ATOMIC_FLOAT_2_EXTENSION_NAME "VK_EXT_shader_atomic_float2" ### string, not number "\"VK_EXT_shader_atomic_float2\"" */
...
/* #define VK_EXT_SURFACE_MAINTENANCE_1_EXTENSION_NAME "VK_EXT_surface_maintenance1" ### string, not number "\"VK_EXT_surface_maintenance1\"" */
typedef enum VkPresentScalingFlagBitsEXT { VK_PRESENT_SCALING_ONE_TO_ONE_BIT_EXT = 0x00000001, VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_EXT = 0x00000002, VK_PRESENT_SCALING_STRETCH_BIT_EXT = 0x00000004, VK_PRESENT_SCALING_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkPresentScalingFlagBitsEXT;
typedef VkFlags VkPresentScalingFlagsEXT;
typedef enum VkPresentGravityFlagBitsEXT { VK_PRESENT_GRAVITY_MIN_BIT_EXT = 0x00000001, VK_PRESENT_GRAVITY_MAX_BIT_EXT = 0x00000002, VK_PRESENT_GRAVITY_CENTERED_BIT_EXT = 0x00000004, VK_PRESENT_GRAVITY_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkPresentGravityFlagBitsEXT;
...
/* #define VK_EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME "VK_EXT_swapchain_maintenance1" ### string, not number "\"VK_EXT_swapchain_maintenance1\"" */
...
/* #define VK_EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_EXTENSION_NAME "VK_EXT_shader_demote_to_helper_invocation" ### string, not number "\"VK_EXT_shader_demote_to_helper_invocation\"" */
...
/* #define VK_NV_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME "VK_NV_device_generated_commands" ### string, not number "\"VK_NV_device_generated_commands\"" */
...
typedef enum VkIndirectStateFlagBitsNV { VK_INDIRECT_STATE_FLAG_FRONTFACE_BIT_NV = 0x00000001, VK_INDIRECT_STATE_FLAG_BITS_MAX_ENUM_NV = 0x7FFFFFFF } VkIndirectStateFlagBitsNV;
typedef VkFlags VkIndirectStateFlagsNV;
typedef enum VkIndirectCommandsLayoutUsageFlagBitsNV { VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_NV = 0x00000001, VK_INDIRECT_COMMANDS_LAYOUT_USAGE_INDEXED_SEQUENCES_BIT_NV = 0x00000002, VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_NV = 0x00000004, VK_INDIRECT_COMMANDS_LAYOUT_USAGE_FLAG_BITS_MAX_ENUM_NV = 0x7FFFFFFF } VkIndirectCommandsLayoutUsageFlagBitsNV;
...
/* #define VK_NV_INHERITED_VIEWPORT_SCISSOR_EXTENSION_NAME "VK_NV_inherited_viewport_scissor" ### string, not number "\"VK_NV_inherited_viewport_scissor\"" */
...
/* #define VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME "VK_EXT_texel_buffer_alignment" ### string, not number "\"VK_EXT_texel_buffer_alignment\"" */
...
enum { VK_QCOM_RENDER_PASS_TRANSFORM_SPEC_VERSION = 4 };
/* #define VK_QCOM_RENDER_PASS_TRANSFORM_EXTENSION_NAME "VK_QCOM_render_pass_transform" ### string, not number "\"VK_QCOM_render_pass_transform\"" */
...
enum { VK_EXT_depth_bias_control = 1 };
enum { VK_EXT_DEPTH_BIAS_CONTROL_SPEC_VERSION = 1 };
/* #define VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME "VK_EXT_depth_bias_control" ### string, not number "\"VK_EXT_depth_bias_control\"" */
...
/* #define VK_EXT_DEVICE_MEMORY_REPORT_EXTENSION_NAME "VK_EXT_device_memory_report" ### string, not number "\"VK_EXT_device_memory_report\"" */
typedef enum VkDeviceMemoryReportEventTypeEXT { VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT = 0, VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_FREE_EXT = 1, VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT = 2, VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_UNIMPORT_EXT = 3, VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATION_FAILED_EXT = 4, VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDeviceMemoryReportEventTypeEXT;
...
/* #define VK_EXT_ACQUIRE_DRM_DISPLAY_EXTENSION_NAME "VK_EXT_acquire_drm_display" ### string, not number "\"VK_EXT_acquire_drm_display\"" */
...
/* #define VK_EXT_ROBUSTNESS_2_EXTENSION_NAME "VK_EXT_robustness2" ### string, not number "\"VK_EXT_robustness2\"" */
...
/* #define VK_EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME "VK_EXT_custom_border_color" ### string, not number "\"VK_EXT_custom_border_color\"" */
...
/* #define VK_GOOGLE_USER_TYPE_EXTENSION_NAME "VK_GOOGLE_user_type" ### string, not number "\"VK_GOOGLE_user_type\"" */
enum { VK_NV_present_barrier = 1 };
enum { VK_NV_PRESENT_BARRIER_SPEC_VERSION = 1 };
/* #define VK_NV_PRESENT_BARRIER_EXTENSION_NAME "VK_NV_present_barrier" ### string, not number "\"VK_NV_present_barrier\"" */
...
/* #define VK_EXT_PRIVATE_DATA_EXTENSION_NAME "VK_EXT_private_data" ### string, not number "\"VK_EXT_private_data\"" */
...
/* #define VK_EXT_PIPELINE_CREATION_CACHE_CONTROL_EXTENSION_NAME "VK_EXT_pipeline_creation_cache_control" ### string, not number "\"VK_EXT_pipeline_creation_cache_control\"" */
typedef VkPhysicalDevicePipelineCreationCacheControlFeatures VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT;
enum { VK_NV_device_diagnostics_config = 1 };
enum { VK_NV_DEVICE_DIAGNOSTICS_CONFIG_SPEC_VERSION = 2 };
/* #define VK_NV_DEVICE_DIAGNOSTICS_CONFIG_EXTENSION_NAME "VK_NV_device_diagnostics_config" ### string, not number "\"VK_NV_device_diagnostics_config\"" */
typedef enum VkDeviceDiagnosticsConfigFlagBitsNV { VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_SHADER_DEBUG_INFO_BIT_NV = 0x00000001, VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_RESOURCE_TRACKING_BIT_NV = 0x00000002, VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_AUTOMATIC_CHECKPOINTS_BIT_NV = 0x00000004, VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_SHADER_ERROR_REPORTING_BIT_NV = 0x00000008, VK_DEVICE_DIAGNOSTICS_CONFIG_FLAG_BITS_MAX_ENUM_NV = 0x7FFFFFFF } VkDeviceDiagnosticsConfigFlagBitsNV;
...
/* #define VK_QCOM_RENDER_PASS_STORE_OPS_EXTENSION_NAME "VK_QCOM_render_pass_store_ops" ### string, not number "\"VK_QCOM_render_pass_store_ops\"" */
...
/* #define VK_NV_CUDA_KERNEL_LAUNCH_EXTENSION_NAME "VK_NV_cuda_kernel_launch" ### string, not number "\"VK_NV_cuda_kernel_launch\"" */
...
/* #define VK_NV_LOW_LATENCY_EXTENSION_NAME  "VK_NV_low_latency" ### string, not number "\"VK_NV_low_latency\"" */
...
/* #define VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME "VK_EXT_descriptor_buffer" ### string, not number "\"VK_EXT_descriptor_buffer\"" */
...
/* #define VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME "VK_EXT_graphics_pipeline_library" ### string, not number "\"VK_EXT_graphics_pipeline_library\"" */
...
enum { VK_AMD_shader_early_and_late_fragment_tests = 1 };
enum { VK_AMD_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_SPEC_VERSION = 1 };
/* #define VK_AMD_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_EXTENSION_NAME "VK_AMD_shader_early_and_late_fragment_tests" ### string, not number "\"VK_AMD_shader_early_and_late_fragment_tests\"" */
...
/* #define VK_NV_FRAGMENT_SHADING_RATE_ENUMS_EXTENSION_NAME "VK_NV_fragment_shading_rate_enums" ### string, not number "\"VK_NV_fragment_shading_rate_enums\"" */
typedef enum VkFragmentShadingRateTypeNV { VK_FRAGMENT_SHADING_RATE_TYPE_FRAGMENT_SIZE_NV = 0, VK_FRAGMENT_SHADING_RATE_TYPE_ENUMS_NV = 1, VK_FRAGMENT_SHADING_RATE_TYPE_MAX_ENUM_NV = 0x7FFFFFFF } VkFragmentShadingRateTypeNV;
typedef enum VkFragmentShadingRateNV { VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV = 0, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV = 1, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV = 4, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV = 5, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV = 6, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV = 9, VK_FRAGMENT_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV = 10, VK_FRAGMENT_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV = 11, VK_FRAGMENT_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV = 12, VK_FRAGMENT_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV = 13, VK_FRAGMENT_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV = 14, VK_FRAGMENT_SHADING_RATE_NO_INVOCATIONS_NV = 15, VK_FRAGMENT_SHADING_RATE_MAX_ENUM_NV = 0x7FFFFFFF } VkFragmentShadingRateNV;
...
/* #define VK_EXT_YCBCR_2PLANE_444_FORMATS_EXTENSION_NAME "VK_EXT_ycbcr_2plane_444_formats" ### string, not number "\"VK_EXT_ycbcr_2plane_444_formats\"" */
...
/* #define VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME "VK_EXT_fragment_density_map2" ### string, not number "\"VK_EXT_fragment_density_map2\"" */
...
/* #define VK_QCOM_ROTATED_COPY_COMMANDS_EXTENSION_NAME "VK_QCOM_rotated_copy_commands" ### string, not number "\"VK_QCOM_rotated_copy_commands\"" */
...
enum { VK_EXT_attachment_feedback_loop_layout = 1 };
enum { VK_EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_SPEC_VERSION = 2 };
/* #define VK_EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_EXTENSION_NAME "VK_EXT_attachment_feedback_loop_layout" ### string, not number "\"VK_EXT_attachment_feedback_loop_layout\"" */
...
/* #define VK_EXT_4444_FORMATS_EXTENSION_NAME "VK_EXT_4444_formats" ### string, not number "\"VK_EXT_4444_formats\"" */
...
/* #define VK_ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME "VK_ARM_rasterization_order_attachment_access" ### string, not number "\"VK_ARM_rasterization_order_attachment_access\"" */
...
/* #define VK_EXT_RGBA10X6_FORMATS_EXTENSION_NAME "VK_EXT_rgba10x6_formats" ### string, not number "\"VK_EXT_rgba10x6_formats\"" */
...
/* #define VK_VALVE_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME "VK_VALVE_mutable_descriptor_type" ### string, not number "\"VK_VALVE_mutable_descriptor_type\"" */
...
/* #define VK_EXT_VERTEX_INPUT_DYNAMIC_STATE_EXTENSION_NAME "VK_EXT_vertex_input_dynamic_state" ### string, not number "\"VK_EXT_vertex_input_dynamic_state\"" */
...
/* #define VK_EXT_PHYSICAL_DEVICE_DRM_EXTENSION_NAME "VK_EXT_physical_device_drm" ### string, not number "\"VK_EXT_physical_device_drm\"" */
...
enum { VK_EXT_device_address_binding_report = 1 };
enum { VK_EXT_DEVICE_ADDRESS_BINDING_REPORT_SPEC_VERSION = 1 };
/* #define VK_EXT_DEVICE_ADDRESS_BINDING_REPORT_EXTENSION_NAME "VK_EXT_device_address_binding_report" ### string, not number "\"VK_EXT_device_address_binding_report\"" */
typedef enum VkDeviceAddressBindingTypeEXT { VK_DEVICE_ADDRESS_BINDING_TYPE_BIND_EXT = 0, VK_DEVICE_ADDRESS_BINDING_TYPE_UNBIND_EXT = 1, VK_DEVICE_ADDRESS_BINDING_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkDeviceAddressBindingTypeEXT;
typedef enum VkDeviceAddressBindingFlagBitsEXT { VK_DEVICE_ADDRESS_BINDING_INTERNAL_OBJECT_BIT_EXT = 0x00000001, VK_DEVICE_ADDRESS_BINDING_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkDeviceAddressBindingFlagBitsEXT;
...
/* #define VK_EXT_DEPTH_CLIP_CONTROL_EXTENSION_NAME "VK_EXT_depth_clip_control" ### string, not number "\"VK_EXT_depth_clip_control\"" */
...
/* #define VK_EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_EXTENSION_NAME "VK_EXT_primitive_topology_list_restart" ### string, not number "\"VK_EXT_primitive_topology_list_restart\"" */
...
/* #define VK_HUAWEI_SUBPASS_SHADING_EXTENSION_NAME "VK_HUAWEI_subpass_shading" ### string, not number "\"VK_HUAWEI_subpass_shading\"" */
...
/* #define VK_HUAWEI_INVOCATION_MASK_EXTENSION_NAME "VK_HUAWEI_invocation_mask" ### string, not number "\"VK_HUAWEI_invocation_mask\"" */
...
/* #define VK_NV_EXTERNAL_MEMORY_RDMA_EXTENSION_NAME "VK_NV_external_memory_rdma" ### string, not number "\"VK_NV_external_memory_rdma\"" */
...
enum { VK_EXT_pipeline_properties = 1 };
enum { VK_EXT_PIPELINE_PROPERTIES_SPEC_VERSION = 1 };
/* #define VK_EXT_PIPELINE_PROPERTIES_EXTENSION_NAME "VK_EXT_pipeline_properties" ### string, not number "\"VK_EXT_pipeline_properties\"" */
...
enum { VK_EXT_frame_boundary = 1 };
enum { VK_EXT_FRAME_BOUNDARY_SPEC_VERSION = 1 };
/* #define VK_EXT_FRAME_BOUNDARY_EXTENSION_NAME "VK_EXT_frame_boundary" ### string, not number "\"VK_EXT_frame_boundary\"" */
typedef enum VkFrameBoundaryFlagBitsEXT { VK_FRAME_BOUNDARY_FRAME_END_BIT_EXT = 0x00000001, VK_FRAME_BOUNDARY_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkFrameBoundaryFlagBitsEXT;
...
enum { VK_EXT_multisampled_render_to_single_sampled = 1 };
enum { VK_EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_SPEC_VERSION = 1 };
/* #define VK_EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_EXTENSION_NAME "VK_EXT_multisampled_render_to_single_sampled" ### string, not number "\"VK_EXT_multisampled_render_to_single_sampled\"" */
...
/* #define VK_EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME "VK_EXT_extended_dynamic_state2" ### string, not number "\"VK_EXT_extended_dynamic_state2\"" */
...
/* #define VK_EXT_COLOR_WRITE_ENABLE_EXTENSION_NAME "VK_EXT_color_write_enable" ### string, not number "\"VK_EXT_color_write_enable\"" */
...
enum { VK_EXT_primitives_generated_query = 1 };
enum { VK_EXT_PRIMITIVES_GENERATED_QUERY_SPEC_VERSION = 1 };
/* #define VK_EXT_PRIMITIVES_GENERATED_QUERY_EXTENSION_NAME "VK_EXT_primitives_generated_query" ### string, not number "\"VK_EXT_primitives_generated_query\"" */
...
/* #define VK_EXT_GLOBAL_PRIORITY_QUERY_EXTENSION_NAME "VK_EXT_global_priority_query" ### string, not number "\"VK_EXT_global_priority_query\"" */
enum { VK_MAX_GLOBAL_PRIORITY_SIZE_EXT = 16 };
...
/* #define VK_EXT_IMAGE_VIEW_MIN_LOD_EXTENSION_NAME "VK_EXT_image_view_min_lod" ### string, not number "\"VK_EXT_image_view_min_lod\"" */
...
/* #define VK_EXT_MULTI_DRAW_EXTENSION_NAME  "VK_EXT_multi_draw" ### string, not number "\"VK_EXT_multi_draw\"" */
...
enum { VK_EXT_image_2d_view_of_3d = 1 };
enum { VK_EXT_IMAGE_2D_VIEW_OF_3D_SPEC_VERSION = 1 };
/* #define VK_EXT_IMAGE_2D_VIEW_OF_3D_EXTENSION_NAME "VK_EXT_image_2d_view_of_3d" ### string, not number "\"VK_EXT_image_2d_view_of_3d\"" */
...
/* #define VK_EXT_SHADER_TILE_IMAGE_EXTENSION_NAME "VK_EXT_shader_tile_image" ### string, not number "\"VK_EXT_shader_tile_image\"" */
...
/* #define VK_EXT_OPACITY_MICROMAP_EXTENSION_NAME "VK_EXT_opacity_micromap" ### string, not number "\"VK_EXT_opacity_micromap\"" */
typedef enum VkMicromapTypeEXT { VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT = 0, VK_MICROMAP_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkMicromapTypeEXT;
typedef enum VkBuildMicromapModeEXT { VK_BUILD_MICROMAP_MODE_BUILD_EXT = 0, VK_BUILD_MICROMAP_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkBuildMicromapModeEXT;
typedef enum VkCopyMicromapModeEXT { VK_COPY_MICROMAP_MODE_CLONE_EXT = 0, VK_COPY_MICROMAP_MODE_SERIALIZE_EXT = 1, VK_COPY_MICROMAP_MODE_DESERIALIZE_EXT = 2, VK_COPY_MICROMAP_MODE_COMPACT_EXT = 3, VK_COPY_MICROMAP_MODE_MAX_ENUM_EXT = 0x7FFFFFFF } VkCopyMicromapModeEXT;
typedef enum VkOpacityMicromapFormatEXT { VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT = 1, VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT = 2, VK_OPACITY_MICROMAP_FORMAT_MAX_ENUM_EXT = 0x7FFFFFFF } VkOpacityMicromapFormatEXT;
typedef enum VkOpacityMicromapSpecialIndexEXT { VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_TRANSPARENT_EXT = -1, VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_OPAQUE_EXT = -2, VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_UNKNOWN_TRANSPARENT_EXT = -3, VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_UNKNOWN_OPAQUE_EXT = -4, VK_OPACITY_MICROMAP_SPECIAL_INDEX_MAX_ENUM_EXT = 0x7FFFFFFF } VkOpacityMicromapSpecialIndexEXT;
typedef enum VkAccelerationStructureCompatibilityKHR { VK_ACCELERATION_STRUCTURE_COMPATIBILITY_COMPATIBLE_KHR = 0, VK_ACCELERATION_STRUCTURE_COMPATIBILITY_INCOMPATIBLE_KHR = 1, VK_ACCELERATION_STRUCTURE_COMPATIBILITY_MAX_ENUM_KHR = 0x7FFFFFFF } VkAccelerationStructureCompatibilityKHR;
typedef enum VkAccelerationStructureBuildTypeKHR { VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_KHR = 0, VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR = 1, VK_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_OR_DEVICE_KHR = 2, VK_ACCELERATION_STRUCTURE_BUILD_TYPE_MAX_ENUM_KHR = 0x7FFFFFFF } VkAccelerationStructureBuildTypeKHR;
typedef enum VkBuildMicromapFlagBitsEXT { VK_BUILD_MICROMAP_PREFER_FAST_TRACE_BIT_EXT = 0x00000001, VK_BUILD_MICROMAP_PREFER_FAST_BUILD_BIT_EXT = 0x00000002, VK_BUILD_MICROMAP_ALLOW_COMPACTION_BIT_EXT = 0x00000004, VK_BUILD_MICROMAP_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkBuildMicromapFlagBitsEXT;
typedef VkFlags VkBuildMicromapFlagsEXT;
typedef enum VkMicromapCreateFlagBitsEXT { VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT = 0x00000001, VK_MICROMAP_CREATE_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkMicromapCreateFlagBitsEXT;
...
/* #define VK_EXT_LOAD_STORE_OP_NONE_EXTENSION_NAME "VK_EXT_load_store_op_none" ### string, not number "\"VK_EXT_load_store_op_none\"" */
enum { VK_HUAWEI_cluster_culling_shader = 1 };
enum { VK_HUAWEI_CLUSTER_CULLING_SHADER_SPEC_VERSION = 3 };
/* #define VK_HUAWEI_CLUSTER_CULLING_SHADER_EXTENSION_NAME "VK_HUAWEI_cluster_culling_shader" ### string, not number "\"VK_HUAWEI_cluster_culling_shader\"" */
...
/* #define VK_EXT_BORDER_COLOR_SWIZZLE_EXTENSION_NAME "VK_EXT_border_color_swizzle" ### string, not number "\"VK_EXT_border_color_swizzle\"" */
...
/* #define VK_EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME "VK_EXT_pageable_device_local_memory" ### string, not number "\"VK_EXT_pageable_device_local_memory\"" */
...
/* #define VK_ARM_SHADER_CORE_PROPERTIES_EXTENSION_NAME "VK_ARM_shader_core_properties" ### string, not number "\"VK_ARM_shader_core_properties\"" */
...
enum { VK_ARM_scheduling_controls = 1 };
enum { VK_ARM_SCHEDULING_CONTROLS_SPEC_VERSION = 1 };
/* #define VK_ARM_SCHEDULING_CONTROLS_EXTENSION_NAME "VK_ARM_scheduling_controls" ### string, not number "\"VK_ARM_scheduling_controls\"" */
...
/* #define VK_EXT_IMAGE_SLICED_VIEW_OF_3D_EXTENSION_NAME "VK_EXT_image_sliced_view_of_3d" ### string, not number "\"VK_EXT_image_sliced_view_of_3d\"" */
...
/* #define VK_VALVE_DESCRIPTOR_SET_HOST_MAPPING_EXTENSION_NAME "VK_VALVE_descriptor_set_host_mapping" ### string, not number "\"VK_VALVE_descriptor_set_host_mapping\"" */
...
enum { VK_EXT_depth_clamp_zero_one = 1 };
enum { VK_EXT_DEPTH_CLAMP_ZERO_ONE_SPEC_VERSION = 1 };
/* #define VK_EXT_DEPTH_CLAMP_ZERO_ONE_EXTENSION_NAME "VK_EXT_depth_clamp_zero_one" ### string, not number "\"VK_EXT_depth_clamp_zero_one\"" */
typedef struct VkPhysicalDeviceDepthClampZeroOneFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 depthClampZeroOne;
} VkPhysicalDeviceDepthClampZeroOneFeaturesEXT;
enum { VK_EXT_non_seamless_cube_map = 1 };
enum { VK_EXT_NON_SEAMLESS_CUBE_MAP_SPEC_VERSION = 1 };
/* #define VK_EXT_NON_SEAMLESS_CUBE_MAP_EXTENSION_NAME "VK_EXT_non_seamless_cube_map" ### string, not number "\"VK_EXT_non_seamless_cube_map\"" */
typedef struct VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 nonSeamlessCubeMap;
} VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT;
enum { VK_ARM_render_pass_striped = 1 };
enum { VK_ARM_RENDER_PASS_STRIPED_SPEC_VERSION = 1 };
/* #define VK_ARM_RENDER_PASS_STRIPED_EXTENSION_NAME "VK_ARM_render_pass_striped" ### string, not number "\"VK_ARM_render_pass_striped\"" */
...
/* #define VK_QCOM_FRAGMENT_DENSITY_MAP_OFFSET_EXTENSION_NAME "VK_QCOM_fragment_density_map_offset" ### string, not number "\"VK_QCOM_fragment_density_map_offset\"" */
...
enum { VK_NV_copy_memory_indirect = 1 };
enum { VK_NV_COPY_MEMORY_INDIRECT_SPEC_VERSION = 1 };
/* #define VK_NV_COPY_MEMORY_INDIRECT_EXTENSION_NAME "VK_NV_copy_memory_indirect" ### string, not number "\"VK_NV_copy_memory_indirect\"" */
...
enum { VK_NV_memory_decompression = 1 };
enum { VK_NV_MEMORY_DECOMPRESSION_SPEC_VERSION = 1 };
/* #define VK_NV_MEMORY_DECOMPRESSION_EXTENSION_NAME "VK_NV_memory_decompression" ### string, not number "\"VK_NV_memory_decompression\"" */
...
enum { VK_NV_device_generated_commands_compute = 1 };
enum { VK_NV_DEVICE_GENERATED_COMMANDS_COMPUTE_SPEC_VERSION = 2 };
/* #define VK_NV_DEVICE_GENERATED_COMMANDS_COMPUTE_EXTENSION_NAME "VK_NV_device_generated_commands_compute" ### string, not number "\"VK_NV_device_generated_commands_compute\"" */
...
/* #define VK_NV_LINEAR_COLOR_ATTACHMENT_EXTENSION_NAME "VK_NV_linear_color_attachment" ### string, not number "\"VK_NV_linear_color_attachment\"" */
...
/* #define VK_GOOGLE_SURFACELESS_QUERY_EXTENSION_NAME "VK_GOOGLE_surfaceless_query" ### string, not number "\"VK_GOOGLE_surfaceless_query\"" */
enum { VK_EXT_image_compression_control_swapchain = 1 };
enum { VK_EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_SPEC_VERSION = 1 };
/* #define VK_EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_EXTENSION_NAME "VK_EXT_image_compression_control_swapchain" ### string, not number "\"VK_EXT_image_compression_control_swapchain\"" */
typedef struct VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 imageCompressionControlSwapchain;
} VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT;
enum { VK_QCOM_image_processing = 1 };
enum { VK_QCOM_IMAGE_PROCESSING_SPEC_VERSION = 1 };
/* #define VK_QCOM_IMAGE_PROCESSING_EXTENSION_NAME "VK_QCOM_image_processing" ### string, not number "\"VK_QCOM_image_processing\"" */
...
enum { VK_EXT_nested_command_buffer = 1 };
enum { VK_EXT_NESTED_COMMAND_BUFFER_SPEC_VERSION = 1 };
/* #define VK_EXT_NESTED_COMMAND_BUFFER_EXTENSION_NAME "VK_EXT_nested_command_buffer" ### string, not number "\"VK_EXT_nested_command_buffer\"" */
...
enum { VK_EXT_external_memory_acquire_unmodified = 1 };
enum { VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_SPEC_VERSION = 1 };
/* #define VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXTENSION_NAME "VK_EXT_external_memory_acquire_unmodified" ### string, not number "\"VK_EXT_external_memory_acquire_unmodified\"" */
typedef struct VkExternalMemoryAcquireUnmodifiedEXT {
	VkStructureType sType;
	const void* pNext;
	VkBool32 acquireUnmodifiedMemory;
} VkExternalMemoryAcquireUnmodifiedEXT;
enum { VK_EXT_extended_dynamic_state3 = 1 };
enum { VK_EXT_EXTENDED_DYNAMIC_STATE_3_SPEC_VERSION = 2 };
/* #define VK_EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME "VK_EXT_extended_dynamic_state3" ### string, not number "\"VK_EXT_extended_dynamic_state3\"" */
...
enum { VK_LUNARG_direct_driver_loading = 1 };
enum { VK_LUNARG_DIRECT_DRIVER_LOADING_SPEC_VERSION = 1 };
/* #define VK_LUNARG_DIRECT_DRIVER_LOADING_EXTENSION_NAME "VK_LUNARG_direct_driver_loading" ### string, not number "\"VK_LUNARG_direct_driver_loading\"" */
typedef enum VkDirectDriverLoadingModeLUNARG { VK_DIRECT_DRIVER_LOADING_MODE_EXCLUSIVE_LUNARG = 0, VK_DIRECT_DRIVER_LOADING_MODE_INCLUSIVE_LUNARG = 1, VK_DIRECT_DRIVER_LOADING_MODE_MAX_ENUM_LUNARG = 0x7FFFFFFF } VkDirectDriverLoadingModeLUNARG;
...
enum { VK_EXT_shader_module_identifier = 1 };
enum { VK_MAX_SHADER_MODULE_IDENTIFIER_SIZE_EXT = 32 };
enum { VK_EXT_SHADER_MODULE_IDENTIFIER_SPEC_VERSION = 1 };
/* #define VK_EXT_SHADER_MODULE_IDENTIFIER_EXTENSION_NAME "VK_EXT_shader_module_identifier" ### string, not number "\"VK_EXT_shader_module_identifier\"" */
...
enum { VK_EXT_rasterization_order_attachment_access = 1 };
enum { VK_EXT_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_SPEC_VERSION = 1 };
/* #define VK_EXT_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME "VK_EXT_rasterization_order_attachment_access" ### string, not number "\"VK_EXT_rasterization_order_attachment_access\"" */
enum { VK_NV_optical_flow = 1 };
typedef struct VkOpticalFlowSessionNV_T *VkOpticalFlowSessionNV;
enum { VK_NV_OPTICAL_FLOW_SPEC_VERSION = 1 };
/* #define VK_NV_OPTICAL_FLOW_EXTENSION_NAME "VK_NV_optical_flow" ### string, not number "\"VK_NV_optical_flow\"" */
typedef enum VkOpticalFlowPerformanceLevelNV { VK_OPTICAL_FLOW_PERFORMANCE_LEVEL_UNKNOWN_NV = 0, VK_OPTICAL_FLOW_PERFORMANCE_LEVEL_SLOW_NV = 1, VK_OPTICAL_FLOW_PERFORMANCE_LEVEL_MEDIUM_NV = 2, VK_OPTICAL_FLOW_PERFORMANCE_LEVEL_FAST_NV = 3, VK_OPTICAL_FLOW_PERFORMANCE_LEVEL_MAX_ENUM_NV = 0x7FFFFFFF } VkOpticalFlowPerformanceLevelNV;
...
typedef enum VkOpticalFlowExecuteFlagBitsNV { VK_OPTICAL_FLOW_EXECUTE_DISABLE_TEMPORAL_HINTS_BIT_NV = 0x00000001, VK_OPTICAL_FLOW_EXECUTE_FLAG_BITS_MAX_ENUM_NV = 0x7FFFFFFF } VkOpticalFlowExecuteFlagBitsNV;
...
enum { VK_EXT_legacy_dithering = 1 };
enum { VK_EXT_LEGACY_DITHERING_SPEC_VERSION = 1 };
/* #define VK_EXT_LEGACY_DITHERING_EXTENSION_NAME "VK_EXT_legacy_dithering" ### string, not number "\"VK_EXT_legacy_dithering\"" */
typedef struct VkPhysicalDeviceLegacyDitheringFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 legacyDithering;
} VkPhysicalDeviceLegacyDitheringFeaturesEXT;
enum { VK_EXT_pipeline_protected_access = 1 };
enum { VK_EXT_PIPELINE_PROTECTED_ACCESS_SPEC_VERSION = 1 };
/* #define VK_EXT_PIPELINE_PROTECTED_ACCESS_EXTENSION_NAME "VK_EXT_pipeline_protected_access" ### string, not number "\"VK_EXT_pipeline_protected_access\"" */
...
/* #define VK_EXT_SHADER_OBJECT_EXTENSION_NAME "VK_EXT_shader_object" ### string, not number "\"VK_EXT_shader_object\"" */
typedef enum VkShaderCodeTypeEXT { VK_SHADER_CODE_TYPE_BINARY_EXT = 0, VK_SHADER_CODE_TYPE_SPIRV_EXT = 1, VK_SHADER_CODE_TYPE_MAX_ENUM_EXT = 0x7FFFFFFF } VkShaderCodeTypeEXT;
typedef enum VkShaderCreateFlagBitsEXT { VK_SHADER_CREATE_LINK_STAGE_BIT_EXT = 0x00000001, VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT = 0x00000002, VK_SHADER_CREATE_REQUIRE_FULL_SUBGROUPS_BIT_EXT = 0x00000004, VK_SHADER_CREATE_NO_TASK_SHADER_BIT_EXT = 0x00000008, VK_SHADER_CREATE_DISPATCH_BASE_BIT_EXT = 0x00000010, VK_SHADER_CREATE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_EXT = 0x00000020, VK_SHADER_CREATE_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT = 0x00000040, VK_SHADER_CREATE_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF } VkShaderCreateFlagBitsEXT;
...
enum { VK_QCOM_tile_properties = 1 };
enum { VK_QCOM_TILE_PROPERTIES_SPEC_VERSION = 1 };
/* #define VK_QCOM_TILE_PROPERTIES_EXTENSION_NAME "VK_QCOM_tile_properties" ### string, not number "\"VK_QCOM_tile_properties\"" */
...
enum { VK_SEC_amigo_profiling = 1 };
enum { VK_SEC_AMIGO_PROFILING_SPEC_VERSION = 1 };
/* #define VK_SEC_AMIGO_PROFILING_EXTENSION_NAME "VK_SEC_amigo_profiling" ### string, not number "\"VK_SEC_amigo_profiling\"" */
...
enum { VK_QCOM_multiview_per_view_viewports = 1 };
enum { VK_QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_SPEC_VERSION = 1 };
/* #define VK_QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_EXTENSION_NAME "VK_QCOM_multiview_per_view_viewports" ### string, not number "\"VK_QCOM_multiview_per_view_viewports\"" */
typedef struct VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM {
	VkStructureType sType;
	void* pNext;
	VkBool32 multiviewPerViewViewports;
} VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM;
enum { VK_NV_ray_tracing_invocation_reorder = 1 };
enum { VK_NV_RAY_TRACING_INVOCATION_REORDER_SPEC_VERSION = 1 };
/* #define VK_NV_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME "VK_NV_ray_tracing_invocation_reorder" ### string, not number "\"VK_NV_ray_tracing_invocation_reorder\"" */
typedef enum VkRayTracingInvocationReorderModeNV { VK_RAY_TRACING_INVOCATION_REORDER_MODE_NONE_NV = 0, VK_RAY_TRACING_INVOCATION_REORDER_MODE_REORDER_NV = 1, VK_RAY_TRACING_INVOCATION_REORDER_MODE_MAX_ENUM_NV = 0x7FFFFFFF } VkRayTracingInvocationReorderModeNV;
...
enum { VK_NV_extended_sparse_address_space = 1 };
enum { VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_SPEC_VERSION = 1 };
/* #define VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_EXTENSION_NAME "VK_NV_extended_sparse_address_space" ### string, not number "\"VK_NV_extended_sparse_address_space\"" */
...
/* #define VK_ARM_SHADER_CORE_BUILTINS_EXTENSION_NAME "VK_ARM_shader_core_builtins" ### string, not number "\"VK_ARM_shader_core_builtins\"" */
...
enum { VK_EXT_pipeline_library_group_handles = 1 };
enum { VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_SPEC_VERSION = 1 };
/* #define VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME "VK_EXT_pipeline_library_group_handles" ### string, not number "\"VK_EXT_pipeline_library_group_handles\"" */
typedef struct VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 pipelineLibraryGroupHandles;
} VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT;
enum { VK_EXT_dynamic_rendering_unused_attachments = 1 };
enum { VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_SPEC_VERSION = 1 };
/* #define VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_EXTENSION_NAME "VK_EXT_dynamic_rendering_unused_attachments" ### string, not number "\"VK_EXT_dynamic_rendering_unused_attachments\"" */
typedef struct VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT {
	VkStructureType sType;
	void* pNext;
	VkBool32 dynamicRenderingUnusedAttachments;
} VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT;
enum { VK_NV_low_latency2 = 1 };
enum { VK_NV_LOW_LATENCY_2_SPEC_VERSION = 2 };
/* #define VK_NV_LOW_LATENCY_2_EXTENSION_NAME "VK_NV_low_latency2" ### string, not number "\"VK_NV_low_latency2\"" */
typedef enum VkLatencyMarkerNV { VK_LATENCY_MARKER_SIMULATION_START_NV = 0, VK_LATENCY_MARKER_SIMULATION_END_NV = 1, VK_LATENCY_MARKER_RENDERSUBMIT_START_NV = 2, VK_LATENCY_MARKER_RENDERSUBMIT_END_NV = 3, VK_LATENCY_MARKER_PRESENT_START_NV = 4, VK_LATENCY_MARKER_PRESENT_END_NV = 5, VK_LATENCY_MARKER_INPUT_SAMPLE_NV = 6, VK_LATENCY_MARKER_TRIGGER_FLASH_NV = 7, VK_LATENCY_MARKER_OUT_OF_BAND_RENDERSUBMIT_START_NV = 8, VK_LATENCY_MARKER_OUT_OF_BAND_RENDERSUBMIT_END_NV = 9, VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_START_NV = 10, VK_LATENCY_MARKER_OUT_OF_BAND_PRESENT_END_NV = 11, VK_LATENCY_MARKER_MAX_ENUM_NV = 0x7FFFFFFF } VkLatencyMarkerNV;
typedef enum VkOutOfBandQueueTypeNV { VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV = 0, VK_OUT_OF_BAND_QUEUE_TYPE_PRESENT_NV = 1, VK_OUT_OF_BAND_QUEUE_TYPE_MAX_ENUM_NV = 0x7FFFFFFF } VkOutOfBandQueueTypeNV;
...
/* #define VK_QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_EXTENSION_NAME "VK_QCOM_multiview_per_view_render_areas" ### string, not number "\"VK_QCOM_multiview_per_view_render_areas\"" */
...
enum { VK_NV_per_stage_descriptor_set = 1 };
enum { VK_NV_PER_STAGE_DESCRIPTOR_SET_SPEC_VERSION = 1 };
/* #define VK_NV_PER_STAGE_DESCRIPTOR_SET_EXTENSION_NAME "VK_NV_per_stage_descriptor_set" ### string, not number "\"VK_NV_per_stage_descriptor_set\"" */
...
enum { VK_QCOM_image_processing2 = 1 };
enum { VK_QCOM_IMAGE_PROCESSING_2_SPEC_VERSION = 1 };
/* #define VK_QCOM_IMAGE_PROCESSING_2_EXTENSION_NAME "VK_QCOM_image_processing2" ### string, not number "\"VK_QCOM_image_processing2\"" */
typedef enum VkBlockMatchWindowCompareModeQCOM { VK_BLOCK_MATCH_WINDOW_COMPARE_MODE_MIN_QCOM = 0, VK_BLOCK_MATCH_WINDOW_COMPARE_MODE_MAX_QCOM = 1, VK_BLOCK_MATCH_WINDOW_COMPARE_MODE_MAX_ENUM_QCOM = 0x7FFFFFFF } VkBlockMatchWindowCompareModeQCOM;
...
enum { VK_QCOM_filter_cubic_weights = 1 };
enum { VK_QCOM_FILTER_CUBIC_WEIGHTS_SPEC_VERSION = 1 };
/* #define VK_QCOM_FILTER_CUBIC_WEIGHTS_EXTENSION_NAME "VK_QCOM_filter_cubic_weights" ### string, not number "\"VK_QCOM_filter_cubic_weights\"" */
typedef enum VkCubicFilterWeightsQCOM { VK_CUBIC_FILTER_WEIGHTS_CATMULL_ROM_QCOM = 0, VK_CUBIC_FILTER_WEIGHTS_ZERO_TANGENT_CARDINAL_QCOM = 1, VK_CUBIC_FILTER_WEIGHTS_B_SPLINE_QCOM = 2, VK_CUBIC_FILTER_WEIGHTS_MITCHELL_NETRAVALI_QCOM = 3, VK_CUBIC_FILTER_WEIGHTS_MAX_ENUM_QCOM = 0x7FFFFFFF } VkCubicFilterWeightsQCOM;
...
enum { VK_QCOM_ycbcr_degamma = 1 };
enum { VK_QCOM_YCBCR_DEGAMMA_SPEC_VERSION = 1 };
/* #define VK_QCOM_YCBCR_DEGAMMA_EXTENSION_NAME "VK_QCOM_ycbcr_degamma" ### string, not number "\"VK_QCOM_ycbcr_degamma\"" */
...
enum { VK_QCOM_filter_cubic_clamp = 1 };
enum { VK_QCOM_FILTER_CUBIC_CLAMP_SPEC_VERSION = 1 };
/* #define VK_QCOM_FILTER_CUBIC_CLAMP_EXTENSION_NAME "VK_QCOM_filter_cubic_clamp" ### string, not number "\"VK_QCOM_filter_cubic_clamp\"" */
typedef struct VkPhysicalDeviceCubicClampFeaturesQCOM {
	VkStructureType sType;
	void* pNext;
	VkBool32 cubicRangeClamp;
} VkPhysicalDeviceCubicClampFeaturesQCOM;
enum { VK_EXT_attachment_feedback_loop_dynamic_state = 1 };
enum { VK_EXT_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_SPEC_VERSION = 1 };
/* #define VK_EXT_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_EXTENSION_NAME "VK_EXT_attachment_feedback_loop_dynamic_state" ### string, not number "\"VK_EXT_attachment_feedback_loop_dynamic_state\"" */
...
enum { VK_MSFT_layered_driver = 1 };
enum { VK_MSFT_LAYERED_DRIVER_SPEC_VERSION = 1 };
/* #define VK_MSFT_LAYERED_DRIVER_EXTENSION_NAME "VK_MSFT_layered_driver" ### string, not number "\"VK_MSFT_layered_driver\"" */
typedef enum VkLayeredDriverUnderlyingApiMSFT { VK_LAYERED_DRIVER_UNDERLYING_API_NONE_MSFT = 0, VK_LAYERED_DRIVER_UNDERLYING_API_D3D12_MSFT = 1, VK_LAYERED_DRIVER_UNDERLYING_API_MAX_ENUM_MSFT = 0x7FFFFFFF } VkLayeredDriverUnderlyingApiMSFT;
typedef struct VkPhysicalDeviceLayeredDriverPropertiesMSFT {
	VkStructureType sType;
	void* pNext;
	VkLayeredDriverUnderlyingApiMSFT underlyingAPI;
} VkPhysicalDeviceLayeredDriverPropertiesMSFT;
enum { VK_NV_descriptor_pool_overallocation = 1 };
enum { VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_SPEC_VERSION = 1 };
/* #define VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_EXTENSION_NAME "VK_NV_descriptor_pool_overallocation" ### string, not number "\"VK_NV_descriptor_pool_overallocation\"" */
...
/* #define VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME "VK_KHR_acceleration_structure" ### string, not number "\"VK_KHR_acceleration_structure\"" */
typedef enum VkBuildAccelerationStructureModeKHR { VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR = 0, VK_BUILD_ACCELERATION_STRUCTURE_MODE_UPDATE_KHR = 1, VK_BUILD_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_KHR = 0x7FFFFFFF } VkBuildAccelerationStructureModeKHR;
typedef enum VkAccelerationStructureCreateFlagBitsKHR { VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = 0x00000001, VK_ACCELERATION_STRUCTURE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT = 0x00000008, VK_ACCELERATION_STRUCTURE_CREATE_MOTION_BIT_NV = 0x00000004, VK_ACCELERATION_STRUCTURE_CREATE_FLAG_BITS_MAX_ENUM_KHR = 0x7FFFFFFF } VkAccelerationStructureCreateFlagBitsKHR;
...
/* #define VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME "VK_KHR_ray_tracing_pipeline" ### string, not number "\"VK_KHR_ray_tracing_pipeline\"" */
typedef enum VkShaderGroupShaderKHR { VK_SHADER_GROUP_SHADER_GENERAL_KHR = 0, VK_SHADER_GROUP_SHADER_CLOSEST_HIT_KHR = 1, VK_SHADER_GROUP_SHADER_ANY_HIT_KHR = 2, VK_SHADER_GROUP_SHADER_INTERSECTION_KHR = 3, VK_SHADER_GROUP_SHADER_MAX_ENUM_KHR = 0x7FFFFFFF } VkShaderGroupShaderKHR;
...
/* #define VK_KHR_RAY_QUERY_EXTENSION_NAME   "VK_KHR_ray_query" ### string, not number "\"VK_KHR_ray_query\"" */
typedef struct VkPhysicalDeviceRayQueryFeaturesKHR {
	VkStructureType sType;
	void* pNext;
	VkBool32 rayQuery;
} VkPhysicalDeviceRayQueryFeaturesKHR;
enum { VK_EXT_mesh_shader = 1 };
enum { VK_EXT_MESH_SHADER_SPEC_VERSION = 1 };
/* #define VK_EXT_MESH_SHADER_EXTENSION_NAME "VK_EXT_mesh_shader" ### string, not number "\"VK_EXT_mesh_shader\"" */
...
/* + END   /usr/include/vulkan/vulkan_core.h */
]]
...
return setmetatable({
	...
	VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000001),
	VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000001),
	VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000002),
	VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000002),
	VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000004),
	VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000004),
	VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000008),
	VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000008),
	VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000010),
	VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000010),
	VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000020),
	VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000020),
	VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000040),
	VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000040),
	VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000080),
	VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000080),
	VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000100),
	VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000100),
	VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000200),
	VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000200),
	VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000400),
	VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000400),
	VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00000800),
	VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00000800),
	VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00001000),
	VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00001000),
	VK_PIPELINE_STAGE_2_TRANSFER_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00001000),
	VK_PIPELINE_STAGE_2_TRANSFER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00001000),
	VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00002000),
	VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00002000),
	VK_PIPELINE_STAGE_2_HOST_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00004000),
	VK_PIPELINE_STAGE_2_HOST_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00004000),
	VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00008000),
	VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00008000),
	VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT = ffi.new('VkPipelineStageFlagBits2', 0x00010000),
	VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00010000),
	VK_PIPELINE_STAGE_2_COPY_BIT = ffi.new('VkPipelineStageFlagBits2', 0x100000000),
	VK_PIPELINE_STAGE_2_COPY_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x100000000),
	VK_PIPELINE_STAGE_2_RESOLVE_BIT = ffi.new('VkPipelineStageFlagBits2', 0x200000000),
	VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x200000000),
	VK_PIPELINE_STAGE_2_BLIT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x400000000),
	VK_PIPELINE_STAGE_2_BLIT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x400000000),
	VK_PIPELINE_STAGE_2_CLEAR_BIT = ffi.new('VkPipelineStageFlagBits2', 0x800000000),
	VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x800000000),
	VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x1000000000),
	VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x1000000000),
	VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT = ffi.new('VkPipelineStageFlagBits2', 0x2000000000),
	VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x2000000000),
	VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT = ffi.new('VkPipelineStageFlagBits2', 0x4000000000),
	VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x4000000000),
	VK_PIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x04000000),
	VK_PIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x08000000),
	VK_PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x01000000),
	VK_PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x00040000),
	VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x00020000),
	VK_PIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00400000),
	VK_PIPELINE_STAGE_2_SHADING_RATE_IMAGE_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x00400000),
	VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x02000000),
	VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x00200000),
	VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x00200000),
	VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x02000000),
	VK_PIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x00800000),
	VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x00080000),
	VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x00100000),
	VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x00080000),
	VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x00100000),
	VK_PIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEI = ffi.new('VkPipelineStageFlagBits2', 0x8000000000),
	VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI = ffi.new('VkPipelineStageFlagBits2', 0x8000000000),
	VK_PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI = ffi.new('VkPipelineStageFlagBits2', 0x10000000000),
	VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHR = ffi.new('VkPipelineStageFlagBits2', 0x10000000),
	VK_PIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXT = ffi.new('VkPipelineStageFlagBits2', 0x40000000),
	VK_PIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEI = ffi.new('VkPipelineStageFlagBits2', 0x20000000000),
	VK_PIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NV = ffi.new('VkPipelineStageFlagBits2', 0x20000000),
	VK_ACCESS_2_NONE = ffi.new('VkAccessFlagBits2', 0),
	VK_ACCESS_2_NONE_KHR = ffi.new('VkAccessFlagBits2', 0),
	VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000001),
	VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000001),
	VK_ACCESS_2_INDEX_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000002),
	VK_ACCESS_2_INDEX_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000002),
	VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000004),
	VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000004),
	VK_ACCESS_2_UNIFORM_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000008),
	VK_ACCESS_2_UNIFORM_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000008),
	VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000010),
	VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000010),
	VK_ACCESS_2_SHADER_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000020),
	VK_ACCESS_2_SHADER_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000020),
	VK_ACCESS_2_SHADER_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00000040),
	VK_ACCESS_2_SHADER_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000040),
	VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000080),
	VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000080),
	VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00000100),
	VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000100),
	VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000200),
	VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000200),
	VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00000400),
	VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000400),
	VK_ACCESS_2_TRANSFER_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00000800),
	VK_ACCESS_2_TRANSFER_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00000800),
	VK_ACCESS_2_TRANSFER_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00001000),
	VK_ACCESS_2_TRANSFER_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00001000),
	VK_ACCESS_2_HOST_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00002000),
	VK_ACCESS_2_HOST_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00002000),
	VK_ACCESS_2_HOST_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00004000),
	VK_ACCESS_2_HOST_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00004000),
	VK_ACCESS_2_MEMORY_READ_BIT = ffi.new('VkAccessFlagBits2', 0x00008000),
	VK_ACCESS_2_MEMORY_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00008000),
	VK_ACCESS_2_MEMORY_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x00010000),
	VK_ACCESS_2_MEMORY_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00010000),
	VK_ACCESS_2_SHADER_SAMPLED_READ_BIT = ffi.new('VkAccessFlagBits2', 0x100000000),
	VK_ACCESS_2_SHADER_SAMPLED_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x100000000),
	VK_ACCESS_2_SHADER_STORAGE_READ_BIT = ffi.new('VkAccessFlagBits2', 0x200000000),
	VK_ACCESS_2_SHADER_STORAGE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x200000000),
	VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT = ffi.new('VkAccessFlagBits2', 0x400000000),
	VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x400000000),
	VK_ACCESS_2_VIDEO_DECODE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x800000000),
	VK_ACCESS_2_VIDEO_DECODE_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x1000000000),
	VK_ACCESS_2_VIDEO_ENCODE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x2000000000),
	VK_ACCESS_2_VIDEO_ENCODE_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x4000000000),
	VK_ACCESS_2_TRANSFORM_FEEDBACK_WRITE_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x02000000),
	VK_ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x04000000),
	VK_ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x08000000),
	VK_ACCESS_2_CONDITIONAL_RENDERING_READ_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x00100000),
	VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV = ffi.new('VkAccessFlagBits2', 0x00020000),
	VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV = ffi.new('VkAccessFlagBits2', 0x00040000),
	VK_ACCESS_2_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00800000),
	VK_ACCESS_2_SHADING_RATE_IMAGE_READ_BIT_NV = ffi.new('VkAccessFlagBits2', 0x00800000),
	VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00200000),
	VK_ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x00400000),
	VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_NV = ffi.new('VkAccessFlagBits2', 0x00200000),
	VK_ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_NV = ffi.new('VkAccessFlagBits2', 0x00400000),
	VK_ACCESS_2_FRAGMENT_DENSITY_MAP_READ_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x01000000),
	VK_ACCESS_2_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x00080000),
	VK_ACCESS_2_DESCRIPTOR_BUFFER_READ_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x20000000000),
	VK_ACCESS_2_INVOCATION_MASK_READ_BIT_HUAWEI = ffi.new('VkAccessFlagBits2', 0x8000000000),
	VK_ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR = ffi.new('VkAccessFlagBits2', 0x10000000000),
	VK_ACCESS_2_MICROMAP_READ_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x100000000000),
	VK_ACCESS_2_MICROMAP_WRITE_BIT_EXT = ffi.new('VkAccessFlagBits2', 0x200000000000),
	VK_ACCESS_2_OPTICAL_FLOW_READ_BIT_NV = ffi.new('VkAccessFlagBits2', 0x40000000000),
	VK_ACCESS_2_OPTICAL_FLOW_WRITE_BIT_NV = ffi.new('VkAccessFlagBits2', 0x80000000000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000001),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000001),
	VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000002),
	VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000002),
	VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000004),
	VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000004),
	VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000008),
	VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000008),
	VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000010),
	VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000010),
	VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000020),
	VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000020),
	VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000040),
	VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000040),
	VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000080),
	VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000080),
	VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000100),
	VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000100),
	VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000200),
	VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000200),
	VK_FORMAT_FEATURE_2_BLIT_SRC_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000400),
	VK_FORMAT_FEATURE_2_BLIT_SRC_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000400),
	VK_FORMAT_FEATURE_2_BLIT_DST_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00000800),
	VK_FORMAT_FEATURE_2_BLIT_DST_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00000800),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00001000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00001000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00002000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT = ffi.new('VkFormatFeatureFlagBits2', 0x00002000),
	VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00004000),
	VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00004000),
	VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00008000),
	VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00008000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00010000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00010000),
	VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00020000),
	VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00020000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00040000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00040000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00080000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00080000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00100000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00100000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00200000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00200000),
	VK_FORMAT_FEATURE_2_DISJOINT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00400000),
	VK_FORMAT_FEATURE_2_DISJOINT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00400000),
	VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x00800000),
	VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x00800000),
	VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x80000000),
	VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x80000000),
	VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x100000000),
	VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x100000000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT = ffi.new('VkFormatFeatureFlagBits2', 0x200000000),
	VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x200000000),
	VK_FORMAT_FEATURE_2_VIDEO_DECODE_OUTPUT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x02000000),
	VK_FORMAT_FEATURE_2_VIDEO_DECODE_DPB_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x04000000),
	VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x20000000),
	VK_FORMAT_FEATURE_2_FRAGMENT_DENSITY_MAP_BIT_EXT = ffi.new('VkFormatFeatureFlagBits2', 0x01000000),
	VK_FORMAT_FEATURE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x40000000),
	VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT_EXT = ffi.new('VkFormatFeatureFlagBits2', 0x400000000000),
	VK_FORMAT_FEATURE_2_VIDEO_ENCODE_INPUT_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x08000000),
	VK_FORMAT_FEATURE_2_VIDEO_ENCODE_DPB_BIT_KHR = ffi.new('VkFormatFeatureFlagBits2', 0x10000000),
	VK_FORMAT_FEATURE_2_LINEAR_COLOR_ATTACHMENT_BIT_NV = ffi.new('VkFormatFeatureFlagBits2', 0x4000000000),
	VK_FORMAT_FEATURE_2_WEIGHT_IMAGE_BIT_QCOM = ffi.new('VkFormatFeatureFlagBits2', 0x400000000),
	VK_FORMAT_FEATURE_2_WEIGHT_SAMPLED_IMAGE_BIT_QCOM = ffi.new('VkFormatFeatureFlagBits2', 0x800000000),
	VK_FORMAT_FEATURE_2_BLOCK_MATCHING_BIT_QCOM = ffi.new('VkFormatFeatureFlagBits2', 0x1000000000),
	VK_FORMAT_FEATURE_2_BOX_FILTER_SAMPLED_BIT_QCOM = ffi.new('VkFormatFeatureFlagBits2', 0x2000000000),
	VK_FORMAT_FEATURE_2_OPTICAL_FLOW_IMAGE_BIT_NV = ffi.new('VkFormatFeatureFlagBits2', 0x10000000000),
	VK_FORMAT_FEATURE_2_OPTICAL_FLOW_VECTOR_BIT_NV = ffi.new('VkFormatFeatureFlagBits2', 0x20000000000),
	VK_FORMAT_FEATURE_2_OPTICAL_FLOW_COST_BIT_NV = ffi.new('VkFormatFeatureFlagBits2', 0x40000000000),
	VK_PIPELINE_CREATE_2_DISABLE_OPTIMIZATION_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000001),
	VK_PIPELINE_CREATE_2_ALLOW_DERIVATIVES_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000002),
	VK_PIPELINE_CREATE_2_DERIVATIVE_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000004),
	VK_PIPELINE_CREATE_2_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000008),
	VK_PIPELINE_CREATE_2_DISPATCH_BASE_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000010),
	VK_PIPELINE_CREATE_2_DEFER_COMPILE_BIT_NV = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000020),
	VK_PIPELINE_CREATE_2_CAPTURE_STATISTICS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000040),
	VK_PIPELINE_CREATE_2_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000080),
	VK_PIPELINE_CREATE_2_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000100),
	VK_PIPELINE_CREATE_2_EARLY_RETURN_ON_FAILURE_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000200),
	VK_PIPELINE_CREATE_2_LINK_TIME_OPTIMIZATION_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000400),
	VK_PIPELINE_CREATE_2_RETAIN_LINK_TIME_OPTIMIZATION_INFO_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00800000),
	VK_PIPELINE_CREATE_2_LIBRARY_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00000800),
	VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00001000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_AABBS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00002000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00004000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00008000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00010000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00020000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00080000),
	VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_NV = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00040000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_MOTION_BIT_NV = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00100000),
	VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00200000),
	VK_PIPELINE_CREATE_2_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x00400000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x01000000),
	VK_PIPELINE_CREATE_2_COLOR_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x02000000),
	VK_PIPELINE_CREATE_2_DEPTH_STENCIL_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x04000000),
	VK_PIPELINE_CREATE_2_NO_PROTECTED_ACCESS_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x08000000),
	VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x40000000),
	VK_PIPELINE_CREATE_2_RAY_TRACING_DISPLACEMENT_MICROMAP_BIT_NV = ffi.new('VkPipelineCreateFlagBits2KHR', 0x10000000),
	VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT = ffi.new('VkPipelineCreateFlagBits2KHR', 0x20000000),
	VK_BUFFER_USAGE_2_TRANSFER_SRC_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000001),
	VK_BUFFER_USAGE_2_TRANSFER_DST_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000002),
	VK_BUFFER_USAGE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000004),
	VK_BUFFER_USAGE_2_STORAGE_TEXEL_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000008),
	VK_BUFFER_USAGE_2_UNIFORM_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000010),
	VK_BUFFER_USAGE_2_STORAGE_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000020),
	VK_BUFFER_USAGE_2_INDEX_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000040),
	VK_BUFFER_USAGE_2_VERTEX_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000080),
	VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000100),
	VK_BUFFER_USAGE_2_EXECUTION_GRAPH_SCRATCH_BIT_AMDX = ffi.new('VkBufferUsageFlagBits2KHR', 0x02000000),
	VK_BUFFER_USAGE_2_CONDITIONAL_RENDERING_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000200),
	VK_BUFFER_USAGE_2_SHADER_BINDING_TABLE_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000400),
	VK_BUFFER_USAGE_2_RAY_TRACING_BIT_NV = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000400),
	VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00000800),
	VK_BUFFER_USAGE_2_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00001000),
	VK_BUFFER_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00002000),
	VK_BUFFER_USAGE_2_VIDEO_DECODE_DST_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00004000),
	VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00020000),
	VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00080000),
	VK_BUFFER_USAGE_2_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR = ffi.new('VkBufferUsageFlagBits2KHR', 0x00100000),
	VK_BUFFER_USAGE_2_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00200000),
	VK_BUFFER_USAGE_2_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00400000),
	VK_BUFFER_USAGE_2_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x04000000),
	VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x00800000),
	VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT = ffi.new('VkBufferUsageFlagBits2KHR', 0x01000000),
