...
/* +++++ BEGIN C:/Program Files (x86)/Windows Kits/10/include/10.0.22621.0/shared/sdkddkver.h */
/* #pragma warning(push) */
/* #pragma warning(disable:4668)  */
/* #pragma warning(disable:4001)  */
enum { NTDDI_WIN4 = 67108864 };
enum { NTDDI_WIN2K = 83886080 };
enum { NTDDI_WIN2KSP1 = 83886336 };
enum { NTDDI_WIN2KSP2 = 83886592 };
enum { NTDDI_WIN2KSP3 = 83886848 };
enum { NTDDI_WIN2KSP4 = 83887104 };
enum { NTDDI_WINXP = 83951616 };
enum { NTDDI_WINXPSP1 = 83951872 };
enum { NTDDI_WINXPSP2 = 83952128 };
enum { NTDDI_WINXPSP3 = 83952384 };
enum { NTDDI_WINXPSP4 = 83952640 };
enum { NTDDI_WS03 = 84017152 };
enum { NTDDI_WS03SP1 = 84017408 };
enum { NTDDI_WS03SP2 = 84017664 };
enum { NTDDI_WS03SP3 = 84017920 };
enum { NTDDI_WS03SP4 = 84018176 };
enum { NTDDI_WIN6 = 100663296 };
enum { NTDDI_WIN6SP1 = 100663552 };
enum { NTDDI_WIN6SP2 = 100663808 };
enum { NTDDI_WIN6SP3 = 100664064 };
enum { NTDDI_WIN6SP4 = 100664320 };
enum { NTDDI_VISTA = 100663296 };
enum { NTDDI_VISTASP1 = 100663552 };
enum { NTDDI_VISTASP2 = 100663808 };
enum { NTDDI_VISTASP3 = 100664064 };
enum { NTDDI_VISTASP4 = 100664320 };
enum { NTDDI_LONGHORN = 100663296 };
enum { NTDDI_WS08 = 100663552 };
enum { NTDDI_WS08SP2 = 100663808 };
enum { NTDDI_WS08SP3 = 100664064 };
enum { NTDDI_WS08SP4 = 100664320 };
enum { NTDDI_WIN7 = 100728832 };
enum { NTDDI_WIN8 = 100794368 };
enum { NTDDI_WINBLUE = 100859904 };
enum { NTDDI_WINTHRESHOLD = 167772160 };
enum { NTDDI_WIN10 = 167772160 };
enum { NTDDI_WIN10_TH2 = 167772161 };
enum { NTDDI_WIN10_RS1 = 167772162 };
enum { NTDDI_WIN10_RS2 = 167772163 };
enum { NTDDI_WIN10_RS3 = 167772164 };
enum { NTDDI_WIN10_RS4 = 167772165 };
enum { NTDDI_WIN10_RS5 = 167772166 };
enum { NTDDI_WIN10_19H1 = 167772167 };
enum { NTDDI_WIN10_VB = 167772168 };
enum { NTDDI_WIN10_MN = 167772169 };
enum { NTDDI_WIN10_FE = 167772170 };
enum { NTDDI_WIN10_CO = 167772171 };
enum { NTDDI_WIN10_NI = 167772172 };
enum { WDK_NTDDI_VERSION = 167772172 };
enum { OSVERSION_MASK = 4294901760 };
enum { SPVERSION_MASK = 65280 };
enum { SUBVERSION_MASK = 255 };
enum { NTDDI_VERSION = 167772172 };
enum { WINVER = 2560 };
/* #pragma warning(pop) */
/* +++++ END   C:/Program Files (x86)/Windows Kits/10/include/10.0.22621.0/shared/sdkddkver.h */
enum { SDL_WINDOWS7_SDK = 1 };
enum { SDL_WINDOWS8_SDK = 1 };
enum { SDL_WINDOWS10_SDK = 1 };
...
extern void __cdecl SDL_qsort(void *base, size_t nmemb, size_t size, int (*compare) (const void *, const void *));
...
extern double __cdecl SDL_atan2(double x, double y);
extern float __cdecl SDL_atan2f(float x, float y);
...
extern int __cdecl SDL_RegisterApp(char *name, Uint32 style, void *hInst);
...
extern int __cdecl SDL_SemWaitTimeout(SDL_sem * sem, Uint32 ms);
...
/* ++++++ BEGIN C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.39.33519/include/vcruntime_startup.h */
/* ++++++ END   C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.39.33519/include/vcruntime_startup.h */
...
extern SDL_Thread *__cdecl SDL_CreateThreadWithStackSize(int (__cdecl * fn) (void *), const char *name, const size_t stacksize, void *data, pfnSDL_CurrentBeginThread pfnBeginThread, pfnSDL_CurrentEndThread pfnEndThread);
...
/* +++ BEGIN C:/Users/Chris/include/SDL2/SDL_stdinc.h */
/* +++ END   C:/Users/Chris/include/SDL2/SDL_stdinc.h */
/* +++ BEGIN C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.39.33519/include/intrin.h */
/* +++ END   C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.39.33519/include/intrin.h */
/* +++ BEGIN C:/Users/Chris/include/SDL2/begin_code.h */
/* #pragma warning(disable: 4103) */
/* #pragma pack(push,8) */
/* +++ END   C:/Users/Chris/include/SDL2/begin_code.h */
...
extern void __cdecl SDL_SetTextInputRect(SDL_Rect *rect);
...
typedef enum { SDL_CONTROLLER_TYPE_UNKNOWN = 0, SDL_CONTROLLER_TYPE_XBOX360, SDL_CONTROLLER_TYPE_XBOXONE, SDL_CONTROLLER_TYPE_PS3, SDL_CONTROLLER_TYPE_PS4, SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO, SDL_CONTROLLER_TYPE_VIRTUAL, SDL_CONTROLLER_TYPE_PS5 } SDL_GameControllerType;
...
extern SDL_GameControllerAxis __cdecl SDL_GameControllerGetAxisFromString(const char *pchString);
...
extern SDL_GameControllerButton __cdecl SDL_GameControllerGetButtonFromString(const char *pchString);
...
/* #define SDL_HINT_JOYSTICK_HIDAPI_CORRELATE_XINPUT   "SDL_JOYSTICK_HIDAPI_CORRELATE_XINPUT" ### string, not number "\"SDL_JOYSTICK_HIDAPI_CORRELATE_XINPUT\"" */
...
extern SDL_PowerState __cdecl SDL_GetPowerInfo(int *secs, int *pct);
/* +++ BEGIN C:/Users/Chris/include/SDL2/close_code.h */
/* #pragma pack(pop) */
/* +++ END   C:/Users/Chris/include/SDL2/close_code.h */
...
enum { SDL_PATCHLEVEL = 14 };
enum { SDL_COMPILEDVERSION = 2014 };
