...
ffi.cdef[[
/* + BEGIN C:/Users/Chris/include/fitsio.h */
/* #define CFITSIO_VERSION 3.49 ### string, not number "3.49" */
enum { CFITSIO_MINOR = 49 };
enum { CFITSIO_MAJOR = 3 };
...
/* ++ BEGIN C:/Users/Chris/include/longnam.h */
...
/* ++ END   C:/Users/Chris/include/longnam.h */
enum { NIOBUF = 40 };
enum { IOBUFLEN = 2880 };
...
int ffghof(fitsfile *fptr, long long *headstart, long long *datastart, long long *dataend, int *status);
...
/* + END   C:/Users/Chris/include/fitsio.h */
]]
