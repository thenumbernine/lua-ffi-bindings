{
	...
	macros={
		...
		FILENAME_MAX="4096",
		FILL_BYTE="((signed char)-127)",
		FILL_CHAR="((char)0)",
		FILL_DOUBLE="(9.9692099683868690e+36)",
		FILL_FLOAT="(9.9692099683868690e+36f)",
		...
		NC_FILL_INT64="((long long)-9223372036854775806LL)",
		NC_FILL_SHORT="((short)-32767)",
		NC_FILL_STRING="((char *)\"\")",
		NC_FILL_UBYTE="(255)",
		NC_FILL_UINT="(4294967295U)",
		NC_FILL_UINT64="((unsigned long long)18446744073709551614ULL)",
		...
		NC_FORMAT_ALL="(0x0200|0x0020|0x0100|0x1000|0x0040|0x0080)",
		NC_FORMAT_CDF5="(5)",
		NC_FORMAT_CLASSIC="(1)",
		NC_FORMAT_DAP2="(5)",
		NC_FORMAT_DAP4="(6)",
		...
		NC_MAX_INT64="(9223372036854775807LL)",
		...
		NC_MIN_DOUBLE="(-1.7976931348623157e+308)",
		NC_MIN_FLOAT="(-3.402823466e+38f)",
		NC_MIN_INT="(-2147483647 - 1)",
		NC_MIN_INT64="(-9223372036854775807LL-1)",
		NC_MIN_SHORT="(-32767 - 1)",
		NC_MMAP="0x0010",
		NC_MPIIO="0x2000",
		NC_MPIPOSIX="0x2000",
		NC_NAT="0",
		...
		linux="1",
		ncvarcpy={
			def="ncvarcopy((ncid_in), (varid), (ncid_out))",
			params={"ncid_in", "varid", "ncid_out"}
		},
		offsetof={
			def="__builtin_offsetof (TYPE, MEMBER)",
			params={"TYPE", "MEMBER"}
		},
		setjmp={
			def="_setjmp (env)",
