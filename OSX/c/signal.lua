...
int sigaltstack(const stack_t * restrict, stack_t * restrict) __asm( "sigaltstack" ) __attribute__((availability(watchos,unavailable))) __attribute__((availability(tvos,unavailable)));
