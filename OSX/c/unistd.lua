...
int setuid(uid_t);
unsigned int
  sleep(unsigned int) __asm("_sleep" );
long sysconf(int);
pid_t tcgetpgrp(int);
int tcsetpgrp(int, pid_t);
char *ttyname(int);
int ttyname_r(int, char *, size_t) __asm("_ttyname_r" );
int unlink(const char *);
ssize_t write(int __fd, const void * __buf, size_t __nbyte) __asm("_write" );
size_t confstr(int, char *, size_t) __asm("_confstr" );
int getopt(int, char * const [], const char *) __asm("_getopt" );
extern char *optarg;
...
void encrypt(char *, int) __asm("_encrypt" );
int fchdir(int);
long gethostid(void);
pid_t getpgid(pid_t);
pid_t getsid(pid_t);
...
char *getwd(char *) ;
int lchown(const char *, uid_t, gid_t) __asm("_lchown" );
int lockf(int, int, off_t) __asm("_lockf" );
int nice(int) __asm("_nice" );
ssize_t pread(int __fd, void * __buf, size_t __nbyte, off_t __offset) __asm("_pread" );
ssize_t pwrite(int __fd, const void * __buf, size_t __nbyte, off_t __offset) __asm("_pwrite" );
__attribute__((__deprecated__)) __attribute__((availability(watchos,unavailable))) __attribute__((availability(tvos,unavailable)))
void *sbrk(int);
pid_t setpgrp(void) __asm("_setpgrp" );
int setregid(gid_t, gid_t) __asm("_setregid" );
int setreuid(uid_t, uid_t) __asm("_setreuid" );
void swab(const void * restrict, void * restrict, ssize_t);
void sync(void);
int truncate(const char *, off_t);
useconds_t ualarm(useconds_t, useconds_t);
int usleep(useconds_t) __asm("_usleep" );
__attribute__((__deprecated__("Use posix_spawn or fork")))
pid_t vfork(void) __attribute__((availability(watchos,unavailable))) __attribute__((availability(tvos,unavailable)));
int fsync(int) __asm("_fsync" );
...
void *setmode(const char *) __asm("_setmode" );
int setrgid(gid_t);
int setruid(uid_t);
...
int getattrlist(const char*,void*,void*,size_t,unsigned int) __asm("_getattrlist" );
int setattrlist(const char*,void*,void*,size_t,unsigned int) __asm("_setattrlist" );
