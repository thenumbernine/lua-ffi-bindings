...
int chmod(const char *, mode_t) __asm("_chmod" );
int fchmod(int, mode_t) __asm("_fchmod" );
int fstat(int, struct stat *) __asm("_fstat$INODE64");
int lstat(const char *, struct stat *) __asm("_lstat$INODE64");
...
int fstatat(int, const char *, struct stat *, int) __asm("_fstatat$INODE64") __attribute__((availability(macosx,introduced=10.10)));
...
int fstatx_np(int, struct stat *, filesec_t) __asm("_fstatx_np$INODE64");
...
int lstatx_np(const char *, struct stat *, filesec_t) __asm("_lstatx_np$INODE64");
int mkdirx_np(const char *, filesec_t);
int mkfifox_np(const char *, filesec_t);
int statx_np(const char *, struct stat *, filesec_t) __asm("_statx_np$INODE64");
