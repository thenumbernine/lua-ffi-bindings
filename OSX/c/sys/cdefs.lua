...
/* #define __DARWIN_ALIAS (sym) __asm( __STRING(sym) __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_ALIAS_C (sym) __asm( __STRING(sym) __DARWIN_SUF_NON_CANCELABLE __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_ALIAS_I (sym) __asm( __STRING(sym) __DARWIN_SUF_64_BIT_INO_T __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_NOCANCEL (sym) __asm( __STRING(sym) __DARWIN_SUF_NON_CANCELABLE) ### define is not number */
/* #define __DARWIN_INODE64 (sym) __asm( __STRING(sym) __DARWIN_SUF_64_BIT_INO_T) ### define is not number */
/* #define __DARWIN_1050 (sym) __asm( __STRING(sym) __DARWIN_SUF_1050) ### define is not number */
/* #define __DARWIN_1050ALIAS (sym) __asm( __STRING(sym) __DARWIN_SUF_1050 __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_1050ALIAS_C (sym) __asm( __STRING(sym) __DARWIN_SUF_1050 __DARWIN_SUF_NON_CANCELABLE __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_1050ALIAS_I (sym) __asm( __STRING(sym) __DARWIN_SUF_1050 __DARWIN_SUF_64_BIT_INO_T __DARWIN_SUF_UNIX03) ### define is not number */
/* #define __DARWIN_1050INODE64 (sym) __asm( __STRING(sym) __DARWIN_SUF_1050 __DARWIN_SUF_64_BIT_INO_T) ### define is not number */
/* #define __DARWIN_EXTSN (sym) __asm( __STRING(sym) __DARWIN_SUF_EXTSN) ### define is not number */
/* #define __DARWIN_EXTSN_C (sym) __asm( __STRING(sym) __DARWIN_SUF_EXTSN __DARWIN_SUF_NON_CANCELABLE) ### define is not number */
