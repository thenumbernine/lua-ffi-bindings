...
ffi.cdef[[
/* + BEGIN /usr/local/include/GL/gl.h */
...
enum { GL_ALL_ATTRIB_BITS = 4294967295 };
...
enum { GL_ALL_CLIENT_ATTRIB_BITS = 4294967295 };
...
__attribute__((visibility("default"))) void glOrtho( GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val );
__attribute__((visibility("default"))) void glFrustum( GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near_val, GLdouble far_val );
...
__attribute__((visibility("default"))) void glRotated( GLdouble angle, GLdouble x, GLdouble y, GLdouble z );
...
__attribute__((visibility("default"))) void glCallLists( GLsizei n, GLenum type, const GLvoid *lists );
...
__attribute__((visibility("default"))) void glColor4b( GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha );
__attribute__((visibility("default"))) void glColor4d( GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha );
__attribute__((visibility("default"))) void glColor4f( GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha );
__attribute__((visibility("default"))) void glColor4i( GLint red, GLint green, GLint blue, GLint alpha );
__attribute__((visibility("default"))) void glColor4s( GLshort red, GLshort green, GLshort blue, GLshort alpha );
__attribute__((visibility("default"))) void glColor4ub( GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha );
__attribute__((visibility("default"))) void glColor4ui( GLuint red, GLuint green, GLuint blue, GLuint alpha );
__attribute__((visibility("default"))) void glColor4us( GLushort red, GLushort green, GLushort blue, GLushort alpha );
...
__attribute__((visibility("default"))) void glVertexPointer( GLint size, GLenum type, GLsizei stride, const GLvoid *ptr );
__attribute__((visibility("default"))) void glNormalPointer( GLenum type, GLsizei stride, const GLvoid *ptr );
__attribute__((visibility("default"))) void glColorPointer( GLint size, GLenum type, GLsizei stride, const GLvoid *ptr );
__attribute__((visibility("default"))) void glIndexPointer( GLenum type, GLsizei stride, const GLvoid *ptr );
__attribute__((visibility("default"))) void glTexCoordPointer( GLint size, GLenum type, GLsizei stride, const GLvoid *ptr );
...
__attribute__((visibility("default"))) void glInterleavedArrays( GLenum format, GLsizei stride, const GLvoid *pointer );
...
__attribute__((visibility("default"))) void glLightiv( GLenum light, GLenum pname, const GLint *params );
__attribute__((visibility("default"))) void glGetLightfv( GLenum light, GLenum pname, GLfloat *params );
__attribute__((visibility("default"))) void glGetLightiv( GLenum light, GLenum pname, GLint *params );
...
__attribute__((visibility("default"))) void glPixelMapfv( GLenum map, GLsizei mapsize, const GLfloat *values );
__attribute__((visibility("default"))) void glPixelMapuiv( GLenum map, GLsizei mapsize, const GLuint *values );
__attribute__((visibility("default"))) void glPixelMapusv( GLenum map, GLsizei mapsize, const GLushort *values );
...
__attribute__((visibility("default"))) void glBitmap( GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap );
...
__attribute__((visibility("default"))) void glDrawPixels( GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels );
__attribute__((visibility("default"))) void glCopyPixels( GLint x, GLint y, GLsizei width, GLsizei height, GLenum type );
...
__attribute__((visibility("default"))) void glTexImage1D( GLenum target, GLint level, GLint internalFormat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels );
...
__attribute__((visibility("default"))) void glGetTexImage( GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels );
...
__attribute__((visibility("default"))) void glPrioritizeTextures( GLsizei n, const GLuint *textures, const GLclampf *priorities );
__attribute__((visibility("default"))) GLboolean glAreTexturesResident( GLsizei n, const GLuint *textures, GLboolean *residences );
__attribute__((visibility("default"))) GLboolean glIsTexture( GLuint texture );
__attribute__((visibility("default"))) void glTexSubImage1D( GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels );
...
__attribute__((visibility("default"))) void glCopyTexImage1D( GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border );
...
__attribute__((visibility("default"))) void glCopyTexSubImage1D( GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width );
...
__attribute__((visibility("default"))) void glMap1d( GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points );
__attribute__((visibility("default"))) void glMap1f( GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points );
__attribute__((visibility("default"))) void glMap2d( GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points );
__attribute__((visibility("default"))) void glMap2f( GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points );
...
__attribute__((visibility("default"))) void glMapGrid2d( GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2 );
__attribute__((visibility("default"))) void glMapGrid2f( GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2 );
...
__attribute__((visibility("default"))) void glGetMinmax( GLenum target, GLboolean reset, GLenum format, GLenum types, GLvoid *values );
...
__attribute__((visibility("default"))) void glMultiDrawArrays (GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount);
__attribute__((visibility("default"))) void glMultiDrawElements (GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei drawcount);
...
__attribute__((visibility("default"))) void glFogCoordPointer (GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glSecondaryColorPointer (GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glGetBufferSubData (GLenum target, GLintptr offset, GLsizeiptr size, void *data);
__attribute__((visibility("default"))) void * glMapBuffer (GLenum target, GLenum access);
...
__attribute__((visibility("default"))) void glMultiDrawElementsBaseVertex (GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei drawcount, const GLint *basevertex);
...
__attribute__((visibility("default"))) void glGetSynciv (GLsync sync, GLenum pname, GLsizei count, GLsizei *length, GLint *values);
...
__attribute__((visibility("default"))) void glTexImage2DMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
__attribute__((visibility("default"))) void glTexImage3DMultisample (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
...
__attribute__((visibility("default"))) void glDepthRangeArrayv (GLuint first, GLsizei count, const GLdouble *v);
__attribute__((visibility("default"))) void glDepthRangeIndexed (GLuint index, GLdouble n, GLdouble f);
...
__attribute__((visibility("default"))) void glDrawArraysInstancedBaseInstance (GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance);
__attribute__((visibility("default"))) void glDrawElementsInstancedBaseInstance (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLuint baseinstance);
__attribute__((visibility("default"))) void glDrawElementsInstancedBaseVertexBaseInstance (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance);
__attribute__((visibility("default"))) void glGetInternalformativ (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params);
...
__attribute__((visibility("default"))) void glDrawTransformFeedbackInstanced (GLenum mode, GLuint id, GLsizei instancecount);
__attribute__((visibility("default"))) void glDrawTransformFeedbackStreamInstanced (GLenum mode, GLuint id, GLuint stream, GLsizei instancecount);
...
__attribute__((visibility("default"))) void glClearBufferData (GLenum target, GLenum internalformat, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glClearBufferSubData (GLenum target, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);
...
__attribute__((visibility("default"))) void glGetInternalformati64v (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64 *params);
__attribute__((visibility("default"))) void glInvalidateTexSubImage (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth);
__attribute__((visibility("default"))) void glInvalidateTexImage (GLuint texture, GLint level);
__attribute__((visibility("default"))) void glInvalidateBufferSubData (GLuint buffer, GLintptr offset, GLsizeiptr length);
__attribute__((visibility("default"))) void glInvalidateBufferData (GLuint buffer);
...
__attribute__((visibility("default"))) void glMultiDrawArraysIndirect (GLenum mode, const void *indirect, GLsizei drawcount, GLsizei stride);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirect (GLenum mode, GLenum type, const void *indirect, GLsizei drawcount, GLsizei stride);
...
__attribute__((visibility("default"))) void glGetProgramResourceiv (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei count, GLsizei *length, GLint *params);
...
__attribute__((visibility("default"))) GLint glGetProgramResourceLocationIndex (GLuint program, GLenum programInterface, const GLchar *name);
__attribute__((visibility("default"))) void glShaderStorageBlockBinding (GLuint program, GLuint storageBlockIndex, GLuint storageBlockBinding);
...
__attribute__((visibility("default"))) void glTextureView (GLuint texture, GLenum target, GLuint origtexture, GLenum internalformat, GLuint minlevel, GLuint numlevels, GLuint minlayer, GLuint numlayers);
...
__attribute__((visibility("default"))) void glVertexAttribLFormat (GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
...
__attribute__((visibility("default"))) void glClearTexImage (GLuint texture, GLint level, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glClearTexSubImage (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glBindBuffersBase (GLenum target, GLuint first, GLsizei count, const GLuint *buffers);
__attribute__((visibility("default"))) void glBindBuffersRange (GLenum target, GLuint first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizeiptr *sizes);
__attribute__((visibility("default"))) void glBindTextures (GLuint first, GLsizei count, const GLuint *textures);
__attribute__((visibility("default"))) void glBindSamplers (GLuint first, GLsizei count, const GLuint *samplers);
__attribute__((visibility("default"))) void glBindImageTextures (GLuint first, GLsizei count, const GLuint *textures);
__attribute__((visibility("default"))) void glBindVertexBuffers (GLuint first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizei *strides);
...
__attribute__((visibility("default"))) void glClipControl (GLenum origin, GLenum depth);
__attribute__((visibility("default"))) void glCreateTransformFeedbacks (GLsizei n, GLuint *ids);
__attribute__((visibility("default"))) void glTransformFeedbackBufferBase (GLuint xfb, GLuint index, GLuint buffer);
__attribute__((visibility("default"))) void glTransformFeedbackBufferRange (GLuint xfb, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
__attribute__((visibility("default"))) void glGetTransformFeedbackiv (GLuint xfb, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetTransformFeedbacki_v (GLuint xfb, GLenum pname, GLuint index, GLint *param);
__attribute__((visibility("default"))) void glGetTransformFeedbacki64_v (GLuint xfb, GLenum pname, GLuint index, GLint64 *param);
__attribute__((visibility("default"))) void glCreateBuffers (GLsizei n, GLuint *buffers);
__attribute__((visibility("default"))) void glNamedBufferStorage (GLuint buffer, GLsizeiptr size, const void *data, GLbitfield flags);
__attribute__((visibility("default"))) void glNamedBufferData (GLuint buffer, GLsizeiptr size, const void *data, GLenum usage);
__attribute__((visibility("default"))) void glNamedBufferSubData (GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);
__attribute__((visibility("default"))) void glCopyNamedBufferSubData (GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
__attribute__((visibility("default"))) void glClearNamedBufferData (GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glClearNamedBufferSubData (GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void * glMapNamedBuffer (GLuint buffer, GLenum access);
__attribute__((visibility("default"))) void * glMapNamedBufferRange (GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
__attribute__((visibility("default"))) GLboolean glUnmapNamedBuffer (GLuint buffer);
__attribute__((visibility("default"))) void glFlushMappedNamedBufferRange (GLuint buffer, GLintptr offset, GLsizeiptr length);
__attribute__((visibility("default"))) void glGetNamedBufferParameteriv (GLuint buffer, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glGetNamedBufferParameteri64v (GLuint buffer, GLenum pname, GLint64 *params);
__attribute__((visibility("default"))) void glGetNamedBufferPointerv (GLuint buffer, GLenum pname, void **params);
__attribute__((visibility("default"))) void glGetNamedBufferSubData (GLuint buffer, GLintptr offset, GLsizeiptr size, void *data);
__attribute__((visibility("default"))) void glCreateFramebuffers (GLsizei n, GLuint *framebuffers);
__attribute__((visibility("default"))) void glNamedFramebufferRenderbuffer (GLuint framebuffer, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
__attribute__((visibility("default"))) void glNamedFramebufferParameteri (GLuint framebuffer, GLenum pname, GLint param);
__attribute__((visibility("default"))) void glNamedFramebufferTexture (GLuint framebuffer, GLenum attachment, GLuint texture, GLint level);
__attribute__((visibility("default"))) void glNamedFramebufferTextureLayer (GLuint framebuffer, GLenum attachment, GLuint texture, GLint level, GLint layer);
__attribute__((visibility("default"))) void glNamedFramebufferDrawBuffer (GLuint framebuffer, GLenum buf);
__attribute__((visibility("default"))) void glNamedFramebufferDrawBuffers (GLuint framebuffer, GLsizei n, const GLenum *bufs);
__attribute__((visibility("default"))) void glNamedFramebufferReadBuffer (GLuint framebuffer, GLenum src);
__attribute__((visibility("default"))) void glInvalidateNamedFramebufferData (GLuint framebuffer, GLsizei numAttachments, const GLenum *attachments);
__attribute__((visibility("default"))) void glInvalidateNamedFramebufferSubData (GLuint framebuffer, GLsizei numAttachments, const GLenum *attachments, GLint x, GLint y, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glClearNamedFramebufferiv (GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLint *value);
__attribute__((visibility("default"))) void glClearNamedFramebufferuiv (GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLuint *value);
__attribute__((visibility("default"))) void glClearNamedFramebufferfv (GLuint framebuffer, GLenum buffer, GLint drawbuffer, const GLfloat *value);
__attribute__((visibility("default"))) void glClearNamedFramebufferfi (GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
__attribute__((visibility("default"))) void glBlitNamedFramebuffer (GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
__attribute__((visibility("default"))) GLenum glCheckNamedFramebufferStatus (GLuint framebuffer, GLenum target);
__attribute__((visibility("default"))) void glGetNamedFramebufferParameteriv (GLuint framebuffer, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetNamedFramebufferAttachmentParameteriv (GLuint framebuffer, GLenum attachment, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glCreateRenderbuffers (GLsizei n, GLuint *renderbuffers);
__attribute__((visibility("default"))) void glNamedRenderbufferStorage (GLuint renderbuffer, GLenum internalformat, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glNamedRenderbufferStorageMultisample (GLuint renderbuffer, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glGetNamedRenderbufferParameteriv (GLuint renderbuffer, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glCreateTextures (GLenum target, GLsizei n, GLuint *textures);
__attribute__((visibility("default"))) void glTextureBuffer (GLuint texture, GLenum internalformat, GLuint buffer);
__attribute__((visibility("default"))) void glTextureBufferRange (GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
__attribute__((visibility("default"))) void glTextureStorage1D (GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width);
__attribute__((visibility("default"))) void glTextureStorage2D (GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glTextureStorage3D (GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
__attribute__((visibility("default"))) void glTextureStorage2DMultisample (GLuint texture, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
__attribute__((visibility("default"))) void glTextureStorage3DMultisample (GLuint texture, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
__attribute__((visibility("default"))) void glTextureSubImage1D (GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureSubImage2D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureSubImage3D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glCompressedTextureSubImage1D (GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTextureSubImage2D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTextureSubImage3D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCopyTextureSubImage1D (GLuint texture, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
__attribute__((visibility("default"))) void glCopyTextureSubImage2D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glCopyTextureSubImage3D (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glTextureParameterf (GLuint texture, GLenum pname, GLfloat param);
__attribute__((visibility("default"))) void glTextureParameterfv (GLuint texture, GLenum pname, const GLfloat *param);
__attribute__((visibility("default"))) void glTextureParameteri (GLuint texture, GLenum pname, GLint param);
__attribute__((visibility("default"))) void glTextureParameterIiv (GLuint texture, GLenum pname, const GLint *params);
__attribute__((visibility("default"))) void glTextureParameterIuiv (GLuint texture, GLenum pname, const GLuint *params);
__attribute__((visibility("default"))) void glTextureParameteriv (GLuint texture, GLenum pname, const GLint *param);
__attribute__((visibility("default"))) void glGenerateTextureMipmap (GLuint texture);
__attribute__((visibility("default"))) void glBindTextureUnit (GLuint unit, GLuint texture);
__attribute__((visibility("default"))) void glGetTextureImage (GLuint texture, GLint level, GLenum format, GLenum type, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) void glGetCompressedTextureImage (GLuint texture, GLint level, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) void glGetTextureLevelParameterfv (GLuint texture, GLint level, GLenum pname, GLfloat *params);
__attribute__((visibility("default"))) void glGetTextureLevelParameteriv (GLuint texture, GLint level, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glGetTextureParameterfv (GLuint texture, GLenum pname, GLfloat *params);
__attribute__((visibility("default"))) void glGetTextureParameterIiv (GLuint texture, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glGetTextureParameterIuiv (GLuint texture, GLenum pname, GLuint *params);
__attribute__((visibility("default"))) void glGetTextureParameteriv (GLuint texture, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glCreateVertexArrays (GLsizei n, GLuint *arrays);
__attribute__((visibility("default"))) void glDisableVertexArrayAttrib (GLuint vaobj, GLuint index);
__attribute__((visibility("default"))) void glEnableVertexArrayAttrib (GLuint vaobj, GLuint index);
__attribute__((visibility("default"))) void glVertexArrayElementBuffer (GLuint vaobj, GLuint buffer);
__attribute__((visibility("default"))) void glVertexArrayVertexBuffer (GLuint vaobj, GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
__attribute__((visibility("default"))) void glVertexArrayVertexBuffers (GLuint vaobj, GLuint first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizei *strides);
__attribute__((visibility("default"))) void glVertexArrayAttribBinding (GLuint vaobj, GLuint attribindex, GLuint bindingindex);
__attribute__((visibility("default"))) void glVertexArrayAttribFormat (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayAttribIFormat (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayAttribLFormat (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayBindingDivisor (GLuint vaobj, GLuint bindingindex, GLuint divisor);
__attribute__((visibility("default"))) void glGetVertexArrayiv (GLuint vaobj, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetVertexArrayIndexediv (GLuint vaobj, GLuint index, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetVertexArrayIndexed64iv (GLuint vaobj, GLuint index, GLenum pname, GLint64 *param);
__attribute__((visibility("default"))) void glCreateSamplers (GLsizei n, GLuint *samplers);
__attribute__((visibility("default"))) void glCreateProgramPipelines (GLsizei n, GLuint *pipelines);
__attribute__((visibility("default"))) void glCreateQueries (GLenum target, GLsizei n, GLuint *ids);
__attribute__((visibility("default"))) void glGetQueryBufferObjecti64v (GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
__attribute__((visibility("default"))) void glGetQueryBufferObjectiv (GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
__attribute__((visibility("default"))) void glGetQueryBufferObjectui64v (GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
__attribute__((visibility("default"))) void glGetQueryBufferObjectuiv (GLuint id, GLuint buffer, GLenum pname, GLintptr offset);
__attribute__((visibility("default"))) void glMemoryBarrierByRegion (GLbitfield barriers);
__attribute__((visibility("default"))) void glGetTextureSubImage (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) void glGetCompressedTextureSubImage (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) GLenum glGetGraphicsResetStatus (void);
__attribute__((visibility("default"))) void glGetnCompressedTexImage (GLenum target, GLint lod, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) void glGetnTexImage (GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, void *pixels);
__attribute__((visibility("default"))) void glGetnUniformdv (GLuint program, GLint location, GLsizei bufSize, GLdouble *params);
...
__attribute__((visibility("default"))) void glGetnMapdv (GLenum target, GLenum query, GLsizei bufSize, GLdouble *v);
__attribute__((visibility("default"))) void glGetnMapfv (GLenum target, GLenum query, GLsizei bufSize, GLfloat *v);
__attribute__((visibility("default"))) void glGetnMapiv (GLenum target, GLenum query, GLsizei bufSize, GLint *v);
__attribute__((visibility("default"))) void glGetnPixelMapfv (GLenum map, GLsizei bufSize, GLfloat *values);
__attribute__((visibility("default"))) void glGetnPixelMapuiv (GLenum map, GLsizei bufSize, GLuint *values);
__attribute__((visibility("default"))) void glGetnPixelMapusv (GLenum map, GLsizei bufSize, GLushort *values);
__attribute__((visibility("default"))) void glGetnPolygonStipple (GLsizei bufSize, GLubyte *pattern);
__attribute__((visibility("default"))) void glGetnColorTable (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void *table);
__attribute__((visibility("default"))) void glGetnConvolutionFilter (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void *image);
__attribute__((visibility("default"))) void glGetnSeparableFilter (GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, void *row, GLsizei columnBufSize, void *column, void *span);
__attribute__((visibility("default"))) void glGetnHistogram (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void *values);
__attribute__((visibility("default"))) void glGetnMinmax (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void *values);
__attribute__((visibility("default"))) void glTextureBarrier (void);
...
__attribute__((visibility("default"))) void glSpecializeShader (GLuint shader, const GLchar *pEntryPoint, GLuint numSpecializationConstants, const GLuint *pConstantIndex, const GLuint *pConstantValue);
__attribute__((visibility("default"))) void glMultiDrawArraysIndirectCount (GLenum mode, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirectCount (GLenum mode, GLenum type, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
__attribute__((visibility("default"))) void glPolygonOffsetClamp (GLfloat factor, GLfloat units, GLfloat clamp);
...
__attribute__((visibility("default"))) void glPrimitiveBoundingBoxARB (GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);
...
__attribute__((visibility("default"))) GLuint64 glGetTextureHandleARB (GLuint texture);
__attribute__((visibility("default"))) GLuint64 glGetTextureSamplerHandleARB (GLuint texture, GLuint sampler);
__attribute__((visibility("default"))) void glMakeTextureHandleResidentARB (GLuint64 handle);
__attribute__((visibility("default"))) void glMakeTextureHandleNonResidentARB (GLuint64 handle);
__attribute__((visibility("default"))) GLuint64 glGetImageHandleARB (GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format);
__attribute__((visibility("default"))) void glMakeImageHandleResidentARB (GLuint64 handle, GLenum access);
__attribute__((visibility("default"))) void glMakeImageHandleNonResidentARB (GLuint64 handle);
__attribute__((visibility("default"))) void glUniformHandleui64ARB (GLint location, GLuint64 value);
__attribute__((visibility("default"))) void glUniformHandleui64vARB (GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glProgramUniformHandleui64ARB (GLuint program, GLint location, GLuint64 value);
__attribute__((visibility("default"))) void glProgramUniformHandleui64vARB (GLuint program, GLint location, GLsizei count, const GLuint64 *values);
__attribute__((visibility("default"))) GLboolean glIsTextureHandleResidentARB (GLuint64 handle);
__attribute__((visibility("default"))) GLboolean glIsImageHandleResidentARB (GLuint64 handle);
__attribute__((visibility("default"))) void glVertexAttribL1ui64ARB (GLuint index, GLuint64EXT x);
__attribute__((visibility("default"))) void glVertexAttribL1ui64vARB (GLuint index, const GLuint64EXT *v);
__attribute__((visibility("default"))) void glGetVertexAttribLui64vARB (GLuint index, GLenum pname, GLuint64EXT *params);
...
__attribute__((visibility("default"))) void glDispatchComputeGroupSizeARB (GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z, GLuint group_size_x, GLuint group_size_y, GLuint group_size_z);
...
__attribute__((visibility("default"))) void glDebugMessageCallbackARB (GLDEBUGPROCARB callback, const void *userParam);
...
__attribute__((visibility("default"))) void glDrawElementsInstancedARB (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount);
...
__attribute__((visibility("default"))) void glProgramStringARB (GLenum target, GLenum format, GLsizei len, const void *string);
...
__attribute__((visibility("default"))) void glGetProgramStringARB (GLenum target, GLenum pname, void *string);
...
__attribute__((visibility("default"))) void glSpecializeShaderARB (GLuint shader, const GLchar *pEntryPoint, GLuint numSpecializationConstants, const GLuint *pConstantIndex, const GLuint *pConstantValue);
...
__attribute__((visibility("default"))) void glUniform1i64ARB (GLint location, GLint64 x);
__attribute__((visibility("default"))) void glUniform2i64ARB (GLint location, GLint64 x, GLint64 y);
__attribute__((visibility("default"))) void glUniform3i64ARB (GLint location, GLint64 x, GLint64 y, GLint64 z);
__attribute__((visibility("default"))) void glUniform4i64ARB (GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);
__attribute__((visibility("default"))) void glUniform1i64vARB (GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glUniform2i64vARB (GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glUniform3i64vARB (GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glUniform4i64vARB (GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glUniform1ui64ARB (GLint location, GLuint64 x);
__attribute__((visibility("default"))) void glUniform2ui64ARB (GLint location, GLuint64 x, GLuint64 y);
__attribute__((visibility("default"))) void glUniform3ui64ARB (GLint location, GLuint64 x, GLuint64 y, GLuint64 z);
__attribute__((visibility("default"))) void glUniform4ui64ARB (GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);
__attribute__((visibility("default"))) void glUniform1ui64vARB (GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glUniform2ui64vARB (GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glUniform3ui64vARB (GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glUniform4ui64vARB (GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glGetUniformi64vARB (GLuint program, GLint location, GLint64 *params);
__attribute__((visibility("default"))) void glGetUniformui64vARB (GLuint program, GLint location, GLuint64 *params);
__attribute__((visibility("default"))) void glGetnUniformi64vARB (GLuint program, GLint location, GLsizei bufSize, GLint64 *params);
__attribute__((visibility("default"))) void glGetnUniformui64vARB (GLuint program, GLint location, GLsizei bufSize, GLuint64 *params);
__attribute__((visibility("default"))) void glProgramUniform1i64ARB (GLuint program, GLint location, GLint64 x);
__attribute__((visibility("default"))) void glProgramUniform2i64ARB (GLuint program, GLint location, GLint64 x, GLint64 y);
__attribute__((visibility("default"))) void glProgramUniform3i64ARB (GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z);
__attribute__((visibility("default"))) void glProgramUniform4i64ARB (GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);
__attribute__((visibility("default"))) void glProgramUniform1i64vARB (GLuint program, GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glProgramUniform2i64vARB (GLuint program, GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glProgramUniform3i64vARB (GLuint program, GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glProgramUniform4i64vARB (GLuint program, GLint location, GLsizei count, const GLint64 *value);
__attribute__((visibility("default"))) void glProgramUniform1ui64ARB (GLuint program, GLint location, GLuint64 x);
__attribute__((visibility("default"))) void glProgramUniform2ui64ARB (GLuint program, GLint location, GLuint64 x, GLuint64 y);
__attribute__((visibility("default"))) void glProgramUniform3ui64ARB (GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z);
__attribute__((visibility("default"))) void glProgramUniform4ui64ARB (GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);
__attribute__((visibility("default"))) void glProgramUniform1ui64vARB (GLuint program, GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glProgramUniform2ui64vARB (GLuint program, GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glProgramUniform3ui64vARB (GLuint program, GLint location, GLsizei count, const GLuint64 *value);
__attribute__((visibility("default"))) void glProgramUniform4ui64vARB (GLuint program, GLint location, GLsizei count, const GLuint64 *value);
...
__attribute__((visibility("default"))) void glMultiDrawArraysIndirectCountARB (GLenum mode, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirectCountARB (GLenum mode, GLenum type, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
...
__attribute__((visibility("default"))) void glMatrixIndexPointerARB (GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glSampleCoverageARB (GLfloat value, GLboolean invert);
...
__attribute__((visibility("default"))) void glMaxShaderCompilerThreadsARB (GLuint count);
...
__attribute__((visibility("default"))) void glGetnTexImageARB (GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, void *img);
__attribute__((visibility("default"))) void glReadnPixelsARB (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, void *data);
__attribute__((visibility("default"))) void glGetnCompressedTexImageARB (GLenum target, GLint lod, GLsizei bufSize, void *img);
...
__attribute__((visibility("default"))) void glGetnColorTableARB (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void *table);
__attribute__((visibility("default"))) void glGetnConvolutionFilterARB (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void *image);
__attribute__((visibility("default"))) void glGetnSeparableFilterARB (GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, void *row, GLsizei columnBufSize, void *column, void *span);
__attribute__((visibility("default"))) void glGetnHistogramARB (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void *values);
__attribute__((visibility("default"))) void glGetnMinmaxARB (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void *values);
...
__attribute__((visibility("default"))) void glFramebufferSampleLocationsfvARB (GLenum target, GLuint start, GLsizei count, const GLfloat *v);
__attribute__((visibility("default"))) void glNamedFramebufferSampleLocationsfvARB (GLuint framebuffer, GLuint start, GLsizei count, const GLfloat *v);
__attribute__((visibility("default"))) void glEvaluateDepthValuesARB (void);
...
__attribute__((visibility("default"))) void glMinSampleShadingARB (GLfloat value);
...
__attribute__((visibility("default"))) void glCompileShaderIncludeARB (GLuint shader, GLsizei count, const GLchar *const*path, const GLint *length);
...
__attribute__((visibility("default"))) void glBufferPageCommitmentARB (GLenum target, GLintptr offset, GLsizeiptr size, GLboolean commit);
__attribute__((visibility("default"))) void glNamedBufferPageCommitmentEXT (GLuint buffer, GLintptr offset, GLsizeiptr size, GLboolean commit);
__attribute__((visibility("default"))) void glNamedBufferPageCommitmentARB (GLuint buffer, GLintptr offset, GLsizeiptr size, GLboolean commit);
...
__attribute__((visibility("default"))) void glTexPageCommitmentARB (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit);
...
__attribute__((visibility("default"))) void glCompressedTexImage3DARB (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTexImage2DARB (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTexImage1DARB (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTexSubImage3DARB (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTexSubImage2DARB (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glCompressedTexSubImage1DARB (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *data);
__attribute__((visibility("default"))) void glGetCompressedTexImageARB (GLenum target, GLint level, void *img);
...
__attribute__((visibility("default"))) void glWeightPointerARB (GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glBufferDataARB (GLenum target, GLsizeiptrARB size, const void *data, GLenum usage);
__attribute__((visibility("default"))) void glBufferSubDataARB (GLenum target, GLintptrARB offset, GLsizeiptrARB size, const void *data);
__attribute__((visibility("default"))) void glGetBufferSubDataARB (GLenum target, GLintptrARB offset, GLsizeiptrARB size, void *data);
__attribute__((visibility("default"))) void * glMapBufferARB (GLenum target, GLenum access);
...
__attribute__((visibility("default"))) void glGetBufferPointervARB (GLenum target, GLenum pname, void **params);
...
__attribute__((visibility("default"))) void glVertexAttribPointerARB (GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glGetVertexAttribPointervARB (GLuint index, GLenum pname, void **pointer);
...
__attribute__((visibility("default"))) void glDepthRangeArraydvNV (GLuint first, GLsizei count, const GLdouble *v);
__attribute__((visibility("default"))) void glDepthRangeIndexeddNV (GLuint index, GLdouble n, GLdouble f);
...
__attribute__((visibility("default"))) void glMultiTexCoord1bOES (GLenum texture, GLbyte s);
__attribute__((visibility("default"))) void glMultiTexCoord1bvOES (GLenum texture, const GLbyte *coords);
__attribute__((visibility("default"))) void glMultiTexCoord2bOES (GLenum texture, GLbyte s, GLbyte t);
__attribute__((visibility("default"))) void glMultiTexCoord2bvOES (GLenum texture, const GLbyte *coords);
__attribute__((visibility("default"))) void glMultiTexCoord3bOES (GLenum texture, GLbyte s, GLbyte t, GLbyte r);
__attribute__((visibility("default"))) void glMultiTexCoord3bvOES (GLenum texture, const GLbyte *coords);
__attribute__((visibility("default"))) void glMultiTexCoord4bOES (GLenum texture, GLbyte s, GLbyte t, GLbyte r, GLbyte q);
__attribute__((visibility("default"))) void glMultiTexCoord4bvOES (GLenum texture, const GLbyte *coords);
__attribute__((visibility("default"))) void glTexCoord1bOES (GLbyte s);
__attribute__((visibility("default"))) void glTexCoord1bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glTexCoord2bOES (GLbyte s, GLbyte t);
__attribute__((visibility("default"))) void glTexCoord2bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glTexCoord3bOES (GLbyte s, GLbyte t, GLbyte r);
__attribute__((visibility("default"))) void glTexCoord3bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glTexCoord4bOES (GLbyte s, GLbyte t, GLbyte r, GLbyte q);
__attribute__((visibility("default"))) void glTexCoord4bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glVertex2bOES (GLbyte x, GLbyte y);
__attribute__((visibility("default"))) void glVertex2bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glVertex3bOES (GLbyte x, GLbyte y, GLbyte z);
__attribute__((visibility("default"))) void glVertex3bvOES (const GLbyte *coords);
__attribute__((visibility("default"))) void glVertex4bOES (GLbyte x, GLbyte y, GLbyte z, GLbyte w);
__attribute__((visibility("default"))) void glVertex4bvOES (const GLbyte *coords);
...
__attribute__((visibility("default"))) void glAccumxOES (GLenum op, GLfixed value);
__attribute__((visibility("default"))) void glBitmapxOES (GLsizei width, GLsizei height, GLfixed xorig, GLfixed yorig, GLfixed xmove, GLfixed ymove, const GLubyte *bitmap);
__attribute__((visibility("default"))) void glBlendColorxOES (GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
__attribute__((visibility("default"))) void glClearAccumxOES (GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
__attribute__((visibility("default"))) void glColor3xOES (GLfixed red, GLfixed green, GLfixed blue);
__attribute__((visibility("default"))) void glColor3xvOES (const GLfixed *components);
__attribute__((visibility("default"))) void glColor4xvOES (const GLfixed *components);
__attribute__((visibility("default"))) void glConvolutionParameterxOES (GLenum target, GLenum pname, GLfixed param);
__attribute__((visibility("default"))) void glConvolutionParameterxvOES (GLenum target, GLenum pname, const GLfixed *params);
__attribute__((visibility("default"))) void glEvalCoord1xOES (GLfixed u);
__attribute__((visibility("default"))) void glEvalCoord1xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glEvalCoord2xOES (GLfixed u, GLfixed v);
__attribute__((visibility("default"))) void glEvalCoord2xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glFeedbackBufferxOES (GLsizei n, GLenum type, const GLfixed *buffer);
__attribute__((visibility("default"))) void glGetConvolutionParameterxvOES (GLenum target, GLenum pname, GLfixed *params);
__attribute__((visibility("default"))) void glGetHistogramParameterxvOES (GLenum target, GLenum pname, GLfixed *params);
__attribute__((visibility("default"))) void glGetLightxOES (GLenum light, GLenum pname, GLfixed *params);
__attribute__((visibility("default"))) void glGetMapxvOES (GLenum target, GLenum query, GLfixed *v);
__attribute__((visibility("default"))) void glGetMaterialxOES (GLenum face, GLenum pname, GLfixed param);
__attribute__((visibility("default"))) void glGetPixelMapxv (GLenum map, GLint size, GLfixed *values);
__attribute__((visibility("default"))) void glGetTexGenxvOES (GLenum coord, GLenum pname, GLfixed *params);
__attribute__((visibility("default"))) void glGetTexLevelParameterxvOES (GLenum target, GLint level, GLenum pname, GLfixed *params);
__attribute__((visibility("default"))) void glIndexxOES (GLfixed component);
__attribute__((visibility("default"))) void glIndexxvOES (const GLfixed *component);
__attribute__((visibility("default"))) void glLoadTransposeMatrixxOES (const GLfixed *m);
__attribute__((visibility("default"))) void glMap1xOES (GLenum target, GLfixed u1, GLfixed u2, GLint stride, GLint order, GLfixed points);
__attribute__((visibility("default"))) void glMap2xOES (GLenum target, GLfixed u1, GLfixed u2, GLint ustride, GLint uorder, GLfixed v1, GLfixed v2, GLint vstride, GLint vorder, GLfixed points);
__attribute__((visibility("default"))) void glMapGrid1xOES (GLint n, GLfixed u1, GLfixed u2);
__attribute__((visibility("default"))) void glMapGrid2xOES (GLint n, GLfixed u1, GLfixed u2, GLfixed v1, GLfixed v2);
__attribute__((visibility("default"))) void glMultTransposeMatrixxOES (const GLfixed *m);
__attribute__((visibility("default"))) void glMultiTexCoord1xOES (GLenum texture, GLfixed s);
__attribute__((visibility("default"))) void glMultiTexCoord1xvOES (GLenum texture, const GLfixed *coords);
__attribute__((visibility("default"))) void glMultiTexCoord2xOES (GLenum texture, GLfixed s, GLfixed t);
__attribute__((visibility("default"))) void glMultiTexCoord2xvOES (GLenum texture, const GLfixed *coords);
__attribute__((visibility("default"))) void glMultiTexCoord3xOES (GLenum texture, GLfixed s, GLfixed t, GLfixed r);
__attribute__((visibility("default"))) void glMultiTexCoord3xvOES (GLenum texture, const GLfixed *coords);
__attribute__((visibility("default"))) void glMultiTexCoord4xvOES (GLenum texture, const GLfixed *coords);
__attribute__((visibility("default"))) void glNormal3xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glPassThroughxOES (GLfixed token);
__attribute__((visibility("default"))) void glPixelMapx (GLenum map, GLint size, const GLfixed *values);
__attribute__((visibility("default"))) void glPixelStorex (GLenum pname, GLfixed param);
__attribute__((visibility("default"))) void glPixelTransferxOES (GLenum pname, GLfixed param);
__attribute__((visibility("default"))) void glPixelZoomxOES (GLfixed xfactor, GLfixed yfactor);
__attribute__((visibility("default"))) void glPrioritizeTexturesxOES (GLsizei n, const GLuint *textures, const GLfixed *priorities);
__attribute__((visibility("default"))) void glRasterPos2xOES (GLfixed x, GLfixed y);
__attribute__((visibility("default"))) void glRasterPos2xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glRasterPos3xOES (GLfixed x, GLfixed y, GLfixed z);
__attribute__((visibility("default"))) void glRasterPos3xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glRasterPos4xOES (GLfixed x, GLfixed y, GLfixed z, GLfixed w);
__attribute__((visibility("default"))) void glRasterPos4xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glRectxOES (GLfixed x1, GLfixed y1, GLfixed x2, GLfixed y2);
__attribute__((visibility("default"))) void glRectxvOES (const GLfixed *v1, const GLfixed *v2);
__attribute__((visibility("default"))) void glTexCoord1xOES (GLfixed s);
__attribute__((visibility("default"))) void glTexCoord1xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glTexCoord2xOES (GLfixed s, GLfixed t);
__attribute__((visibility("default"))) void glTexCoord2xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glTexCoord3xOES (GLfixed s, GLfixed t, GLfixed r);
__attribute__((visibility("default"))) void glTexCoord3xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glTexCoord4xOES (GLfixed s, GLfixed t, GLfixed r, GLfixed q);
__attribute__((visibility("default"))) void glTexCoord4xvOES (const GLfixed *coords);
...
__attribute__((visibility("default"))) void glVertex2xOES (GLfixed x);
__attribute__((visibility("default"))) void glVertex2xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glVertex3xOES (GLfixed x, GLfixed y);
__attribute__((visibility("default"))) void glVertex3xvOES (const GLfixed *coords);
__attribute__((visibility("default"))) void glVertex4xOES (GLfixed x, GLfixed y, GLfixed z);
__attribute__((visibility("default"))) void glVertex4xvOES (const GLfixed *coords);
...
__attribute__((visibility("default"))) void glDebugMessageCallbackAMD (GLDEBUGPROCAMD callback, void *userParam);
__attribute__((visibility("default"))) GLuint glGetDebugMessageLogAMD (GLuint count, GLsizei bufSize, GLenum *categories, GLenum *severities, GLuint *ids, GLsizei *lengths, GLchar *message);
...
__attribute__((visibility("default"))) void glRenderbufferStorageMultisampleAdvancedAMD (GLenum target, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glNamedRenderbufferStorageMultisampleAdvancedAMD (GLuint renderbuffer, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height);
...
__attribute__((visibility("default"))) void glFramebufferSamplePositionsfvAMD (GLenum target, GLuint numsamples, GLuint pixelindex, const GLfloat *values);
__attribute__((visibility("default"))) void glNamedFramebufferSamplePositionsfvAMD (GLuint framebuffer, GLuint numsamples, GLuint pixelindex, const GLfloat *values);
__attribute__((visibility("default"))) void glGetFramebufferParameterfvAMD (GLenum target, GLenum pname, GLuint numsamples, GLuint pixelindex, GLsizei size, GLfloat *values);
__attribute__((visibility("default"))) void glGetNamedFramebufferParameterfvAMD (GLuint framebuffer, GLenum pname, GLuint numsamples, GLuint pixelindex, GLsizei size, GLfloat *values);
...
__attribute__((visibility("default"))) void glVertexAttribParameteriAMD (GLuint index, GLenum pname, GLint param);
...
__attribute__((visibility("default"))) void glMultiDrawArraysIndirectAMD (GLenum mode, const void *indirect, GLsizei primcount, GLsizei stride);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirectAMD (GLenum mode, GLenum type, const void *indirect, GLsizei primcount, GLsizei stride);
...
__attribute__((visibility("default"))) void glQueryObjectParameteruiAMD (GLenum target, GLuint id, GLenum pname, GLuint param);
...
__attribute__((visibility("default"))) void glTexStorageSparseAMD (GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLsizei layers, GLbitfield flags);
__attribute__((visibility("default"))) void glTextureStorageSparseAMD (GLuint texture, GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLsizei layers, GLbitfield flags);
...
__attribute__((visibility("default"))) void glStencilOpValueAMD (GLenum face, GLuint value);
...
__attribute__((visibility("default"))) void glElementPointerAPPLE (GLenum type, const void *pointer);
...
__attribute__((visibility("default"))) void glTextureRangeAPPLE (GLenum target, GLsizei length, const void *pointer);
__attribute__((visibility("default"))) void glGetTexParameterPointervAPPLE (GLenum target, GLenum pname, void **params);
...
__attribute__((visibility("default"))) void glVertexArrayRangeAPPLE (GLsizei length, void *pointer);
__attribute__((visibility("default"))) void glFlushVertexArrayRangeAPPLE (GLsizei length, void *pointer);
...
__attribute__((visibility("default"))) void glElementPointerATI (GLenum type, const void *pointer);
...
__attribute__((visibility("default"))) void * glMapObjectBufferATI (GLuint buffer);
...
__attribute__((visibility("default"))) GLuint glNewObjectBufferATI (GLsizei size, const void *pointer, GLenum usage);
__attribute__((visibility("default"))) GLboolean glIsObjectBufferATI (GLuint buffer);
__attribute__((visibility("default"))) void glUpdateObjectBufferATI (GLuint buffer, GLuint offset, GLsizei size, const void *pointer, GLenum preserve);
...
__attribute__((visibility("default"))) void glBlendColorEXT (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
...
__attribute__((visibility("default"))) void glColorSubTableEXT (GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const void *data);
...
__attribute__((visibility("default"))) void glConvolutionFilter1DEXT (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const void *image);
__attribute__((visibility("default"))) void glConvolutionFilter2DEXT (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *image);
...
__attribute__((visibility("default"))) void glGetConvolutionFilterEXT (GLenum target, GLenum format, GLenum type, void *image);
...
__attribute__((visibility("default"))) void glGetSeparableFilterEXT (GLenum target, GLenum format, GLenum type, void *row, void *column, void *span);
__attribute__((visibility("default"))) void glSeparableFilter2DEXT (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *row, const void *column);
...
__attribute__((visibility("default"))) void glTangentPointerEXT (GLenum type, GLsizei stride, const void *pointer);
__attribute__((visibility("default"))) void glBinormalPointerEXT (GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glTextureImage1DEXT (GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureImage2DEXT (GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureSubImage1DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureSubImage2DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glGetTextureImageEXT (GLuint texture, GLenum target, GLint level, GLenum format, GLenum type, void *pixels);
...
__attribute__((visibility("default"))) void glTextureImage3DEXT (GLuint texture, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTextureSubImage3DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glMultiTexCoordPointerEXT (GLenum texunit, GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glMultiTexImage1DEXT (GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glMultiTexImage2DEXT (GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glMultiTexSubImage1DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glMultiTexSubImage2DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glGetMultiTexImageEXT (GLenum texunit, GLenum target, GLint level, GLenum format, GLenum type, void *pixels);
...
__attribute__((visibility("default"))) void glMultiTexImage3DEXT (GLenum texunit, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glMultiTexSubImage3DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glGetPointerIndexedvEXT (GLenum target, GLuint index, void **data);
...
__attribute__((visibility("default"))) void glCompressedTextureImage3DEXT (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedTextureImage2DEXT (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedTextureImage1DEXT (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedTextureSubImage3DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedTextureSubImage2DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedTextureSubImage1DEXT (GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glGetCompressedTextureImageEXT (GLuint texture, GLenum target, GLint lod, void *img);
__attribute__((visibility("default"))) void glCompressedMultiTexImage3DEXT (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedMultiTexImage2DEXT (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedMultiTexImage1DEXT (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedMultiTexSubImage3DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedMultiTexSubImage2DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glCompressedMultiTexSubImage1DEXT (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void *bits);
__attribute__((visibility("default"))) void glGetCompressedMultiTexImageEXT (GLenum texunit, GLenum target, GLint lod, void *img);
...
__attribute__((visibility("default"))) void glNamedBufferDataEXT (GLuint buffer, GLsizeiptr size, const void *data, GLenum usage);
__attribute__((visibility("default"))) void glNamedBufferSubDataEXT (GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);
__attribute__((visibility("default"))) void * glMapNamedBufferEXT (GLuint buffer, GLenum access);
...
__attribute__((visibility("default"))) void glGetNamedBufferPointervEXT (GLuint buffer, GLenum pname, void **params);
__attribute__((visibility("default"))) void glGetNamedBufferSubDataEXT (GLuint buffer, GLintptr offset, GLsizeiptr size, void *data);
...
__attribute__((visibility("default"))) void glEnableClientStateiEXT (GLenum array, GLuint index);
__attribute__((visibility("default"))) void glDisableClientStateiEXT (GLenum array, GLuint index);
__attribute__((visibility("default"))) void glGetFloati_vEXT (GLenum pname, GLuint index, GLfloat *params);
__attribute__((visibility("default"))) void glGetDoublei_vEXT (GLenum pname, GLuint index, GLdouble *params);
__attribute__((visibility("default"))) void glGetPointeri_vEXT (GLenum pname, GLuint index, void **params);
__attribute__((visibility("default"))) void glNamedProgramStringEXT (GLuint program, GLenum target, GLenum format, GLsizei len, const void *string);
...
__attribute__((visibility("default"))) void glGetNamedProgramStringEXT (GLuint program, GLenum target, GLenum pname, void *string);
...
__attribute__((visibility("default"))) void glVertexArrayVertexOffsetEXT (GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayColorOffsetEXT (GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayEdgeFlagOffsetEXT (GLuint vaobj, GLuint buffer, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayIndexOffsetEXT (GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayNormalOffsetEXT (GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayTexCoordOffsetEXT (GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayMultiTexCoordOffsetEXT (GLuint vaobj, GLuint buffer, GLenum texunit, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayFogCoordOffsetEXT (GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArraySecondaryColorOffsetEXT (GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribOffsetEXT (GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribIOffsetEXT (GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset);
__attribute__((visibility("default"))) void glEnableVertexArrayEXT (GLuint vaobj, GLenum array);
__attribute__((visibility("default"))) void glDisableVertexArrayEXT (GLuint vaobj, GLenum array);
__attribute__((visibility("default"))) void glEnableVertexArrayAttribEXT (GLuint vaobj, GLuint index);
__attribute__((visibility("default"))) void glDisableVertexArrayAttribEXT (GLuint vaobj, GLuint index);
__attribute__((visibility("default"))) void glGetVertexArrayIntegervEXT (GLuint vaobj, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetVertexArrayPointervEXT (GLuint vaobj, GLenum pname, void **param);
__attribute__((visibility("default"))) void glGetVertexArrayIntegeri_vEXT (GLuint vaobj, GLuint index, GLenum pname, GLint *param);
__attribute__((visibility("default"))) void glGetVertexArrayPointeri_vEXT (GLuint vaobj, GLuint index, GLenum pname, void **param);
__attribute__((visibility("default"))) void * glMapNamedBufferRangeEXT (GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);
__attribute__((visibility("default"))) void glFlushMappedNamedBufferRangeEXT (GLuint buffer, GLintptr offset, GLsizeiptr length);
__attribute__((visibility("default"))) void glNamedBufferStorageEXT (GLuint buffer, GLsizeiptr size, const void *data, GLbitfield flags);
__attribute__((visibility("default"))) void glClearNamedBufferDataEXT (GLuint buffer, GLenum internalformat, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glClearNamedBufferSubDataEXT (GLuint buffer, GLenum internalformat, GLsizeiptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);
__attribute__((visibility("default"))) void glNamedFramebufferParameteriEXT (GLuint framebuffer, GLenum pname, GLint param);
__attribute__((visibility("default"))) void glGetNamedFramebufferParameterivEXT (GLuint framebuffer, GLenum pname, GLint *params);
...
__attribute__((visibility("default"))) void glTextureBufferRangeEXT (GLuint texture, GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
...
__attribute__((visibility("default"))) void glTextureStorage2DMultisampleEXT (GLuint texture, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
__attribute__((visibility("default"))) void glTextureStorage3DMultisampleEXT (GLuint texture, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
__attribute__((visibility("default"))) void glVertexArrayBindVertexBufferEXT (GLuint vaobj, GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribFormatEXT (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribIFormatEXT (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribLFormatEXT (GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribBindingEXT (GLuint vaobj, GLuint attribindex, GLuint bindingindex);
__attribute__((visibility("default"))) void glVertexArrayVertexBindingDivisorEXT (GLuint vaobj, GLuint bindingindex, GLuint divisor);
...
__attribute__((visibility("default"))) void glTexturePageCommitmentEXT (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit);
__attribute__((visibility("default"))) void glVertexArrayVertexAttribDivisorEXT (GLuint vaobj, GLuint index, GLuint divisor);
...
__attribute__((visibility("default"))) void glDrawRangeElementsEXT (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices);
...
__attribute__((visibility("default"))) void glFogCoordPointerEXT (GLenum type, GLsizei stride, const void *pointer);
...
enum { GL_EXT_framebuffer_blit_layers = 1 };
...
__attribute__((visibility("default"))) void glBlitFramebufferLayersEXT (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
__attribute__((visibility("default"))) void glBlitFramebufferLayerEXT (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint srcLayer, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLint dstLayer, GLbitfield mask, GLenum filter);
...
__attribute__((visibility("default"))) void glVertexAttribIPointerEXT (GLuint index, GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glGetHistogramEXT (GLenum target, GLboolean reset, GLenum format, GLenum type, void *values);
...
__attribute__((visibility("default"))) void glGetMinmaxEXT (GLenum target, GLboolean reset, GLenum format, GLenum type, void *values);
...
__attribute__((visibility("default"))) void glTexStorageMem1DEXT (GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);
__attribute__((visibility("default"))) void glTextureStorageMem1DEXT (GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);
...
enum { GL_TEXTURE_INDEX_SIZE_EXT = 33005 };
...
__attribute__((visibility("default"))) void glColorTableEXT (GLenum target, GLenum internalFormat, GLsizei width, GLenum format, GLenum type, const void *table);
__attribute__((visibility("default"))) void glGetColorTableEXT (GLenum target, GLenum format, GLenum type, void *data);
...
__attribute__((visibility("default"))) void glGetPixelTransformParameterivEXT (GLenum target, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glGetPixelTransformParameterfvEXT (GLenum target, GLenum pname, GLfloat *params);
...
__attribute__((visibility("default"))) void glSecondaryColorPointerEXT (GLint size, GLenum type, GLsizei stride, const void *pointer);
...
enum { GL_EXT_shader_samples_identical = 1 };
...
__attribute__((visibility("default"))) void glTexSubImage1DEXT (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTexSubImage2DEXT (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glTexImage3DEXT (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTexSubImage3DEXT (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels);
...
enum { GL_TEXTURE_IMMUTABLE_FORMAT_EXT = 37167 };
enum { GL_RGBA32F_EXT = 34836 };
enum { GL_RGB32F_EXT = 34837 };
enum { GL_ALPHA32F_EXT = 34838 };
enum { GL_LUMINANCE32F_EXT = 34840 };
enum { GL_LUMINANCE_ALPHA32F_EXT = 34841 };
enum { GL_RGBA16F_EXT = 34842 };
enum { GL_RGB16F_EXT = 34843 };
enum { GL_ALPHA16F_EXT = 34844 };
enum { GL_LUMINANCE16F_EXT = 34846 };
enum { GL_LUMINANCE_ALPHA16F_EXT = 34847 };
enum { GL_BGRA8_EXT = 37793 };
enum { GL_R8_EXT = 33321 };
enum { GL_RG8_EXT = 33323 };
enum { GL_R32F_EXT = 33326 };
enum { GL_RG32F_EXT = 33328 };
enum { GL_R16F_EXT = 33325 };
enum { GL_RG16F_EXT = 33327 };
...
__attribute__((visibility("default"))) void glTransformFeedbackVaryingsEXT (GLuint program, GLsizei count, const GLchar *const*varyings, GLenum bufferMode);
...
__attribute__((visibility("default"))) void glColorPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const void *pointer);
...
__attribute__((visibility("default"))) void glGetPointervEXT (GLenum pname, void **params);
__attribute__((visibility("default"))) void glIndexPointerEXT (GLenum type, GLsizei stride, GLsizei count, const void *pointer);
__attribute__((visibility("default"))) void glNormalPointerEXT (GLenum type, GLsizei stride, GLsizei count, const void *pointer);
__attribute__((visibility("default"))) void glTexCoordPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const void *pointer);
__attribute__((visibility("default"))) void glVertexPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const void *pointer);
...
__attribute__((visibility("default"))) void glVertexAttribLPointerEXT (GLuint index, GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glSetInvariantEXT (GLuint id, GLenum type, const void *addr);
__attribute__((visibility("default"))) void glSetLocalConstantEXT (GLuint id, GLenum type, const void *addr);
...
__attribute__((visibility("default"))) void glVariantPointerEXT (GLuint id, GLenum type, GLuint stride, const void *addr);
...
__attribute__((visibility("default"))) void glGetVariantPointervEXT (GLuint id, GLenum value, void **data);
...
__attribute__((visibility("default"))) void glVertexWeightPointerEXT (GLint size, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glStringMarkerGREMEDY (GLsizei len, const void *string);
...
__attribute__((visibility("default"))) void glMultiModeDrawElementsIBM (const GLenum *mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei primcount, GLint modestride);
...
__attribute__((visibility("default"))) void glFlushStaticDataIBM (GLenum target);
...
__attribute__((visibility("default"))) void glColorPointerListIBM (GLint size, GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glSecondaryColorPointerListIBM (GLint size, GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glEdgeFlagPointerListIBM (GLint stride, const GLboolean **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glFogCoordPointerListIBM (GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glIndexPointerListIBM (GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glNormalPointerListIBM (GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glTexCoordPointerListIBM (GLint size, GLenum type, GLint stride, const void **pointer, GLint ptrstride);
__attribute__((visibility("default"))) void glVertexPointerListIBM (GLint size, GLenum type, GLint stride, const void **pointer, GLint ptrstride);
...
__attribute__((visibility("default"))) void glSyncTextureINTEL (GLuint texture);
__attribute__((visibility("default"))) void glUnmapTexture2DINTEL (GLuint texture, GLint level);
__attribute__((visibility("default"))) void * glMapTexture2DINTEL (GLuint texture, GLint level, GLbitfield access, GLint *stride, GLenum *layout);
...
__attribute__((visibility("default"))) void glVertexPointervINTEL (GLint size, GLenum type, const void **pointer);
__attribute__((visibility("default"))) void glNormalPointervINTEL (GLenum type, const void **pointer);
__attribute__((visibility("default"))) void glColorPointervINTEL (GLint size, GLenum type, const void **pointer);
__attribute__((visibility("default"))) void glTexCoordPointervINTEL (GLint size, GLenum type, const void **pointer);
...
__attribute__((visibility("default"))) void glFramebufferParameteriMESA (GLenum target, GLenum pname, GLint param);
__attribute__((visibility("default"))) void glGetFramebufferParameterivMESA (GLenum target, GLenum pname, GLint *params);
...
__attribute__((visibility("default"))) void glBeginConditionalRenderNVX (GLuint id);
__attribute__((visibility("default"))) void glEndConditionalRenderNVX (void);
...
__attribute__((visibility("default"))) void glUploadGpuMaskNVX (GLbitfield mask);
__attribute__((visibility("default"))) void glMulticastViewportArrayvNVX (GLuint gpu, GLuint first, GLsizei count, const GLfloat *v);
__attribute__((visibility("default"))) void glMulticastViewportPositionWScaleNVX (GLuint gpu, GLuint index, GLfloat xcoeff, GLfloat ycoeff);
__attribute__((visibility("default"))) void glMulticastScissorArrayvNVX (GLuint gpu, GLuint first, GLsizei count, const GLint *v);
__attribute__((visibility("default"))) GLuint glAsyncCopyBufferSubDataNVX (GLsizei waitSemaphoreCount, const GLuint *waitSemaphoreArray, const GLuint64 *fenceValueArray, GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size, GLsizei signalSemaphoreCount, const GLuint *signalSemaphoreArray, const GLuint64 *signalValueArray);
__attribute__((visibility("default"))) GLuint glAsyncCopyImageSubDataNVX (GLsizei waitSemaphoreCount, const GLuint *waitSemaphoreArray, const GLuint64 *waitValueArray, GLuint srcGpu, GLbitfield dstGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth, GLsizei signalSemaphoreCount, const GLuint *signalSemaphoreArray, const GLuint64 *signalValueArray);
...
__attribute__((visibility("default"))) void glLGPUNamedBufferSubDataNVX (GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);
__attribute__((visibility("default"))) void glLGPUCopyImageSubDataNVX (GLuint sourceGpu, GLbitfield destinationGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srxY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);
__attribute__((visibility("default"))) void glLGPUInterlockNVX (void);
...
__attribute__((visibility("default"))) GLuint glCreateProgressFenceNVX (void);
__attribute__((visibility("default"))) void glSignalSemaphoreui64NVX (GLuint signalGpu, GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);
__attribute__((visibility("default"))) void glWaitSemaphoreui64NVX (GLuint waitGpu, GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);
__attribute__((visibility("default"))) void glClientWaitSemaphoreui64NVX (GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);
...
__attribute__((visibility("default"))) void glAlphaToCoverageDitherControlNV (GLenum mode);
...
__attribute__((visibility("default"))) void glMultiDrawArraysIndirectBindlessNV (GLenum mode, const void *indirect, GLsizei drawCount, GLsizei stride, GLint vertexBufferCount);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirectBindlessNV (GLenum mode, GLenum type, const void *indirect, GLsizei drawCount, GLsizei stride, GLint vertexBufferCount);
...
__attribute__((visibility("default"))) void glMultiDrawArraysIndirectBindlessCountNV (GLenum mode, const void *indirect, GLsizei drawCount, GLsizei maxDrawCount, GLsizei stride, GLint vertexBufferCount);
__attribute__((visibility("default"))) void glMultiDrawElementsIndirectBindlessCountNV (GLenum mode, GLenum type, const void *indirect, GLsizei drawCount, GLsizei maxDrawCount, GLsizei stride, GLint vertexBufferCount);
...
__attribute__((visibility("default"))) void glCreateStatesNV (GLsizei n, GLuint *states);
__attribute__((visibility("default"))) void glDeleteStatesNV (GLsizei n, const GLuint *states);
__attribute__((visibility("default"))) GLboolean glIsStateNV (GLuint state);
__attribute__((visibility("default"))) void glStateCaptureNV (GLuint state, GLenum mode);
__attribute__((visibility("default"))) GLuint glGetCommandHeaderNV (GLenum tokenID, GLuint size);
__attribute__((visibility("default"))) GLushort glGetStageIndexNV (GLenum shadertype);
__attribute__((visibility("default"))) void glDrawCommandsNV (GLenum primitiveMode, GLuint buffer, const GLintptr *indirects, const GLsizei *sizes, GLuint count);
__attribute__((visibility("default"))) void glDrawCommandsAddressNV (GLenum primitiveMode, const GLuint64 *indirects, const GLsizei *sizes, GLuint count);
__attribute__((visibility("default"))) void glDrawCommandsStatesNV (GLuint buffer, const GLintptr *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);
__attribute__((visibility("default"))) void glDrawCommandsStatesAddressNV (const GLuint64 *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);
__attribute__((visibility("default"))) void glCreateCommandListsNV (GLsizei n, GLuint *lists);
__attribute__((visibility("default"))) void glDeleteCommandListsNV (GLsizei n, const GLuint *lists);
__attribute__((visibility("default"))) GLboolean glIsCommandListNV (GLuint list);
__attribute__((visibility("default"))) void glListDrawCommandsStatesClientNV (GLuint list, GLuint segment, const void **indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);
__attribute__((visibility("default"))) void glCommandListSegmentsNV (GLuint list, GLuint segments);
__attribute__((visibility("default"))) void glCompileCommandListNV (GLuint list);
__attribute__((visibility("default"))) void glCallCommandListNV (GLuint list);
...
__attribute__((visibility("default"))) void glConservativeRasterParameterfNV (GLenum pname, GLfloat value);
...
__attribute__((visibility("default"))) void glDrawTextureNV (GLuint texture, GLuint sampler, GLfloat x0, GLfloat y0, GLfloat x1, GLfloat y1, GLfloat z, GLfloat s0, GLfloat t0, GLfloat s1, GLfloat t1);
...
__attribute__((visibility("default"))) void glMapControlPointsNV (GLenum target, GLuint index, GLenum type, GLsizei ustride, GLsizei vstride, GLint uorder, GLint vorder, GLboolean packed, const void *points);
...
__attribute__((visibility("default"))) void glGetMapControlPointsNV (GLenum target, GLuint index, GLenum type, GLsizei ustride, GLsizei vstride, GLboolean packed, void *points);
...
__attribute__((visibility("default"))) void glRenderGpuMaskNV (GLbitfield mask);
__attribute__((visibility("default"))) void glMulticastBufferSubDataNV (GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);
__attribute__((visibility("default"))) void glMulticastCopyBufferSubDataNV (GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
__attribute__((visibility("default"))) void glMulticastCopyImageSubDataNV (GLuint srcGpu, GLbitfield dstGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);
__attribute__((visibility("default"))) void glMulticastBlitFramebufferNV (GLuint srcGpu, GLuint dstGpu, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
__attribute__((visibility("default"))) void glMulticastFramebufferSampleLocationsfvNV (GLuint gpu, GLuint framebuffer, GLuint start, GLsizei count, const GLfloat *v);
__attribute__((visibility("default"))) void glMulticastBarrierNV (void);
__attribute__((visibility("default"))) void glMulticastWaitSyncNV (GLuint signalGpu, GLbitfield waitGpuMask);
__attribute__((visibility("default"))) void glMulticastGetQueryObjectivNV (GLuint gpu, GLuint id, GLenum pname, GLint *params);
__attribute__((visibility("default"))) void glMulticastGetQueryObjectuivNV (GLuint gpu, GLuint id, GLenum pname, GLuint *params);
__attribute__((visibility("default"))) void glMulticastGetQueryObjecti64vNV (GLuint gpu, GLuint id, GLenum pname, GLint64 *params);
__attribute__((visibility("default"))) void glMulticastGetQueryObjectui64vNV (GLuint gpu, GLuint id, GLenum pname, GLuint64 *params);
...
__attribute__((visibility("default"))) void glGetInternalformatSampleivNV (GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei count, GLint *params);
...
__attribute__((visibility("default"))) void glGetMemoryObjectDetachedResourcesuivNV (GLuint memory, GLenum pname, GLint first, GLsizei count, GLuint *params);
__attribute__((visibility("default"))) void glResetMemoryObjectParameterNV (GLuint memory, GLenum pname);
__attribute__((visibility("default"))) void glTexAttachMemoryNV (GLenum target, GLuint memory, GLuint64 offset);
__attribute__((visibility("default"))) void glBufferAttachMemoryNV (GLenum target, GLuint memory, GLuint64 offset);
__attribute__((visibility("default"))) void glTextureAttachMemoryNV (GLuint texture, GLuint memory, GLuint64 offset);
__attribute__((visibility("default"))) void glNamedBufferAttachMemoryNV (GLuint buffer, GLuint memory, GLuint64 offset);
...
__attribute__((visibility("default"))) void glBufferPageCommitmentMemNV (GLenum target, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
__attribute__((visibility("default"))) void glTexPageCommitmentMemNV (GLenum target, GLint layer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset, GLboolean commit);
__attribute__((visibility("default"))) void glNamedBufferPageCommitmentMemNV (GLuint buffer, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
__attribute__((visibility("default"))) void glTexturePageCommitmentMemNV (GLuint texture, GLint layer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset, GLboolean commit);
...
__attribute__((visibility("default"))) void glDrawMeshTasksNV (GLuint first, GLuint count);
__attribute__((visibility("default"))) void glDrawMeshTasksIndirectNV (GLintptr indirect);
__attribute__((visibility("default"))) void glMultiDrawMeshTasksIndirectNV (GLintptr indirect, GLsizei drawcount, GLsizei stride);
__attribute__((visibility("default"))) void glMultiDrawMeshTasksIndirectCountNV (GLintptr indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
...
__attribute__((visibility("default"))) void glProgramBufferParametersfvNV (GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLfloat *params);
__attribute__((visibility("default"))) void glProgramBufferParametersIivNV (GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLint *params);
__attribute__((visibility("default"))) void glProgramBufferParametersIuivNV (GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLuint *params);
...
__attribute__((visibility("default"))) GLenum glPathGlyphIndexRangeNV (GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint *baseAndCount);
...
__attribute__((visibility("default"))) void glGetProgramResourcefvNV (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei count, GLsizei *length, GLfloat *params);
__attribute__((visibility("default"))) void glPathColorGenNV (GLenum color, GLenum genMode, GLenum colorFormat, const GLfloat *coeffs);
__attribute__((visibility("default"))) void glPathTexGenNV (GLenum texCoordSet, GLenum genMode, GLint components, const GLfloat *coeffs);
__attribute__((visibility("default"))) void glPathFogGenNV (GLenum genMode);
__attribute__((visibility("default"))) void glGetPathColorGenivNV (GLenum color, GLenum pname, GLint *value);
__attribute__((visibility("default"))) void glGetPathColorGenfvNV (GLenum color, GLenum pname, GLfloat *value);
__attribute__((visibility("default"))) void glGetPathTexGenivNV (GLenum texCoordSet, GLenum pname, GLint *value);
__attribute__((visibility("default"))) void glGetPathTexGenfvNV (GLenum texCoordSet, GLenum pname, GLfloat *value);
...
__attribute__((visibility("default"))) void glPixelDataRangeNV (GLenum target, GLsizei length, const void *pointer);
...
__attribute__((visibility("default"))) GLint glQueryResourceNV (GLenum queryType, GLint tagId, GLuint count, GLint *buffer);
...
__attribute__((visibility("default"))) void glGenQueryResourceTagNV (GLsizei n, GLint *tagIds);
__attribute__((visibility("default"))) void glDeleteQueryResourceTagNV (GLsizei n, const GLint *tagIds);
__attribute__((visibility("default"))) void glQueryResourceTagNV (GLint tagId, const GLchar *tagString);
...
__attribute__((visibility("default"))) void glScissorExclusiveNV (GLint x, GLint y, GLsizei width, GLsizei height);
__attribute__((visibility("default"))) void glScissorExclusiveArrayvNV (GLuint first, GLsizei count, const GLint *v);
...
__attribute__((visibility("default"))) void glBindShadingRateImageNV (GLuint texture);
__attribute__((visibility("default"))) void glGetShadingRateImagePaletteNV (GLuint viewport, GLuint entry, GLenum *rate);
__attribute__((visibility("default"))) void glGetShadingRateSampleLocationivNV (GLenum rate, GLuint samples, GLuint index, GLint *location);
__attribute__((visibility("default"))) void glShadingRateImageBarrierNV (GLboolean synchronize);
__attribute__((visibility("default"))) void glShadingRateImagePaletteNV (GLuint viewport, GLuint first, GLsizei count, const GLenum *rates);
__attribute__((visibility("default"))) void glShadingRateSampleOrderNV (GLenum order);
__attribute__((visibility("default"))) void glShadingRateSampleOrderCustomNV (GLenum rate, GLuint samples, const GLint *locations);
...
__attribute__((visibility("default"))) void glCreateSemaphoresNV (GLsizei n, GLuint *semaphores);
__attribute__((visibility("default"))) void glSemaphoreParameterivNV (GLuint semaphore, GLenum pname, const GLint *params);
__attribute__((visibility("default"))) void glGetSemaphoreParameterivNV (GLuint semaphore, GLenum pname, GLint *params);
...
__attribute__((visibility("default"))) void glTransformFeedbackAttribsNV (GLsizei count, const GLint *attribs, GLenum bufferMode);
...
__attribute__((visibility("default"))) void glVDPAUInitNV (const void *vdpDevice, const void *getProcAddress);
__attribute__((visibility("default"))) void glVDPAUFiniNV (void);
__attribute__((visibility("default"))) GLvdpauSurfaceNV glVDPAURegisterVideoSurfaceNV (const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);
__attribute__((visibility("default"))) GLvdpauSurfaceNV glVDPAURegisterOutputSurfaceNV (const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);
__attribute__((visibility("default"))) GLboolean glVDPAUIsSurfaceNV (GLvdpauSurfaceNV surface);
__attribute__((visibility("default"))) void glVDPAUUnregisterSurfaceNV (GLvdpauSurfaceNV surface);
__attribute__((visibility("default"))) void glVDPAUGetSurfaceivNV (GLvdpauSurfaceNV surface, GLenum pname, GLsizei count, GLsizei *length, GLint *values);
...
__attribute__((visibility("default"))) GLvdpauSurfaceNV glVDPAURegisterVideoSurfaceWithPictureStructureNV (const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames, GLboolean isFrameStructure);
...
__attribute__((visibility("default"))) void glVertexArrayRangeNV (GLsizei length, const void *pointer);
...
__attribute__((visibility("default"))) void glGetVertexAttribPointervNV (GLuint index, GLenum pname, void **pointer);
...
__attribute__((visibility("default"))) void glVertexAttribPointerNV (GLuint index, GLint fsize, GLenum type, GLsizei stride, const void *pointer);
...
__attribute__((visibility("default"))) void glTexImage4DSGIS (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLsizei size4d, GLint border, GLenum format, GLenum type, const void *pixels);
__attribute__((visibility("default"))) void glTexSubImage4DSGIS (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint woffset, GLsizei width, GLsizei height, GLsizei depth, GLsizei size4d, GLenum format, GLenum type, const void *pixels);
...
__attribute__((visibility("default"))) void glIglooInterfaceSGIX (GLenum pname, const void *params);
...
__attribute__((visibility("default"))) void glColorTableSGI (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const void *table);
...
__attribute__((visibility("default"))) void glGetColorTableSGI (GLenum target, GLenum format, GLenum type, void *table);
...
__attribute__((visibility("default"))) void glReplacementCodePointerSUN (GLenum type, GLsizei stride, const void **pointer);
...
enum { GL_UNSIGNED_INT_8_24_REV_MESA = 34642 };
enum { GL_UNSIGNED_SHORT_15_1_MESA = 34643 };
enum { GL_UNSIGNED_SHORT_1_15_REV_MESA = 34644 };
