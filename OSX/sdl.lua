...
extern const SDL_AssertData * SDL_GetAssertionReport();
extern void SDL_ResetAssertionReport();
...
extern SDL_cond * SDL_CreateCond();
...
extern SDL_bool SDL_HasPrimarySelectionText();
extern int SDL_GetCPUCount();
extern int SDL_GetCPUCacheLineSize();
extern SDL_bool SDL_HasRDTSC();
extern SDL_bool SDL_HasAltiVec();
extern SDL_bool SDL_HasMMX();
extern SDL_bool SDL_Has3DNow();
extern SDL_bool SDL_HasSSE();
extern SDL_bool SDL_HasSSE2();
extern SDL_bool SDL_HasSSE3();
extern SDL_bool SDL_HasSSE41();
extern SDL_bool SDL_HasSSE42();
extern SDL_bool SDL_HasAVX();
extern SDL_bool SDL_HasAVX2();
extern SDL_bool SDL_HasAVX512F();
extern SDL_bool SDL_HasARMSIMD();
extern SDL_bool SDL_HasNEON();
extern SDL_bool SDL_HasLSX();
extern SDL_bool SDL_HasLASX();
extern int SDL_GetSystemRAM();
extern size_t SDL_SIMDGetAlignment();
...
extern SDL_YUV_CONVERSION_MODE SDL_GetYUVConversionMode();
...
extern SDL_bool SDL_IsScreenSaverEnabled();
...
extern void SDL_ClearComposition();
extern SDL_bool SDL_IsTextInputShown();
extern void SDL_SetTextInputRect(const SDL_Rect *rect);
extern SDL_bool SDL_HasScreenKeyboardSupport();
...
extern SDL_bool SDL_GetRelativeMouseMode();
...
extern void SDL_LockSensors();
extern void SDL_UnlockSensors();
extern int SDL_NumSensors();
...
extern int SDL_GameControllerNumMappings();
...
extern int SDL_MouseIsHaptic();
extern SDL_Haptic * SDL_HapticOpenFromMouse();
...
extern void SDL_Metal_GetDrawableSize(SDL_Window* window, int *w, int *h);
...
extern __attribute__((deprecated)) int SDL_GetRevisionNumber();
extern SDL_Locale * SDL_GetPreferredLocales();
